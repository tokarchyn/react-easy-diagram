...
import DiagramExampleSource from '!!raw-loader!./_customizePortDiagram';
import DiagramExample from './_customizePortDiagram'

export default function Example() {
  return (
    <ExampleWrapper title='Customize Port Example'>
