...
import DiagramExampleSource from '!!raw-loader!./_configureUserInteractionDiagram';
import DiagramExample from './_configureUserInteractionDiagram'

export default function Example() {
  return (
    <ExampleWrapper title='Configure user interaction'>
