...
You can customize visual representation of nodes, ports and links mainly in two ways: by providing your own
components or by modifying built-in components.
