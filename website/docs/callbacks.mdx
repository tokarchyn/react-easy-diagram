...
Information type: [onNodeLabelChanged](api/interfaces/OnNodeLabelChanged)

## onNodeTypeChanged

:::caution
If type is changed to `undefined` the [COMPONENT_DEFAULT_TYPE](api/#component_default_type) will be used but in callback `newValue` will be `undefined`.
:::

Information type: [onNodeTypeChanged](api/interfaces/OnNodeTypeChanged)

## onNodeDataChanged

Information type: [OnNodeDataChanged](api/interfaces/OnNodeDataChanged)

## onNodeIsSelectionEnabledChanged

Information type: [OnNodeIsSelectionEnabledChanged](api/interfaces/OnNodeIsSelectionEnabledChanged)

## onNodeIsDragEnabledChanged

Information type: [OnNodeIsDragEnabledChanged](api/interfaces/OnNodeIsDragEnabledChanged)
