...
/* harmony default export */ var routes = ([{path:'/react-easy-diagram/',component:exports_ComponentCreator('/react-easy-diagram/','6b1'),exact:true},{path:'/react-easy-diagram/examples/basic',component:exports_ComponentCreator('/react-easy-diagram/examples/basic','15f'),exact:true},{path:'/react-easy-diagram/examples/calculator',component:exports_ComponentCreator('/react-easy-diagram/examples/calculator','9ee'),exact:true},{path:'/react-easy-diagram/examples/callbacks',component:exports_ComponentCreator('/react-easy-diagram/examples/callbacks','fbb'),exact:true},{path:'/react-easy-diagram/examples/configureDefaultLink',component:exports_ComponentCreator('/react-easy-diagram/examples/configureDefaultLink','4de'),exact:true},{path:'/react-easy-diagram/examples/configureDefaultPort',component:exports_ComponentCreator('/react-easy-diagram/examples/configureDefaultPort','889'),exact:true},{path:'/react-easy-diagram/examples/configureUserInteraction',component:exports_ComponentCreator('/react-easy-diagram/examples/configureUserInteraction','2b0'),exact:true},{path:'/react-easy-diagram/examples/dynamicPorts',component:exports_ComponentCreator('/react-easy-diagram/examples/dynamicPorts','470'),exact:true},{path:'/react-easy-diagram/examples/linkMarkers',component:exports_ComponentCreator('/react-easy-diagram/examples/linkMarkers','0d6'),exact:true},{path:'/react-easy-diagram/examples/performance',component:exports_ComponentCreator('/react-easy-diagram/examples/performance','5ca'),exact:true},{path:'/react-easy-diagram/examples/portPosition',component:exports_ComponentCreator('/react-easy-diagram/examples/portPosition','b41'),exact:true},{path:'/react-easy-diagram/examples/positionSnapping',component:exports_ComponentCreator('/react-easy-diagram/examples/positionSnapping','408'),exact:true},{path:'/react-easy-diagram/examples/updatePortsPosition',component:exports_ComponentCreator('/react-easy-diagram/examples/updatePortsPosition','33a'),exact:true},{path:'/react-easy-diagram/docs',component:exports_ComponentCreator('/react-easy-diagram/docs','b6f'),routes:[{path:'/react-easy-diagram/docs/',component:exports_ComponentCreator('/react-easy-diagram/docs/','cb9'),exact:true}]},{path:'*',component:exports_ComponentCreator('*')}]);
...
var globalData_namespaceObject = JSON.parse('{"docusaurus-plugin-content-docs":{"default":{"path":"/react-easy-diagram/docs","versions":[{"name":"current","label":"Next","isLast":true,"path":"/react-easy-diagram/docs","mainDocId":"introduction","docs":[{"id":"introduction","path":"/react-easy-diagram/docs/","sidebar":"docs"}]}]}}}');
