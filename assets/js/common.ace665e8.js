(self["webpackChunkwebsite"] = self["webpackChunkwebsite"] || []).push([[592],{
...
/* harmony export */   "features": function() { return /* binding */ _i; },
/* harmony export */   "transform": function() { return /* binding */ ki; }
/* harmony export */ });
...
__webpack_require__.d(__webpack_exports__, {
  "BackgroundWrapper": function() { return /* binding */ BackgroundWrapper; },
  "Button": function() { return /* binding */ Button; },
  "Callbacks": function() { return /* binding */ Callbacks; },
  "CommandExecutor": function() { return /* binding */ CommandExecutor; },
  "CopyIcon": function() { return /* binding */ CopyIcon; },
  "DISABLED_USER_SELECT_CSS_CLASS": function() { return /* binding */ DISABLED_USER_SELECT_CSS_CLASS; },
  "Diagram": function() { return /* binding */ _Diagram; },
  "DiagramSettings": function() { return /* binding */ DiagramSettings; },
  "DiagramState": function() { return /* binding */ DiagramState; },
  "DragState": function() { return /* binding */ DragState; },
  "FilterCenterFocusIcon": function() { return /* binding */ FilterCenterFocusIcon; },
  "HtmlElementRefState": function() { return /* binding */ HtmlElementRefState; },
  "InnerDiagram": function() { return /* binding */ InnerDiagram; },
  "LinkCreationState": function() { return /* binding */ LinkCreationState; },
  "LinkDefault": function() { return /* binding */ LinkDefault; },
  "LinkPointEndpointState": function() { return /* binding */ LinkPointEndpointState; },
  "LinkPortEndpointState": function() { return /* binding */ LinkPortEndpointState; },
  "LinkState": function() { return /* binding */ LinkState; },
  "LinkWrapper": function() { return /* binding */ LinkWrapper; },
  "LinksLayer": function() { return /* binding */ LinksLayer; },
  "LinksSettings": function() { return /* binding */ LinksSettings; },
  "LinksStore": function() { return /* binding */ LinksStore; },
  "MiniControlWrapper": function() { return /* binding */ MiniControlWrapper; },
  "Node": function() { return /* binding */ Node; },
  "NodeContext": function() { return /* binding */ NodeContext; },
  "NodeLabel": function() { return /* binding */ NodeLabel; },
  "NodeState": function() { return /* binding */ NodeState; },
  "NodeWrapper": function() { return /* binding */ NodeWrapper; },
  "NodesLayer": function() { return /* binding */ NodesLayer; },
  "NodesSettings": function() { return /* binding */ NodesSettings; },
  "NodesStore": function() { return /* binding */ NodesStore; },
  "Port": function() { return /* binding */ Port; },
  "PortInnerDefault": function() { return /* binding */ PortInnerDefault; },
  "PortState": function() { return /* binding */ PortState; },
  "PortsSettings": function() { return /* binding */ PortsSettings; },
  "RenderedPortsComponentsContext": function() { return /* binding */ RenderedPortsComponentsContext; },
  "RootStore": function() { return /* binding */ RootStore; },
  "RootStoreContext": function() { return /* binding */ RootStoreContext; },
  "RubbishBinIcon": function() { return /* binding */ RubbishBinIcon; },
  "SelectionState": function() { return /* binding */ SelectionState; },
  "UserInteractionSettings": function() { return /* binding */ UserInteractionSettings; },
  "VisualComponentState": function() { return /* binding */ VisualComponentState; },
  "VisualComponentWithDefault": function() { return /* binding */ VisualComponentWithDefault; },
  "VisualComponents": function() { return /* binding */ VisualComponents; },
  "addPoints": function() { return /* binding */ addPoints; },
  "arePointsEqual": function() { return /* binding */ arePointsEqual; },
  "areTranformationsEqual": function() { return /* binding */ areTranformationsEqual; },
  "canDragGestureBeTapInstead": function() { return /* binding */ canDragGestureBeTapInstead; },
  "clampValue": function() { return /* binding */ clampValue; },
  "className": function() { return /* binding */ className$1; },
  "cloneSelectedNodesCommand": function() { return /* binding */ cloneSelectedNodesCommand; },
  "commandC": function() { return /* binding */ commandC; },
  "commandM": function() { return /* binding */ commandM; },
  "componentDefaultType": function() { return /* binding */ componentDefaultType; },
  "coordinateFromPoint": function() { return /* binding */ coordinateFromPoint; },
  "createArrowMarker": function() { return /* binding */ createArrowMarker; },
  "createCircleMarker": function() { return /* binding */ createCircleMarker; },
  "createCrossesImageGenerator": function() { return /* binding */ createCrossesImageGenerator; },
  "createCurvedLinkPathConstructor": function() { return /* binding */ createCurvedLinkPathConstructor; },
  "createDefaultBackground": function() { return /* binding */ createDefaultBackground; },
  "createDefaultMiniControl": function() { return /* binding */ createDefaultMiniControl; },
  "createDotsImageGenerator": function() { return /* binding */ createDotsImageGenerator; },
  "createFullPortId": function() { return /* binding */ createFullPortId; },
  "createGridImageGenerator": function() { return /* binding */ createGridImageGenerator; },
  "createInputHorizontalNode": function() { return /* binding */ createInputHorizontalNode; },
  "createInputOutputHorizontalNode": function() { return /* binding */ createInputOutputHorizontalNode; },
  "createInputOutputVerticalNode": function() { return /* binding */ createInputOutputVerticalNode; },
  "createInputVerticalNode": function() { return /* binding */ createInputVerticalNode; },
  "createLinkDefault": function() { return /* binding */ createLinkDefault; },
  "createLinkPath": function() { return /* binding */ createLinkPath; },
  "createNode": function() { return /* binding */ createNode; },
  "createOutputHorizontalNode": function() { return /* binding */ createOutputHorizontalNode; },
  "createOutputVerticalNode": function() { return /* binding */ createOutputVerticalNode; },
  "createPortInnerDefault": function() { return /* binding */ createPortInnerDefault; },
  "createPortsContainer": function() { return /* binding */ createPortsContainer; },
  "createStarNode": function() { return /* binding */ createStarNode; },
  "createStraightLinkPathConstructor": function() { return /* binding */ createStraightLinkPathConstructor; },
  "createVector": function() { return /* binding */ createVector; },
  "deepCopy": function() { return /* binding */ deepCopy; },
  "disableNodeUserInteractionClassName": function() { return /* binding */ disableNodeUserInteractionClassName; },
  "distanceBetweenPoints": function() { return /* binding */ distanceBetweenPoints; },
  "enableNodeUserInteractionClassName": function() { return /* binding */ enableNodeUserInteractionClassName; },
  "errorResult": function() { return /* binding */ errorResult; },
  "errorValueResult": function() { return /* binding */ errorValueResult; },
  "eventPathContainsClass": function() { return /* binding */ eventPathContainsClass; },
  "generateTransform": function() { return /* binding */ generateTransform; },
  "getDegree": function() { return /* binding */ getDegree; },
  "getRadian": function() { return /* binding */ getRadian; },
  "guid": function() { return /* binding */ guid; },
  "guidForcedUniqueness": function() { return /* binding */ guidForcedUniqueness; },
  "isBoolean": function() { return /* binding */ isBoolean; },
  "isError": function() { return /* binding */ isError; },
  "isNumber": function() { return /* binding */ isNumber; },
  "isObject": function() { return /* binding */ isObject; },
  "isPoint": function() { return /* binding */ isPoint; },
  "isSuccess": function() { return /* binding */ isSuccess; },
  "linkCreationComponentType": function() { return /* binding */ linkCreationComponentType; },
  "linkPortEndpointsEquals": function() { return /* binding */ linkPortEndpointsEquals; },
  "multiplyPoint": function() { return /* binding */ multiplyPoint; },
  "portPositionValues": function() { return /* binding */ portPositionValues; },
  "positionValues": function() { return /* binding */ positionValues; },
  "removeSelectedCommand": function() { return /* binding */ removeSelectedCommand; },
  "removeSelectedLinksCommand": function() { return /* binding */ removeSelectedLinksCommand; },
  "removeSelectedNodesCommand": function() { return /* binding */ removeSelectedNodesCommand; },
  "roundPoint": function() { return /* binding */ roundPoint; },
  "subtractPoints": function() { return /* binding */ subtractPoints; },
  "successResult": function() { return /* binding */ successResult; },
  "successValueResult": function() { return /* binding */ successValueResult; },
  "useCursor": function() { return /* binding */ useCursor; },
  "useDiagram": function() { return /* binding */ useDiagram; },
  "useDiagramCursor": function() { return /* binding */ useDiagramCursor; },
  "useDiagramDragHandlers": function() { return /* binding */ useDiagramDragHandlers; },
  "useDiagramPinchHandlers": function() { return /* binding */ useDiagramPinchHandlers; },
  "useDiagramUserInteraction": function() { return /* binding */ useDiagramUserInteraction; },
  "useDiagramWheelHandler": function() { return /* binding */ useDiagramWheelHandler; },
  "useDisableContextMenu": function() { return /* binding */ useDisableContextMenu; },
  "useLinkUserInteraction": function() { return /* binding */ useLinkUserInteraction; },
  "useNodeUserInteraction": function() { return /* binding */ useNodeUserInteraction; },
  "useNotifyRef": function() { return /* binding */ useNotifyRef; },
  "usePortUserInteraction": function() { return /* binding */ usePortUserInteraction; },
  "useRelativePositionStyles": function() { return /* binding */ useRelativePositionStyles; },
  "useRootStore": function() { return /* binding */ useRootStore; },
  "useUpdateOrCreatePortState": function() { return /* binding */ useUpdateOrCreatePortState; },
  "useUserAbilityToSelectSwitcher": function() { return /* binding */ useUserAbilityToSelectSwitcher; }
});
...
;// CONCATENATED MODULE: ../lib/dist/index.esm.js
function isPoint(value){return Array.isArray(value)&&value.length===2&&value.every(function(v){return Number.isFinite(v);});}var distanceBetweenPoints=function distanceBetweenPoints(a,b){return Math.sqrt(Math.pow(a[0]-b[0],2)+Math.pow(a[1]-b[1],2));};var roundPoint=function roundPoint(point){return[Math.round(point[0]),Math.round(point[1])];};var addPoints=function addPoints(){var _a;var points=[];for(var _i=0;_i<arguments.length;_i++){points[_i]=arguments[_i];}return(_a=points.reduce(function(prev,curr){if(curr){return[(prev?prev[0]:0)+curr[0],(prev?prev[1]:0)+curr[1]];}else{return prev;}}))!==null&&_a!==void 0?_a:[0,0];};var subtractPoints=function subtractPoints(){var points=[];for(var _i=0;_i<arguments.length;_i++){points[_i]=arguments[_i];}return points.reduce(function(prev,curr){return curr?[prev[0]-curr[0],prev[1]-curr[1]]:prev;});};var multiplyPoint=function multiplyPoint(a,m){return[a[0]*m,a[1]*m];};var arePointsEqual=function arePointsEqual(a,b){return a===b||isPoint(a)&&isPoint(b)&&a[0]===b[0]&&a[1]===b[1];};var cloneSelectedNodesCommand={execute:function execute(rootStore){rootStore.selectionState.selectedNodes.forEach(function(node){var nodeObj=node.export();nodeObj.id=undefined;nodeObj.label=nodeObj.label;nodeObj.position=addPoints(nodeObj.position,[50,50]);rootStore.nodesStore.addNode(nodeObj,false);});}};/*! *****************************************************************************
 ...
 */function canDragGestureBeTapInstead(movement){return Math.max(Math.abs(movement[0]),Math.abs(movement[1]))<3;}function useCursor(active,cursor,ref){var cursorBeforeSetRef=(0,react.useRef)('');(0,react.useEffect)(function(){if(!active||!ref||!cursor||ref.style.cursor===cursor){return;}cursorBeforeSetRef.current=ref.style.cursor;ref.style.cursor=cursor;return function(){ref.style.cursor=cursorBeforeSetRef.current;};},[active,ref]);}function useDiagramCursor(active,cursor){var diagramState=useRootStore().diagramState;var ref=diagramState.diagramInnerRef.current;useCursor(active,cursor,ref);}function useDisableContextMenu(ref){var handleContextMenu=(0,react.useCallback)(function(event){event.preventDefault();},[]);(0,react.useEffect)(function(){ref===null||ref===void 0?void 0:ref.addEventListener('contextmenu',handleContextMenu);return function(){ref===null||ref===void 0?void 0:ref.removeEventListener('contextmenu',handleContextMenu);};},[ref]);}var useNodeUserInteraction=function useNodeUserInteraction(nodeState){var _a,_b;var rootStore=useRootStore();var interactionActiveRef=(0,react.useRef)(false);var selectOnLongTapRef=(0,react.useRef)(null);var cancelSelectOnLongTap=(0,react.useCallback)(function(){if(selectOnLongTapRef.current){clearTimeout(selectOnLongTapRef.current);selectOnLongTapRef.current=null;return true;}return false;},[selectOnLongTapRef]);var userInteractionElemRef=(0,react.useRef)(null);var handlers=(0,react.useMemo)(function(){return{onDrag:function onDrag(_a){var pinching=_a.pinching,delta=_a.delta,movement=_a.movement;if(!interactionActiveRef.current||pinching||canDragGestureBeTapInstead(movement)){return;}cancelSelectOnLongTap();if(rootStore.dragState.isActive&&!nodeState.isDragActive)return;if(!nodeState.isDragEnabled)return;if(!nodeState.isDragActive){rootStore.dragState.startDragging(nodeState);}rootStore.dragState.dragBy(multiplyPoint(delta,1/rootStore.diagramState.zoom));},onDragStart:function onDragStart(_a){var event=_a.event;interactionActiveRef.current=allowNodeInteraction(event)&&!rootStore.dragState.isActive;if(interactionActiveRef.current){cancelSelectOnLongTap();if(nodeState.isSelectionEnabled){selectOnLongTapRef.current=__webpack_require__.g.setTimeout(function(){if(selectOnLongTapRef.current){selectOnLongTapRef.current=null;rootStore.selectionState.switch(nodeState);}},selectDelay);}}},onDragEnd:function onDragEnd(_a){var tap=_a.tap,ctrlKey=_a.ctrlKey;if(interactionActiveRef.current){interactionActiveRef.current=false;var selectLongOnTapCancelled=cancelSelectOnLongTap();if(nodeState.isDragActive){rootStore.dragState.stopDragging();}// selectLongOnTapCancelled means that callback in timer wasn't executed yet
if(nodeState.isSelectionEnabled&&tap&&selectLongOnTapCancelled){rootStore.selectionState.select(nodeState,!ctrlKey);}}}};},[nodeState,rootStore]);useGesture(handlers,{domTarget:userInteractionElemRef,eventOptions:{passive:false}});useUserAbilityToSelectSwitcher(interactionActiveRef.current,(_b=(_a=userInteractionElemRef.current)===null||_a===void 0?void 0:_a.ownerDocument)===null||_b===void 0?void 0:_b.body);useDisableContextMenu(userInteractionElemRef.current);useDiagramCursor(nodeState.isDragActive,'move');useCursor(nodeState.isDragActive,'move',nodeState.ref.current);return userInteractionElemRef;};var selectDelay=500;function allowNodeInteraction(event){return eventPathContainsClass(event,enableNodeUserInteractionClassName,disableNodeUserInteractionClassName);}var enableNodeUserInteractionClassName='react_easy_diagram_enable_node_user_interaction';var disableNodeUserInteractionClassName='react_easy_diagram_disable_node_user_interaction';var NodeWrapper=(0,es/* observer */.Pi)(function(_a){var node=_a.node;var userInteractionElemRef=useNodeUserInteraction(node);var renderedPortsContextValue=usePortsCleanUp(node);return/*#__PURE__*/react.createElement(NodeContext.Provider,{value:node},/*#__PURE__*/react.createElement(RenderedPortsComponentsContext.Provider,{value:renderedPortsContextValue},/*#__PURE__*/react.createElement("div",{id:node.id,className:className$1,style:{transform:"translate("+node.position[0]+"px, "+node.position[1]+"px)",zIndex:node.selected?10:undefined},ref:node.ref},/*#__PURE__*/react.createElement(node.componentDefinition.component,{draggableRef:userInteractionElemRef,entity:node,settings:node.componentDefinition.settings}))));});var NodeContext=/*#__PURE__*/react.createContext(null);var RenderedPortsComponentsContext=/*#__PURE__*/react.createContext({render:function render(){return undefined;},unrender:function unrender(){return undefined;}});var className$1="react_fast_diagram_NodeWrapper "+enableNodeUserInteractionClassName;/**
 * Clean up old ports.
 * @param node
 * @returns ports that are currently rendered
 */var usePortsCleanUp=function usePortsCleanUp(node){var renderedPortsRef=useNotifyRef([]);var renderedPortsContextValue=(0,react.useMemo)(function(){return{render:function render(id){if(!renderedPortsRef.current.includes(id)){renderedPortsRef.current=__spreadArrays(renderedPortsRef.current,[id]);}},unrender:function unrender(id){if(renderedPortsRef.current.includes(id)){renderedPortsRef.current=renderedPortsRef.current.filter(function(oldId){return oldId!==id;});}}};},[renderedPortsRef]);(0,react.useLayoutEffect)(function(){renderedPortsRef.current=[];},[node,renderedPortsRef]);(0,react.useEffect)(function(){var extraPortsIds=Object.keys(node.ports).filter(function(id){return!renderedPortsRef.current.includes(id);});(0,mobx_esm/* action */.aD)(function(){return extraPortsIds.forEach(function(id){return node.removePort(id);});});},[renderedPortsRef.current]);return renderedPortsContextValue;};var NodesLayer=(0,es/* observer */.Pi)(function(_a){var nodesStore=_a.nodesStore;var rootStore=useRootStore();(0,react.useEffect)(function(){rootStore.diagramState.zoomToFit();},[]);return/*#__PURE__*/react.createElement("div",{className:"react_fast_diagram_Layer"},Array.from(nodesStore.nodes).map(function(_a){_a[0];var node=_a[1];return/*#__PURE__*/react.createElement(NodeWrapper,{key:node.id,node:node});}));});function useDiagramDragHandlers(cancelEvent){var _a,_b;var rootStore=useRootStore();var diagramState=rootStore.diagramState;var activeRef=useNotifyRef(false);var handlers=(0,react.useMemo)(function(){return{onDrag:function onDrag(_a){var pinching=_a.pinching,delta=_a.delta;if(!activeRef.current||pinching){return;}diagramState.setOffset(addPoints(diagramState.offset,delta));},onDragStart:function onDragStart(_a){var event=_a.event,cancel=_a.cancel;if(cancelEvent&&cancelEvent(event)){cancel();return;}// Do not activate so drag will not be performed, but also don't cancel, as it would not be possible to clear selection
if(!rootStore.diagramSettings.userInteraction.diagramPan||event.buttons!==1){return;}activeRef.current=true;},onDragEnd:function onDragEnd(_a){var tap=_a.tap;if(tap){rootStore.selectionState.unselectAll();}activeRef.current=false;}};},[activeRef,diagramState,cancelEvent,rootStore]);useUserAbilityToSelectSwitcher(activeRef.current,(_b=(_a=diagramState.diagramInnerRef.current)===null||_a===void 0?void 0:_a.ownerDocument)===null||_b===void 0?void 0:_b.body);useDiagramCursor(activeRef.current,'grabbing');return handlers;}function useDiagramPinchHandlers(cancel){var _a,_b;var _c=useRootStore(),diagramState=_c.diagramState,diagramSettings=_c.diagramSettings;var activeRef=useNotifyRef(false);var pinchState=(0,react.useRef)({distance:0,origin:[0,0],elementLeftTop:[0,0]});var handlers=(0,react.useMemo)(function(){return{onPinch:function onPinch(_a){var distance=_a.da[0],origin=_a.origin;if(!activeRef.current||!diagramState.diagramInnerRef.current){return;}var originDiff=diagramSettings.userInteraction.diagramPan?subtractPoints(origin,pinchState.current.origin):[0,0];var originPositionOnElement=subtractPoints(origin,pinchState.current.elementLeftTop);diagramState.tranlsateAndZoomInto(originDiff,originPositionOnElement,distance/pinchState.current.distance);pinchState.current={distance:distance,origin:origin,elementLeftTop:pinchState.current.elementLeftTop};},onPinchStart:function onPinchStart(_a){var distance=_a.da[0],origin=_a.origin,event=_a.event;if(!diagramSettings.userInteraction.diagramZoom||cancel(event)||!diagramState.diagramInnerRef.current){return;}var rect=diagramState.diagramInnerRef.current.getBoundingClientRect();pinchState.current={distance:distance,origin:origin,elementLeftTop:[rect.left,rect.top]};activeRef.current=true;},onPinchEnd:function onPinchEnd(){return activeRef.current=false;}};},[diagramState.diagramInnerRef.current,activeRef,diagramState,cancel,diagramSettings]);useUserAbilityToSelectSwitcher(activeRef.current,(_b=(_a=diagramState.diagramInnerRef.current)===null||_a===void 0?void 0:_a.ownerDocument)===null||_b===void 0?void 0:_b.body);return handlers;}function useDiagramWheelHandler(state){var _a=useRootStore(),diagramState=_a.diagramState,diagramSettings=_a.diagramSettings;var handlers=(0,react.useMemo)(function(){return{onWheel:function onWheel(_a){var _b=_a.direction;_b[0];var yDirection=_b[1],event=_a.event;if(!diagramState.diagramInnerRef.current||!diagramSettings.userInteraction.diagramZoom)return;event===null||event===void 0?void 0:event.preventDefault();var rect=diagramState.diagramInnerRef.current.getBoundingClientRect();var mousePositionOnElement=subtractPoints([event.clientX,event.clientY],[rect.left,rect.top]);var factor=0.9;if(yDirection<0){factor=1/factor;}state.tranlsateAndZoomInto([0,0],mousePositionOnElement,factor);}};},[diagramState.diagramInnerRef,state,diagramSettings]);return handlers;}var useDiagramUserInteraction=function useDiagramUserInteraction(){var diagramState=useRootStore().diagramState;var cancelGesture=(0,react.useCallback)(function(event){return event.target!==diagramState.diagramInnerRef.current;},[diagramState.diagramInnerRef]);var dragHandlers=useDiagramDragHandlers(cancelGesture);var pinchHandlers=useDiagramPinchHandlers(cancelGesture);var wheelHandler=useDiagramWheelHandler(diagramState);useGesture(_assign(_assign(_assign({},dragHandlers),pinchHandlers),wheelHandler),{domTarget:diagramState.diagramInnerRef,eventOptions:{passive:false}});};var MiniControlWrapper=(0,es/* observer */.Pi)(function(){var rootStore=useRootStore();var minicontrolComponentState=rootStore.diagramSettings.miniControlComponentState;return minicontrolComponentState.component&&/*#__PURE__*/react.createElement(minicontrolComponentState.component,{rootStore:rootStore,settings:minicontrolComponentState.settings});});var generateTransform=function generateTransform(translate,scale){var translatePart="translate("+translate[0]+"px, "+translate[1]+"px)";if(scale){var scalePart="scale("+scale+")";return translatePart+' '+scalePart;}else{return translatePart;}};var areTranformationsEqual=function areTranformationsEqual(a,b){return a===b||a&&b&&a.zoom===b.zoom&&arePointsEqual(a.offset,b.offset);};var InnerDiagram=(0,es/* observer */.Pi)(function(props){var rootStore=useRootStore();useDiagramUserInteraction();var offset=rootStore.diagramState.offset;var zoom=rootStore.diagramState.zoom;// Notify state about already rendered zoom and offset.
(0,react.useEffect)(function(){rootStore.diagramState.renderOffsetAndZoom(offset,zoom);},[offset,zoom]);(0,react.useEffect)(function(){var resizeHandler=function resizeHandler(){return rootStore.nodesStore.nodes.forEach(function(n){return n.recalculatePortsSizeAndPosition();});};window.addEventListener('resize',resizeHandler);return function(){return window.removeEventListener('resize',resizeHandler);};},[rootStore]);return/*#__PURE__*/react.createElement("div",{ref:rootStore.diagramState.diagramInnerRef,style:_assign({},props.diagramStyles),className:'react_fast_diagram_DiagramInner'},/*#__PURE__*/react.createElement(BackgroundWrapper,null),/*#__PURE__*/react.createElement("div",{className:'react_fast_diagram_DiagramInner_DraggablePart',style:{transform:generateTransform(offset,zoom)}},/*#__PURE__*/react.createElement(LinksLayer,{linksStore:rootStore.linksStore}),/*#__PURE__*/react.createElement(NodesLayer,{nodesStore:rootStore.nodesStore})),/*#__PURE__*/react.createElement(MiniControlWrapper,null));});InnerDiagram.displayName='InnerDiagram';function isSuccess(result){return result.success;}function isError(result){return!result.success;}function successResult(){return{success:true};}function successValueResult(value){return{success:true,value:value};}function errorResult(error){return{success:false,error:error};}function errorValueResult(value,error){return{success:false,error:error,value:value};}var Callbacks=/** @class */function(){function Callbacks(rootStore){var _this=this;this.import=function(callbacks){_this._validateLinkEndpoints=callbacks===null||callbacks===void 0?void 0:callbacks.validateLinkEndpoints;_this._nodesAdded=callbacks===null||callbacks===void 0?void 0:callbacks.nodesAdded;_this._nodePositionChanged=callbacks===null||callbacks===void 0?void 0:callbacks.nodePositionChanged;_this._dragStateChanged=callbacks===null||callbacks===void 0?void 0:callbacks.dragStateChanged;};this.export=function(){return{validateLinkEndpoints:_this._validateLinkEndpoints,nodesAdded:_this._nodesAdded,nodePositionChanged:_this._nodePositionChanged,dragStateChanged:_this._dragStateChanged};};this.validateLinkEndpoints=function(source,target){if(_this._validateLinkEndpoints)return _this._validateLinkEndpoints(source,target,_this._rootStore);else return true;};this.nodesAdded=function(addResults,importing){return _this._nodesAdded&&_this._nodesAdded(addResults.filter(isSuccess).map(function(r){return r.value;}),addResults.filter(isError),importing,_this._rootStore);};this.nodePositionChanged=function(node,oldPosition,newPosition,isDragActive){return _this._nodePositionChanged&&_this._nodePositionChanged(node,oldPosition,newPosition,isDragActive,_this._rootStore);};this.dragStateChanged=function(nodes,started){return _this._dragStateChanged&&_this._dragStateChanged(nodes,started,_this._rootStore);};this._rootStore=rootStore;this.import();}return Callbacks;}();var VisualComponentWithDefault=/** @class */function(){function VisualComponentWithDefault(defaultComponent){var _this=this;this.import=function(newComponent){_this._innerComponent=newComponent?new VisualComponentState(newComponent):_this._defaultComponent;};this._innerComponent=new VisualComponentState(defaultComponent);this._defaultComponent=this._innerComponent;(0,mobx_esm/* makeAutoObservable */.ky)(this);}Object.defineProperty(VisualComponentWithDefault.prototype,"component",{get:function get(){return this._innerComponent.component;},enumerable:false,configurable:true});Object.defineProperty(VisualComponentWithDefault.prototype,"settings",{get:function get(){return this._innerComponent.settings;},enumerable:false,configurable:true});return VisualComponentWithDefault;}();// Icons from https://material-ui.com/components/material-icons/
var RubbishBinIcon=function RubbishBinIcon(){return/*#__PURE__*/react.createElement("svg",{viewBox:'0 0 24 24'},/*#__PURE__*/react.createElement("path",{d:"M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zm2.46-7.12l1.41-1.41L12 12.59l2.12-2.12 1.41 1.41L13.41 14l2.12 2.12-1.41 1.41L12 15.41l-2.12 2.12-1.41-1.41L10.59 14l-2.13-2.12zM15.5 4l-1-1h-5l-1 1H5v2h14V4z"}));};var CopyIcon=function CopyIcon(){return/*#__PURE__*/react.createElement("svg",{viewBox:'0 0 24 24'},/*#__PURE__*/react.createElement("path",{d:'M16 1H4c-1.1 0-2 .9-2 2v14h2V3h12V1zm-1 4H8c-1.1 0-1.99.9-1.99 2L6 21c0 1.1.89 2 1.99 2H19c1.1 0 2-.9 2-2V11l-6-6zM8 21V7h6v5h5v9H8z'}));};var FilterCenterFocusIcon=function FilterCenterFocusIcon(){return/*#__PURE__*/react.createElement("svg",{viewBox:'0 0 24 24'},/*#__PURE__*/react.createElement("path",{d:"M5 15H3v4c0 1.1.9 2 2 2h4v-2H5v-4zM5 5h4V3H5c-1.1 0-2 .9-2 2v4h2V5zm14-2h-4v2h4v4h2V5c0-1.1-.9-2-2-2zm0 16h-4v2h4c1.1 0 2-.9 2-2v-4h-2v4zM12 9c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z"}));};var MiniControlDefault=(0,es/* observer */.Pi)(function(_a){var rootStore=_a.rootStore,settings=_a.settings;settings=settings!==null&&settings!==void 0?settings:defaultSettings;if(Object.values(settings.buttons).every(function(v){return v===false;}))return null;return/*#__PURE__*/react.createElement("div",{className:'react_fast_diagram_Minicontrol_Default',style:_assign(_assign({},getOffsetStyles(settings)),settings===null||settings===void 0?void 0:settings.containerStyle)},settings.buttons.deleteSelection&&rootStore.selectionState.selectedItems.length>0&&/*#__PURE__*/react.createElement(Button,{size:settings.buttonsSize,onClick:function onClick(){return rootStore.commandExecutor.execute(removeSelectedCommand);}},/*#__PURE__*/react.createElement(RubbishBinIcon,null)),settings.buttons.cloneSelectedNodes&&rootStore.selectionState.selectedItems.length>0&&/*#__PURE__*/react.createElement(Button,{size:settings.buttonsSize,onClick:function onClick(){return rootStore.commandExecutor.execute(cloneSelectedNodesCommand);}},/*#__PURE__*/react.createElement(CopyIcon,null)),settings.buttons.zoomIn&&/*#__PURE__*/react.createElement(Button,{size:settings.buttonsSize,onClick:rootStore.diagramState.zoomIn,children:'+'}),settings.buttons.zoomOut&&/*#__PURE__*/react.createElement(Button,{size:settings.buttonsSize,onClick:rootStore.diagramState.zoomOut,children:'-'}),settings.buttons.zoomToFit&&/*#__PURE__*/react.createElement(Button,{size:settings.buttonsSize,onClick:rootStore.diagramState.zoomToFit},/*#__PURE__*/react.createElement(FilterCenterFocusIcon,null)));});function getOffsetStyles(settings){return{top:settings.position=='left-top'||settings.position=='right-top'?settings.parentOffset:undefined,right:settings.position=='right-bottom'||settings.position=='right-top'?settings.parentOffset:undefined,bottom:settings.position=='left-bottom'||settings.position=='right-bottom'?settings.parentOffset:undefined,left:settings.position=='left-top'||settings.position=='left-bottom'?settings.parentOffset:undefined};}var Button=function Button(props){return/*#__PURE__*/react.createElement("button",{onClick:props.onClick,className:'react_fast_diagram_Minicontrol_Default_Btn',style:{width:props.size+'px',height:props.size+'px',padding:5}},props.children);};var createDefaultMiniControl=function createDefaultMiniControl(settings){var finalSettings=_assign(_assign({},defaultSettings),settings?settings:{});return{component:MiniControlDefault,settings:finalSettings};};var defaultSettings={position:'left-bottom',containerStyle:{},buttonsSize:30,buttons:{zoomIn:true,zoomOut:true,deleteSelection:true,cloneSelectedNodes:true,zoomToFit:true},parentOffset:20};var UserInteractionSettings=/** @class */function(){function UserInteractionSettings(){var _this=this;this.import=function(obj){var _a,_b,_c,_d,_e,_f;if(obj===true||obj===undefined||obj===null)_this.setAll(true);else if(obj===false)_this.setAll(false);else if(isObject(obj)){_this._diagramZoom=(_a=obj.diagramZoom)!==null&&_a!==void 0?_a:true;_this._diagramPan=(_b=obj.diagramPan)!==null&&_b!==void 0?_b:true;_this._nodeDrag=(_c=obj.nodeDrag)!==null&&_c!==void 0?_c:true;_this._portConnection=(_d=obj.portConnection)!==null&&_d!==void 0?_d:true;_this._nodeSelection=(_e=obj.nodeSelection)!==null&&_e!==void 0?_e:true;_this._linkSelection=(_f=obj.linkSelection)!==null&&_f!==void 0?_f:true;}};this.setAll=function(value){_this._diagramZoom=value;_this._diagramPan=value;_this._nodeDrag=value;_this._portConnection=value;_this._nodeSelection=value;_this._linkSelection=value;};this.import();(0,mobx_esm/* makeAutoObservable */.ky)(this);}Object.defineProperty(UserInteractionSettings.prototype,"diagramZoom",{get:function get(){return this._diagramZoom;},set:function set(value){this._diagramZoom=value;},enumerable:false,configurable:true});Object.defineProperty(UserInteractionSettings.prototype,"diagramPan",{get:function get(){return this._diagramPan;},set:function set(value){this._diagramPan=value;},enumerable:false,configurable:true});Object.defineProperty(UserInteractionSettings.prototype,"nodeDrag",{get:function get(){return this._nodeDrag;},set:function set(value){this._nodeDrag=value;},enumerable:false,configurable:true});Object.defineProperty(UserInteractionSettings.prototype,"portConnection",{get:function get(){return this._portConnection;},set:function set(value){this._portConnection=value;},enumerable:false,configurable:true});Object.defineProperty(UserInteractionSettings.prototype,"nodeSelection",{get:function get(){return this._nodeSelection;},set:function set(value){this._nodeSelection=value;},enumerable:false,configurable:true});Object.defineProperty(UserInteractionSettings.prototype,"linkSelection",{get:function get(){return this._linkSelection;},set:function set(value){this._linkSelection=value;},enumerable:false,configurable:true});return UserInteractionSettings;}();var DiagramSettings=/** @class */function(){function DiagramSettings(){var _this=this;this._zoomInterval=defaultZoomInterval;this._zoomToFitSettings=defaultZoomToFitSettings;this.import=function(obj){_this._backgroundComponentState.import(obj===null||obj===void 0?void 0:obj.backgroundComponent);_this._miniControlComponentState.import(obj===null||obj===void 0?void 0:obj.miniControlComponent);_this.setZoomInterval(obj===null||obj===void 0?void 0:obj.zoomInterval);_this._zoomToFitSettings=_assign(_assign({},defaultZoomToFitSettings),obj===null||obj===void 0?void 0:obj.zoomToFitSettings);_this._userInteraction.import(obj===null||obj===void 0?void 0:obj.userInteraction);};this.setZoomInterval=function(value){_this._zoomInterval=value!==null&&value!==void 0?value:defaultZoomInterval;};this._backgroundComponentState=new VisualComponentWithDefault(createDefaultBackground());this._miniControlComponentState=new VisualComponentWithDefault(createDefaultMiniControl());this._userInteraction=new UserInteractionSettings();(0,mobx_esm/* makeAutoObservable */.ky)(this);}Object.defineProperty(DiagramSettings.prototype,"backgroundComponentState",{get:function get(){return this._backgroundComponentState;},enumerable:false,configurable:true});Object.defineProperty(DiagramSettings.prototype,"miniControlComponentState",{get:function get(){return this._miniControlComponentState;},enumerable:false,configurable:true});Object.defineProperty(DiagramSettings.prototype,"zoomInterval",{get:function get(){return this._zoomInterval;},enumerable:false,configurable:true});Object.defineProperty(DiagramSettings.prototype,"zoomToFitSettings",{get:function get(){return this._zoomToFitSettings;},enumerable:false,configurable:true});Object.defineProperty(DiagramSettings.prototype,"userInteraction",{get:function get(){return this._userInteraction;},enumerable:false,configurable:true});return DiagramSettings;}();var defaultZoomInterval=[0.1,3];var defaultZoomToFitSettings={padding:[30,30]};var HtmlElementRefState=/** @class */function(){function HtmlElementRefState(initValue){var _this=this;this._triggerSizePositionRecalculation=0;this.offsetRelativeToParent=function(parent,zoom){_this._triggerSizePositionRecalculation|1;// to make offsetRelativeToParent dependend on _triggerSizePositionRecalculation
var curr=_this.current;if(!curr)return null;var boundingRect=curr.getBoundingClientRect();var parentBoundingRect=parent.getBoundingClientRect();return[(boundingRect.x-parentBoundingRect.x)/zoom,(boundingRect.y-parentBoundingRect.y)/zoom];};this.recalculateSizeAndPosition=function(){_this._triggerSizePositionRecalculation+=1;};this._currentInternal=initValue;(0,mobx_esm/* makeAutoObservable */.ky)(this);}Object.defineProperty(HtmlElementRefState.prototype,"current",{get:function get(){return this._currentInternal;},set:function set(value){this._currentInternal=value;},enumerable:false,configurable:true});Object.defineProperty(HtmlElementRefState.prototype,"realSize",{/**
         ...
         */get:function get(){this._triggerSizePositionRecalculation|1;// to make realSize dependend on _triggerSizePositionRecalculation
if(this.current){return[this.current.clientWidth,this.current.clientHeight];}else{return null;}},enumerable:false,configurable:true});return HtmlElementRefState;}();var DiagramState=/** @class */function(){function DiagramState(rootStore){var _this=this;this.import=function(state){_this.setOffset(state===null||state===void 0?void 0:state.offset);_this.setZoom(state===null||state===void 0?void 0:state.zoom);};this.export=function(){return deepCopy({offset:_this._offset,zoom:_this._zoom});};this.setOffset=function(newOffset){_this._offset=newOffset!==null&&newOffset!==void 0?newOffset:[0,0];};this.setZoom=function(newZoom){_this._zoom=clampValue(newZoom!==null&&newZoom!==void 0?newZoom:1,_this._rootStore.diagramSettings.zoomInterval);};this.zoomIn=function(){return _this.zoomIntoCenter(1/0.8);};this.zoomOut=function(){return _this.zoomIntoCenter(0.8);};// See: https://stackoverflow.com/a/30039971/9142642
...
subtractPoints(pointToZoomInto,pointDisplacementAfterZoom),newZoom);};this.setTransformation=function(newOffset,newZoom){_this.setOffset(newOffset);_this.setZoom(newZoom);};this.translate=function(translateBy){_this.setOffset(addPoints(_this._offset,translateBy));};this.tranlsateAndZoomInto=function(translateBy,pointToZoomInto,zoomMultiplicator){_this.translate(translateBy);_this.zoomInto(pointToZoomInto,zoomMultiplicator);};this.zoomIntoCenter=function(zoomMultiplicator){var diagramRealSize=_this._diagramInnerRef.realSize;if(!diagramRealSize)return;_this.zoomInto(multiplyPoint(diagramRealSize,0.5),zoomMultiplicator);};/**
         * Set offset and zoom values that were already rendered.
         */this.renderOffsetAndZoom=function(offset,zoom){_this._renderedOffset=offset;_this._renderedZoom=zoom;};this.zoomToFit=function(){var nodesBoundingBox=_this._getNodesBoundingBoxWithPadding();var diagramSize=_this._diagramInnerRef.realSize;if(!diagramSize){console.warn('Cannot retrieve diagram size');return;}var newZoom=calculateNewZoomToFitBoundingBox(diagramSize,nodesBoundingBox);// Extend interval to be able to set required zoom
_this._rootStore.diagramSettings.setZoomInterval([Math.min(_this._rootStore.diagramSettings.zoomInterval[0],newZoom),Math.max(_this._rootStore.diagramSettings.zoomInterval[1],newZoom)]);_this.setZoom(newZoom);_this.setOffset(calculateOffsetToCenterBoundingBox(diagramSize,newZoom,nodesBoundingBox));};this._getNodesBoundingBoxWithPadding=function(){var nodesBoundingBox=_this._rootStore.nodesStore.getNodesBoundingBox();var padding=_this._rootStore.diagramSettings.zoomToFitSettings.padding;nodesBoundingBox.topLeftCorner=subtractPoints(nodesBoundingBox.topLeftCorner,padding);nodesBoundingBox.bottomRightCorner=addPoints(nodesBoundingBox.bottomRightCorner,padding);nodesBoundingBox.size=subtractPoints(nodesBoundingBox.bottomRightCorner,nodesBoundingBox.topLeftCorner);return nodesBoundingBox;};this._diagramInnerRef=new HtmlElementRefState(null);this._rootStore=rootStore;this._renderedOffset=[0,0];this._renderedZoom=1;this.import();(0,mobx_esm/* makeAutoObservable */.ky)(this,{// @ts-ignore
_rootStore:false});}Object.defineProperty(DiagramState.prototype,"diagramInnerRef",{get:function get(){return this._diagramInnerRef;},enumerable:false,configurable:true});Object.defineProperty(DiagramState.prototype,"offset",{get:function get(){return this._offset;},enumerable:false,configurable:true});Object.defineProperty(DiagramState.prototype,"zoom",{get:function get(){return this._zoom;},enumerable:false,configurable:true});Object.defineProperty(DiagramState.prototype,"renderedOffset",{get:function get(){return this._renderedOffset;},enumerable:false,configurable:true});Object.defineProperty(DiagramState.prototype,"renderedZoom",{get:function get(){return this._renderedZoom;},enumerable:false,configurable:true});return DiagramState;}();function calculateNewZoomToFitBoundingBox(diagramSize,boundingBox){// Zoom to fit the largest size, horizontal or vertical
...
);}var LinkDefault=(0,es/* observer */.Pi)(function(_a){var entity=_a.entity,settings=_a.settings,bind=_a.bind;var finalSettings=_assign(_assign({},linkDefaultSettings),settings);var path=entity.path;if(!path)return null;var color=finalSettings.color;if(entity.selected&&finalSettings.selectedColor)color=finalSettings.selectedColor;else if(entity.hovered&&finalSettings.hoveredColor)color=finalSettings.hoveredColor;return/*#__PURE__*/react.createElement("g",null,/*#__PURE__*/react.createElement("path",{d:path.svgPath,stroke:color,strokeWidth:finalSettings.strokeWidth,fill:'none',strokeLinecap:'round',markerStart:getMarkerBasedOnState(finalSettings.markerStart,entity.selected,entity.hovered),markerEnd:getMarkerBasedOnState(finalSettings.markerEnd,entity.selected,entity.hovered)}),/*#__PURE__*/react.createElement("path",_assign({d:path.svgPath,stroke:color,strokeWidth:'5'},bind(),{pointerEvents:'auto',fill:'none',strokeOpacity:entity.hovered&&finalSettings.enableHoverEffect?0.22:0})));});function getMarkerBasedOnState(marker,selected,hovered){if(!marker)return undefined;var id=undefined;if(typeof marker==='string'){id=marker;}else{id=marker.default;if(selected&&marker.selected)id=marker.selected;else if(hovered&&marker.hovered)id=marker.hovered;}return"url(#"+id+")";}var linkDefaultSettings={color:'#c2c2c2',selectedColor:'#6eb7ff',hoveredColor:'#a1d0ff',strokeWidth:1,cirleRadius:3,enableHoverEffect:true};function createLinkDefault(settings){return{component:LinkDefault,settings:settings};}function getDegree(dir){switch(dir){case'left':return 180;case'up':return 90;case'right':return 0;case'down':return 270;case'left-up':return 135;case'right-up':return 45;case'right-down':return 315;case'left-down':return 225;default:return undefined;}}function getRadian(dir){var degree=getDegree(dir);return degree!==undefined?degree*Math.PI/180:undefined;}function createVector(point1,length,angleInRadian){return[point1[0]+length*(angleInRadian!==undefined?Math.cos(angleInRadian):0),point1[1]+length*(angleInRadian!==undefined?-Math.sin(angleInRadian):0)];}function commandM(point){return'M '+coordinateFromPoint(point);}function commandC(startPoint,control1,control2,endPoint){return commandM(startPoint)+' C '+coordinateFromPoint(control1)+' '+coordinateFromPoint(control2)+' '+coordinateFromPoint(endPoint);}function coordinateFromPoint(point){return point[0]+" "+point[1];}function curvedLinkPathConstructor(source,target,settings){if(!source||!target)return'';var directionFactor=settings.tweakDirectionFactorBasedOnDistance(distanceBetweenPoints(source.point,target.point),settings.directionFactor);return commandC(source.point,createVector(source.point,directionFactor,getRadian(source.direction)),createVector(target.point,directionFactor,getRadian(target.direction)),target.point);}var defualtSettings={directionFactor:60,tweakDirectionFactorBasedOnDistance:function tweakDirectionFactorBasedOnDistance(distance,directionFactor){if(distance<100){return directionFactor*(distance/100);}return directionFactor;}};function createCurvedLinkPathConstructor(settings){return function(source,target){return curvedLinkPathConstructor(source,target,settings?_assign(_assign({},defualtSettings),settings):defualtSettings);};}var LinkCreationState=/** @class */function(){function LinkCreationState(rootStore){var _this=this;this._source=null;this._target=null;this._targetPortCandidate=null;this.startLinking=function(portState,pointOnPort){_this._resetProps();_this._source=new LinkPortEndpointState(portState.nodeId,portState.id,_this._rootStore);var sourcePoint=_this._source.point;var portSize=_this._source.port.realSize;if(sourcePoint&&portSize){// endpoint point is calculated for center of port
var topLeftCornerPoint=subtractPoints(sourcePoint,multiplyPoint(portSize,0.5));_this._target=new LinkPointEndpointState(addPoints(topLeftCornerPoint,multiplyPoint(pointOnPort,1/_this._rootStore.diagramState.zoom)));}else{_this._resetProps();return false;}return true;};this.setTargetPortCandidate=function(portState){if(!_this._source)return;var canAddLink=_this._rootStore.linksStore.validateLink({source:{nodeId:_this._source.nodeId,portId:_this._source.portId},target:{nodeId:portState.nodeId,portId:portState.id}});_this._targetPortCandidate=portState;if(canAddLink.success){portState.validForConnection=true;}else{portState.validForConnection=false;}};this.resetTargetPortCandidate=function(portState){if(_this._targetPortCandidate===portState){_this._targetPortCandidate=null;}portState.validForConnection=true;};this.stopLinking=function(){if(_this._targetPortCandidate&&_this._source){var result=_this._rootStore.linksStore.validateAndAddLink({source:{nodeId:_this._source.nodeId,portId:_this._source.portId},target:{nodeId:_this._targetPortCandidate.nodeId,portId:_this._targetPortCandidate.id}});if(result.success){_this._rootStore.selectionState.select(result.value,true);}}_this._resetProps();};this._resetProps=function(){if(_this._source){if(_this._source.port){_this._source.port.validForConnection=true;}_this._source=null;}_this._target=null;if(_this._targetPortCandidate){_this._targetPortCandidate.validForConnection=true;_this._targetPortCandidate=null;}};(0,mobx_esm/* makeAutoObservable */.ky)(this);this._rootStore=rootStore;}Object.defineProperty(LinkCreationState.prototype,"selected",{get:function get(){return true;},enumerable:false,configurable:true});Object.defineProperty(LinkCreationState.prototype,"hovered",{get:function get(){return true;},enumerable:false,configurable:true});Object.defineProperty(LinkCreationState.prototype,"source",{get:function get(){return this._source;},enumerable:false,configurable:true});Object.defineProperty(LinkCreationState.prototype,"target",{get:function get(){return this._target;},enumerable:false,configurable:true});Object.defineProperty(LinkCreationState.prototype,"targetPortCandidate",{get:function get(){return this._targetPortCandidate;},enumerable:false,configurable:true});Object.defineProperty(LinkCreationState.prototype,"isLinking",{get:function get(){return!!this._source;},enumerable:false,configurable:true});Object.defineProperty(LinkCreationState.prototype,"componentDefinition",{get:function get(){var visualComponents=this._rootStore.linksSettings.visualComponents;return visualComponents.getComponent(linkCreationComponentType);},enumerable:false,configurable:true});Object.defineProperty(LinkCreationState.prototype,"path",{get:function get(){if(!this._source||!this._target)return undefined;else return createLinkPath(this._rootStore,this._source,this._target);},enumerable:false,configurable:true});return LinkCreationState;}();var linkCreationComponentType='linkCreation';var CircleMarker=function CircleMarker(props){var _a;var finalSettings={id:props.id,radius:(_a=props.radius)!==null&&_a!==void 0?_a:2,style:_assign({stroke:'none',fill:'rgb(194, 194, 194)'},props.style)};return/*#__PURE__*/react.createElement("marker",{id:finalSettings.id,overflow:'visible',markerUnits:'userSpaceOnUse'},/*#__PURE__*/react.createElement("circle",{r:finalSettings.radius,style:finalSettings.style}));};function createCircleMarker(settings){return function(){return/*#__PURE__*/react.createElement(CircleMarker,_assign({},settings));};}var ArrowMarker=function ArrowMarker(props){var _a,_b;var finalSettings={id:props.id,height:(_a=props.height)!==null&&_a!==void 0?_a:10,width:(_b=props.width)!==null&&_b!==void 0?_b:10,style:_assign({stroke:'none',fill:'rgb(194, 194, 194)'},props.style)};return/*#__PURE__*/react.createElement("marker",{id:finalSettings.id,overflow:'visible',markerUnits:'userSpaceOnUse',refX:'-0.5',orient:'auto'},/*#__PURE__*/react.createElement("path",{d:"M 0 0 -"+finalSettings.width+" -"+finalSettings.height/2+" -"+finalSettings.width+" "+finalSettings.height/2+" z",style:finalSettings.style}));};function createArrowMarker(settings){return function(){return/*#__PURE__*/react.createElement(ArrowMarker,_assign({},settings));};}var LinksSettings=/** @class */function(){function LinksSettings(){var _a;var _this=this;this._visualComponents=new VisualComponents((_a={},_a[componentDefaultType]=createLinkDefault(),_a[linkCreationComponentType]=createLinkDefault({markerEnd:'default_circle_marker_selected'}),_a));this._defaultSvgMarkers=[createCircleMarker({id:'default_circle_marker',style:{fill:'#c2c2c2'}}),createCircleMarker({id:'default_circle_marker_selected',style:{fill:'#6eb7ff'}}),createCircleMarker({id:'default_circle_marker_hovered',style:{fill:'#a1d0ff'}}),createArrowMarker({id:'default_arrow_marker',style:{fill:'#c2c2c2'}}),createArrowMarker({id:'default_arrow_marker_selected',style:{fill:'#6eb7ff'}}),createArrowMarker({id:'default_arrow_marker_hovered',style:{fill:'#a1d0ff'}})];this._svgMarkers=[];this.import=function(obj){var _a;_this._visualComponents.import(obj);_this.setPathConstructor(obj===null||obj===void 0?void 0:obj.pathConstructor);_this._preferLinksDirection=(_a=obj===null||obj===void 0?void 0:obj.preferLinksDirection)!==null&&_a!==void 0?_a:'horizontal';_this._svgMarkers=(obj===null||obj===void 0?void 0:obj.svgMarkers)?__spreadArrays(obj.svgMarkers,_this._defaultSvgMarkers):_this._defaultSvgMarkers;};this.setPathConstructor=function(value){_this._pathConstructor=value!==null&&value!==void 0?value:defaultPathConstructor;};this.import();(0,mobx_esm/* makeAutoObservable */.ky)(this);}Object.defineProperty(LinksSettings.prototype,"pathConstructor",{get:function get(){return this._pathConstructor;},enumerable:false,configurable:true});Object.defineProperty(LinksSettings.prototype,"visualComponents",{get:function get(){return this._visualComponents;},enumerable:false,configurable:true});Object.defineProperty(LinksSettings.prototype,"preferLinksDirection",{get:function get(){return this._preferLinksDirection;},enumerable:false,configurable:true});Object.defineProperty(LinksSettings.prototype,"svgMarkers",{get:function get(){return this._svgMarkers;},enumerable:false,configurable:true});return LinksSettings;}();var defaultPathConstructor=createCurvedLinkPathConstructor();function guidS4(){return Math.floor((1+Math.random())*0x10000).toString(16).substring(1);}function guid(){// return id of format 'aaaaaaaa'-'aaaa'-'aaaa'-'aaaa'-'aaaaaaaaaaaa'
return guidS4()+guidS4()+'-'+guidS4()+'-'+guidS4()+'-'+guidS4()+'-'+guidS4()+guidS4()+guidS4();}function guidForcedUniqueness(checkExistence){var id=guid();while(checkExistence(id)){id=guid();}return id;}var PortState=/** @class */function(){function PortState(rootStore,id,nodeId,state){var _this=this;this._ref=new HtmlElementRefState(null);this._dragging=false;this._hovered=false;this._validForConnection=true;this._sizeAndPositionRecalculationWithDelay=0;this.setLabel=function(value){_this._label=value!==null&&value!==void 0?value:'';};this.setType=function(value){_this._type=value!==null&&value!==void 0?value:componentDefaultType;};/**
         * Update all properties. If some property missing in `state` parameter, the default one will be used.
         */this.import=function(state){_this.setType(state===null||state===void 0?void 0:state.type);_this.setLabel(state===null||state===void 0?void 0:state.label);_this.setExtra(state===null||state===void 0?void 0:state.extra);_this.setComponent(state===null||state===void 0?void 0:state.component);_this.setLinkDirection(state===null||state===void 0?void 0:state.linkDirection);_this.setIsConnectionEnabled(state===null||state===void 0?void 0:state.isConnectionEnabled);};/**
         * Update only those properties presented in `state` parameter
         */this.update=function(state){if(!state)return;state.type&&_this.setType(state.type);state.label&&_this.setLabel(state.label);state.extra&&_this.setExtra(state.extra);state.component&&_this.setComponent(state.component);state.linkDirection&&_this.setLinkDirection(state.linkDirection);state.isConnectionEnabled&&_this.setIsConnectionEnabled(state.isConnectionEnabled);};this.export=function(){var _a,_b;return deepCopy({id:_this._id,nodeId:_this._nodeId,label:_this._label,type:_this._type,linkDirection:(_a=_this._linkDirection)!==null&&_a!==void 0?_a:undefined,isConnectionEnabled:(_b=_this._isConnectionEnabled)!==null&&_b!==void 0?_b:undefined});};this.setExtra=function(value){_this._extra=value!==null&&value!==void 0?value:null;};this.setComponent=function(value){if(!value){_this._component=null;}else{_this._component=new VisualComponentState(value);}};this.setLinkDirection=function(value){_this._linkDirection=value!==null&&value!==void 0?value:null;};this.setLinkDirectionIfNotYet=function(direction){var _a;_this._linkDirection=(_a=_this._linkDirection)!==null&&_a!==void 0?_a:direction;};this.recalculateSizeAndPosition=function(){_this._sizeAndPositionRecalculationWithDelay+=1;};this.recalculateSizeAndPositionWithoutDelay=function(){_this._ref.recalculateSizeAndPosition();};this.setIsConnectionEnabled=function(value){_this._isConnectionEnabled=isBoolean(value)?value:null;};this._id=id;this._nodeId=nodeId;this.import(state);(0,mobx_esm/* makeAutoObservable */.ky)(this);this._rootStore=rootStore;(0,mobx_esm/* reaction */.U5)(function(){return[_this._id,_this._nodeId,_this._label,_this._type,_this._extra,_this._component];},function(){_this.recalculateSizeAndPosition();});}Object.defineProperty(PortState.prototype,"id",{get:function get(){return this._id;},enumerable:false,configurable:true});Object.defineProperty(PortState.prototype,"nodeId",{get:function get(){return this._nodeId;},enumerable:false,configurable:true});Object.defineProperty(PortState.prototype,"fullId",{get:function get(){return createFullPortId(this.nodeId,this.id);},enumerable:false,configurable:true});Object.defineProperty(PortState.prototype,"ref",{get:function get(){return this._ref;},enumerable:false,configurable:true});Object.defineProperty(PortState.prototype,"dragging",{get:function get(){return this._dragging;},set:function set(value){this._dragging=value;},enumerable:false,configurable:true});Object.defineProperty(PortState.prototype,"hovered",{get:function get(){return this._hovered;},set:function set(value){this._hovered=value;},enumerable:false,configurable:true});Object.defineProperty(PortState.prototype,"validForConnection",{get:function get(){return this._validForConnection;},set:function set(value){this._validForConnection=value;},enumerable:false,configurable:true});Object.defineProperty(PortState.prototype,"label",{get:function get(){return this._label;},enumerable:false,configurable:true});Object.defineProperty(PortState.prototype,"type",{get:function get(){return this._type;},enumerable:false,configurable:true});Object.defineProperty(PortState.prototype,"extra",{get:function get(){return this._extra;},enumerable:false,configurable:true});Object.defineProperty(PortState.prototype,"node",{get:function get(){var node=this._rootStore.nodesStore.getNode(this.nodeId);if(node)return node;else throw"Node with id '"+this.nodeId+"' does not exist";},enumerable:false,configurable:true});Object.defineProperty(PortState.prototype,"offsetRelativeToNode",{get:function get(){if(this.node.ref.current){return this._ref.offsetRelativeToParent(this.node.ref.current,// Zoom property cannot be used here because to calculate offset we use real
// html elements that have not been rendered with the new zoom at this time
this._rootStore.diagramState.renderedZoom);}return null;},enumerable:false,configurable:true});Object.defineProperty(PortState.prototype,"realSize",{/**
         * @returns Value is calculated without zoom taking into account, that is, the same as zoom would be '1'.
         * Value can be @type {null} in case reference to real DOM object is not set.
...
if(!this.offsetRelativeToNode)return undefined;var nodeCenter=this.node.realSize&&multiplyPoint(this.node.realSize,0.5);if(!nodeCenter)return undefined;if(this._rootStore.linksSettings.preferLinksDirection==='horizontal'){return this.offsetRelativeToNode[0]<nodeCenter[0]?'left':'right';}else if(this._rootStore.linksSettings.preferLinksDirection==='vertical'){return this.offsetRelativeToNode[1]<nodeCenter[1]?'up':'down';}},enumerable:false,configurable:true});Object.defineProperty(PortState.prototype,"sizeAndPositionRecalculationWithDelay",{get:function get(){return this._sizeAndPositionRecalculationWithDelay;},enumerable:false,configurable:true});Object.defineProperty(PortState.prototype,"isConnectionEnabled",{get:function get(){return this._isConnectionEnabled===null?this._rootStore.diagramSettings.userInteraction.portConnection:this._isConnectionEnabled;},enumerable:false,configurable:true});return PortState;}();function createFullPortId(nodeId,portId){return nodeId+"-"+portId;}var LinksStore=/** @class */function(){function LinksStore(rootStore){var _this=this;this.import=function(newLinks){_this._links=new Map();_this._nodesLinksCollection=new Map();// do not check existence of link's ports as they could be added after first node rendering
newLinks&&newLinks.forEach(function(link){if(_this.validateLinkProperties(link)){_this.addLink(link);}});};this.export=function(){return Array.from(_this._links).map(function(_a){_a[0];var value=_a[1];return value.export();});};this.getNodeLinks=function(nodeId){var _a;return(_a=_this._nodesLinksCollection.get(nodeId))!==null&&_a!==void 0?_a:[];};this.getLink=function(id){return _this.links.get(id);};this.getPortLinks=function(nodeId,portId){var nodeLinks=_this.getNodeLinks(nodeId);var fullPortId=createFullPortId(nodeId,portId);return nodeLinks.filter(function(l){return l.source.port&&l.source.port.fullId===fullPortId||l.target.port&&l.target.port.fullId===fullPortId;});};this.removeNodeLinks=function(nodeId){var links=_this.getNodeLinks(nodeId);links.forEach(function(l){return _this.removeLink(l.id);});};this.removePortLinks=function(nodeId,portId){if(!nodeId||!portId)return;var links=_this.getNodeLinks(nodeId);var endpointToRemove={nodeId:nodeId,portId:portId};links.forEach(function(l){if(linkPortEndpointsEquals(l.source,endpointToRemove)||linkPortEndpointsEquals(l.target,endpointToRemove)){_this.removeLink(l.id);}});};this.addLink=function(link){var _a;var newLink=new LinkState(_this._rootStore,(_a=link.id)!==null&&_a!==void 0?_a:guidForcedUniqueness(function(id){return _this._links.has(id);}),link);_this._links.set(newLink.id,newLink);_this._addLinkToNodeLinksCollection(newLink,link.source.nodeId);_this._addLinkToNodeLinksCollection(newLink,link.target.nodeId);return newLink;};this.validateAndAddLink=function(link){var canAdd=_this.validateLink(link);if(!canAdd.success)return canAdd;var newlyCreatedLink=_this.addLink(link);return successValueResult(newlyCreatedLink);};this.removeLink=function(linkId){var linkToRemove=_this._links.get(linkId);if(linkToRemove){_this._removeLinkFromNodeLinksCollection(linkToRemove,linkToRemove.source.nodeId);_this._removeLinkFromNodeLinksCollection(linkToRemove,linkToRemove.target.nodeId);_this._rootStore.selectionState.unselect(linkToRemove);_this._links.delete(linkId);return true;}return false;};this.validateLink=function(link){var _a,_b;var propsValidationResult=_this.validateLinkProperties(link);if(!propsValidationResult.success)return propsValidationResult;var sourcePortResult=_this.getEndpointPortOrError(link.source);if(!sourcePortResult.success)return sourcePortResult;var targetPortResult=_this.getEndpointPortOrError(link.target);if(!targetPortResult.success)return targetPortResult;if(_this.areEndpointsConnected(link.source,link.target))return errorResult("Link's endpoints are already connected");if(((_b=(_a=_this._rootStore.callbacks).validateLinkEndpoints)===null||_b===void 0?void 0:_b.call(_a,sourcePortResult.value,targetPortResult.value))===false){return errorResult("Link's endpoints are not valid according to validation callback");}return successResult();};this.validateLinkProperties=function(link){if(!link)return errorResult("Cannot add empty");if(link.id&&typeof link!=='string')return errorResult("Cannot add link with id '"+link.id+"' of type different than 'string'");if(link.id&&_this._links.has(link.id))return errorResult("Cannot add link with id '"+link.id+"', as it already exists");if(link.source.nodeId===link.target.nodeId)return errorResult("Link's endpoints are located in the same node");return successResult();};this.getEndpointPortOrError=function(endpoint){var node=_this._rootStore.nodesStore.getNode(endpoint.nodeId);if(!node)return errorResult("Node '"+endpoint.nodeId+"' of link's endpoint does not exist");var port=node.getPort(endpoint.portId);if(!port)return errorResult("Port with id '"+endpoint.portId+"' does not exist in the node '"+endpoint.nodeId+"'");return successValueResult(port);};this.getEndpointPort=function(endpoint){var _a;return(_a=_this._rootStore.nodesStore.getNode(endpoint.nodeId))===null||_a===void 0?void 0:_a.getPort(endpoint.portId);};this.areEndpointsConnected=function(source,target){return!!_this.getLinkForEndpointsIfExists(source,target);};this.getLinkForEndpointsIfExists=function(source,target){var links=_this._nodesLinksCollection.get(source.nodeId);if(links){return links.find(function(l){return linkPortEndpointsEquals(l.source,source)&&linkPortEndpointsEquals(l.target,target)||linkPortEndpointsEquals(l.target,source)&&linkPortEndpointsEquals(l.source,target);});}};this._addLinkToNodeLinksCollection=function(link,nodeId){var links=_this._nodesLinksCollection.get(nodeId);if(!links){_this._nodesLinksCollection.set(nodeId,[link]);}else{links.push(link);}};this._removeLinkFromNodeLinksCollection=function(link,nodeId){var collection=_this._nodesLinksCollection.get(nodeId);if(collection){collection=collection.filter(function(l){return l.id!==link.id;});if(collection.length>0){_this._nodesLinksCollection.set(nodeId,collection);}else{_this._nodesLinksCollection.delete(nodeId);}}};this._linkCreation=new LinkCreationState(rootStore);this.import();(0,mobx_esm/* makeAutoObservable */.ky)(this);this._rootStore=rootStore;}Object.defineProperty(LinksStore.prototype,"links",{get:function get(){return this._links;},enumerable:false,configurable:true});Object.defineProperty(LinksStore.prototype,"linkCreation",{get:function get(){return this._linkCreation;},enumerable:false,configurable:true});return LinksStore;}();var NodeLabel=(0,es/* observer */.Pi)(function(_a){var node=_a.node;return/*#__PURE__*/react.createElement("span",null,node.label?node.label:node.id);});function useUpdateOrCreatePortState(port){var nodesStore=useRootStore().nodesStore;return (0,react.useMemo)(function(){var node=nodesStore.getNode(port.nodeId);if(!node)return undefined;var portState=port.id?node.getPort(port.id):undefined;if(portState){portState.update(port);}else{var result=node.addPort(port);if(result.success){portState=result.value;}}return portState;},[nodesStore,port===null||port===void 0?void 0:port.id,port===null||port===void 0?void 0:port.nodeId,port===null||port===void 0?void 0:port.component,port===null||port===void 0?void 0:port.extra,port===null||port===void 0?void 0:port.isConnectionEnabled,port===null||port===void 0?void 0:port.label,port===null||port===void 0?void 0:port.linkDirection,port===null||port===void 0?void 0:port.type]);}var useRelativePositionStyles=function useRelativePositionStyles(position,offsetFromParentCenter,offsetFromOrigin,usePortCenterPivot){if(usePortCenterPivot===void 0){usePortCenterPivot=true;}return (0,react.useMemo)(function(){if(!position)return{};var positionStyle={position:'absolute'};if(!isNumber(offsetFromParentCenter))offsetFromParentCenter=0;if(!isPoint(offsetFromOrigin))offsetFromOrigin=[0,0];if(position==='left-top'){positionStyle.left=offsetFromOrigin[0]-offsetFromParentCenter;positionStyle.top=offsetFromOrigin[1];if(usePortCenterPivot)positionStyle.transform="translateX(-50%)";}else if(position==='left-center'){positionStyle.left=offsetFromOrigin[0]-offsetFromParentCenter;positionStyle.top='50%';positionStyle.transform="translate("+(usePortCenterPivot?'-50%':0)+", calc(-50% + "+offsetFromOrigin[1]+"px))";}else if(position==='left-bottom'){positionStyle.left=offsetFromOrigin[0]-offsetFromParentCenter;positionStyle.bottom=-offsetFromOrigin[1];if(usePortCenterPivot)positionStyle.transform="translateX(-50%)";}if(position==='top-left'){positionStyle.left=offsetFromOrigin[0];positionStyle.top=offsetFromOrigin[1]-offsetFromParentCenter;if(usePortCenterPivot)positionStyle.transform="translateY(-50%)";}else if(position==='top-center'){positionStyle.left='50%';positionStyle.transform="translate(calc(-50% + "+offsetFromOrigin[0]+"px), "+(usePortCenterPivot?'-50%':0)+")";positionStyle.top=offsetFromOrigin[1]-offsetFromParentCenter;}else if(position==='top-right'){positionStyle.right=-offsetFromOrigin[0];positionStyle.top=offsetFromOrigin[1]-offsetFromParentCenter;if(usePortCenterPivot)positionStyle.transform="translateY(-50%)";}if(position==='right-top'){positionStyle.right=-offsetFromOrigin[0]-offsetFromParentCenter;positionStyle.top=offsetFromOrigin[1];if(usePortCenterPivot)positionStyle.transform="translateX(50%)";}else if(position==='right-center'){positionStyle.right=-offsetFromOrigin[0]-offsetFromParentCenter;positionStyle.top='50%';positionStyle.transform="translate("+(usePortCenterPivot?'50%':0)+", calc(-50% + "+offsetFromOrigin[1]+"px))";}else if(position==='right-bottom'){positionStyle.right=-offsetFromOrigin[0]-offsetFromParentCenter;positionStyle.bottom=-offsetFromOrigin[1];if(usePortCenterPivot)positionStyle.transform="translateX(50%)";}if(position==='bottom-left'){positionStyle.left=offsetFromOrigin[0];positionStyle.bottom=-offsetFromOrigin[1]-offsetFromParentCenter;if(usePortCenterPivot)positionStyle.transform="translateY(50%)";}else if(position==='bottom-center'){positionStyle.left='50%';positionStyle.transform="translate(calc(-50% + "+offsetFromOrigin[0]+"px), "+(usePortCenterPivot?'50%':0)+")";positionStyle.bottom=-offsetFromOrigin[1]-offsetFromParentCenter;}else if(position==='bottom-right'){positionStyle.right=-offsetFromOrigin[0];positionStyle.bottom=-offsetFromOrigin[1]-offsetFromParentCenter;if(usePortCenterPivot)positionStyle.transform="translateY(50%)";}if(position==='diagonal-left-top'){positionStyle.left=offsetFromOrigin[0]-offsetFromParentCenter;positionStyle.top=offsetFromOrigin[1]-offsetFromParentCenter;if(usePortCenterPivot)positionStyle.transform="translate(-50%, -50%)";}else if(position==='diagonal-right-top'){positionStyle.right=-offsetFromOrigin[0]-offsetFromParentCenter;positionStyle.top=offsetFromOrigin[1]-offsetFromParentCenter;if(usePortCenterPivot)positionStyle.transform="translate(50%, -50%)";}else if(position==='diagonal-right-bottom'){positionStyle.right=-offsetFromOrigin[0]-offsetFromParentCenter;positionStyle.bottom=-offsetFromOrigin[1]-offsetFromParentCenter;if(usePortCenterPivot)positionStyle.transform="translate(50%, 50%)";}else if(position==='diagonal-left-bottom'){positionStyle.left=offsetFromOrigin[0]-offsetFromParentCenter;positionStyle.bottom=-offsetFromOrigin[1]-offsetFromParentCenter;if(usePortCenterPivot)positionStyle.transform="translate(-50%, 50%)";}return positionStyle;},[position,offsetFromParentCenter,offsetFromOrigin,usePortCenterPivot]);};var portPositionValues=['left-top','left-center','left-bottom','top-left','top-center','top-right','right-top','right-center','right-bottom','bottom-left','bottom-center','bottom-right','diagonal-left-top','diagonal-right-top','diagonal-right-bottom','diagonal-left-bottom'];var usePortUserInteraction=function usePortUserInteraction(portState){var _a,_b;var _c=useRootStore(),linkCreation=_c.linksStore.linkCreation,diagramState=_c.diagramState;var handlers=(0,react.useMemo)(function(){return{onDrag:function onDrag(_a){var _b;var delta=_a.delta;if(!portState||!portState.dragging)return;var parentScale=diagramState.zoom;(_b=linkCreation.target)===null||_b===void 0?void 0:_b.translateBy(multiplyPoint(delta,1/parentScale));},onDragStart:function onDragStart(_a){var event=_a.event,xy=_a.xy;if(!portState||!portState.isConnectionEnabled)return;// Important! Otherwise on touch display onPointerEnter will not work!
...
var bind=useGesture(handlers,{eventOptions:{passive:false}});useUserAbilityToSelectSwitcher(!!(portState===null||portState===void 0?void 0:portState.dragging),(_b=(_a=portState===null||portState===void 0?void 0:portState.ref.current)===null||_a===void 0?void 0:_a.ownerDocument)===null||_b===void 0?void 0:_b.body);useDiagramCursor(!!(portState===null||portState===void 0?void 0:portState.dragging),'pointer');return{active:!!(portState===null||portState===void 0?void 0:portState.dragging),bind:bind};};var Port=(0,es/* observer */.Pi)(function(props){var node=(0,react.useContext)(NodeContext);// node should already exist
var portState=useUpdateOrCreatePortState(_assign(_assign({linkDirection:props.position&&positionToLinkDirection[props.position]},props),{nodeId:node.id}));var positionStyles=useRelativePositionStyles(props.position,props.offsetFromNodeCenter,props.offsetFromOrigin);useRenderingReport(props.id);var bind=usePortUserInteraction(portState).bind;(0,react.useEffect)(function(){portState===null||portState===void 0?void 0:portState.ref.recalculateSizeAndPosition();},[portState,portState===null||portState===void 0?void 0:portState.ref,portState===null||portState===void 0?void 0:portState.sizeAndPositionRecalculationWithDelay]);if(!portState){return null;}return/*#__PURE__*/react.createElement("div",_assign({style:positionStyles,id:portState.fullId,className:className,ref:portState.ref,key:portState.fullId},bind()),/*#__PURE__*/react.createElement(portState.componentDefinition.component,{entity:portState,settings:portState.componentDefinition.settings}));});var className="react_fast_diagram_Port "+disableNodeUserInteractionClassName;/**
 * Report to NodeWrapper that port was rendered so it can clean up the old ports
 * @param id - port id
 */var useRenderingReport=function useRenderingReport(id){var _a=(0,react.useContext)(RenderedPortsComponentsContext),render=_a.render,unrender=_a.unrender;(0,react.useEffect)(function(){render(id);return function(){return unrender(id);};},[id]);};var positionToLinkDirection={'left-center':'left','left-bottom':'left','left-top':'left','top-left':'up','top-center':'up','top-right':'up','right-center':'right','right-bottom':'right','right-top':'right','bottom-left':'down','bottom-center':'down','bottom-right':'down','diagonal-left-top':'left-up','diagonal-right-top':'right-up','diagonal-right-bottom':'right-down','diagonal-left-bottom':'left-down'};var Node=(0,es/* observer */.Pi)(function(_a){var entity=_a.entity,settings=_a.settings,draggableRef=_a.draggableRef;var finalSettings=_assign(_assign({},defaultNodeDefaultSettings),settings);var finalStyles=_assign(_assign({},finalSettings.style),entity.selected?finalSettings.selectedStyle:undefined);return/*#__PURE__*/react.createElement("div",{ref:draggableRef,className:'react_fast_diagram_Node_Default',style:finalStyles},/*#__PURE__*/react.createElement(finalSettings.innerNode,{node:entity}),Array.isArray(finalSettings.ports)&&finalSettings.ports.map(function(p){return/*#__PURE__*/react.createElement(Port,_assign({},p,{key:p.id}));}));});var defaultNodeDefaultSettings={style:{padding:'10px'},selectedStyle:{border:'#6eb7ff solid 1px'},innerNode:NodeLabel};function createNode(settings){return{component:Node,settings:_assign(_assign({},defaultNodeDefaultSettings),settings)};}var createInputOutputHorizontalNode=function createInputOutputHorizontalNode(settings){return createNode(_assign(_assign({},settings),{ports:[{id:'input',type:'input',position:'left-center'},{id:'output',type:'output',position:'right-center'}]}));};var createInputOutputVerticalNode=function createInputOutputVerticalNode(settings){return createNode(_assign(_assign({},settings),{ports:[{id:'input',type:'input',position:'top-center'},{id:'output',type:'output',position:'bottom-center'}]}));};var createInputHorizontalNode=function createInputHorizontalNode(settings){return createNode(_assign(_assign({},settings),{ports:[{id:'input',type:'input',position:'left-center'}]}));};var createInputVerticalNode=function createInputVerticalNode(settings){return createNode(_assign(_assign({},settings),{ports:[{id:'input',type:'input',position:'top-center'}]}));};var createOutputHorizontalNode=function createOutputHorizontalNode(settings){return createNode(_assign(_assign({},settings),{ports:[{id:'output',type:'output',position:'right-center'}]}));};var createOutputVerticalNode=function createOutputVerticalNode(settings){return createNode(_assign(_assign({},settings),{ports:[{id:'output',type:'output',position:'bottom-center'}]}));};var createStarNode=function createStarNode(settings){return createNode(_assign(_assign({},settings),{ports:[{id:'left',position:'left-center'},{id:'top',position:'top-center'},{id:'right',position:'right-center'},{id:'bottom',position:'bottom-center'}]}));};var NodesSettings=/** @class */function(){function NodesSettings(){var _a;var _this=this;this._visualComponents=new VisualComponents((_a={},_a[componentDefaultType]=createNode({ports:[]}),_a.input_output_horizontal=createInputOutputHorizontalNode(),_a.input_output_vertical=createInputOutputVerticalNode(),_a.input_vertical=createInputVerticalNode(),_a.input_horizontal=createInputHorizontalNode(),_a.output_vertical=createOutputVerticalNode(),_a.output_horizontal=createOutputHorizontalNode(),_a.star=createStarNode(),_a));this.import=function(obj){_this._visualComponents.import(obj);_this.setGridSnap(obj===null||obj===void 0?void 0:obj.gridSnap);};this.setGridSnap=function(gridSnap){if(!gridSnap){_this._gridSnap=null;}else if(typeof gridSnap==='number'){_this._gridSnap=[gridSnap,gridSnap];}else if(Array.isArray(gridSnap)&&gridSnap.length===2){_this._gridSnap=gridSnap;}};this.setGridSnap();(0,mobx_esm/* makeAutoObservable */.ky)(this);}Object.defineProperty(NodesSettings.prototype,"visualComponents",{get:function get(){return this._visualComponents;},enumerable:false,configurable:true});Object.defineProperty(NodesSettings.prototype,"gridSnap",{get:function get(){return this._gridSnap;},enumerable:false,configurable:true});return NodesSettings;}();var NodeState=/** @class */function(){function NodeState(rootStore,id,state){var _this=this;this._isDragActive=false;this.import=function(newState){var _a;_this.setPosition(newState===null||newState===void 0?void 0:newState.position);_this.setType(newState===null||newState===void 0?void 0:newState.type);_this.setExtra(newState===null||newState===void 0?void 0:newState.extra);_this.label=(_a=newState===null||newState===void 0?void 0:newState.label)!==null&&_a!==void 0?_a:'';_this._ports=new Map();_this.setIsSelectionEnabled(newState===null||newState===void 0?void 0:newState.isSelectionEnabled);_this.setIsDragEnabled(newState===null||newState===void 0?void 0:newState.isDragEnabled);};this.export=function(){var _a,_b;return _assign({},deepCopy({id:_this._id,label:_this._label,position:_this._position,type:_this._type,extra:_this.extra,isSelectionEnabled:(_a=_this._isSelectionEnabled)!==null&&_a!==void 0?_a:undefined,isDragEnabled:(_b=_this._isDragEnabled)!==null&&_b!==void 0?_b:undefined}));};/**
         ...
         */this.setPosition=function(newPosition,ignoreSnapping){if(ignoreSnapping===void 0){ignoreSnapping=false;}newPosition=newPosition!==null&&newPosition!==void 0?newPosition:[0,0];var remainder=undefined;if(!ignoreSnapping){var result=snapPositionToGrid(newPosition,_this._rootStore.nodesSettings.gridSnap);newPosition=result.position;remainder=result.remainder;}if(arePointsEqual(newPosition,_this._position))return remainder;var lastPos=_this._position;_this._position=newPosition;// Do not notify if position was not initialized before
if(lastPos){_this._rootStore.callbacks.nodePositionChanged(_this,lastPos,_this._position,_this.isDragActive);}return remainder;};this.setType=function(value){_this._type=value!==null&&value!==void 0?value:componentDefaultType;};this.setExtra=function(value){_this._extra=value!==null&&value!==void 0?value:null;};this.getPort=function(portId){if(portId){return _this._ports.get(portId);}else return undefined;};this.addPort=function(port){var _a;if(!port||port.id&&_this._ports.get(port.id)){return errorResult();}var newPort=new PortState(_this._rootStore,(_a=port.id)!==null&&_a!==void 0?_a:guidForcedUniqueness(function(id){return!!_this._ports.get(id);}),_this._id,port);_this._ports.set(newPort.id,newPort);return successValueResult(newPort);};this.removePort=function(portId){if(portId&&_this._ports.get(portId)){_this._ports.delete(portId);_this._rootStore.linksStore.removePortLinks(_this._id,portId);return true;}return false;};this.getPortOrThrowException=function(portId){var port=_this.getPort(portId);if(port)return port;else throw"Port with id '"+portId+"' does not exist in the node '"+_this._id+"'";};this.recalculatePortsSizeAndPosition=function(){_this._ports.forEach(function(p){return p.recalculateSizeAndPosition();});};this.setIsSelectionEnabled=function(value){_this._isSelectionEnabled=isBoolean(value)?value:null;};this.setIsDragEnabled=function(value){_this._isDragEnabled=isBoolean(value)?value:null;};this._rootStore=rootStore;this._id=id;this._ref=new HtmlElementRefState(null);this._selected=false;this.import(state);(0,mobx_esm/* makeAutoObservable */.ky)(this,{// @ts-ignore
_rootStore:false});(0,mobx_esm/* reaction */.U5)(function(){return[_this._id,_this._label,_this._extra,_this._type];},function(){_this.recalculatePortsSizeAndPosition();});}Object.defineProperty(NodeState.prototype,"id",{get:function get(){return this._id;},enumerable:false,configurable:true});Object.defineProperty(NodeState.prototype,"label",{get:function get(){return this._label;},set:function set(value){this._label=value;},enumerable:false,configurable:true});Object.defineProperty(NodeState.prototype,"position",{get:function get(){return this._position;},enumerable:false,configurable:true});Object.defineProperty(NodeState.prototype,"type",{get:function get(){return this._type;},enumerable:false,configurable:true});Object.defineProperty(NodeState.prototype,"selected",{get:function get(){return this._selected;},set:function set(value){this._selected=value;if(!value){this.isDragActive=false;}},enumerable:false,configurable:true});Object.defineProperty(NodeState.prototype,"extra",{get:function get(){return this._extra;},enumerable:false,configurable:true});Object.defineProperty(NodeState.prototype,"ref",{get:function get(){return this._ref;},enumerable:false,configurable:true});Object.defineProperty(NodeState.prototype,"ports",{get:function get(){return this._ports;},enumerable:false,configurable:true});Object.defineProperty(NodeState.prototype,"transformString",{get:function get(){return generateTransform(this._position);},enumerable:false,configurable:true});Object.defineProperty(NodeState.prototype,"componentDefinition",{get:function get(){var visualComponents=this._rootStore.nodesSettings.visualComponents;return visualComponents.getComponent(this.type);},enumerable:false,configurable:true});Object.defineProperty(NodeState.prototype,"realSize",{/**
         * @returns Value is calculated without zoom taking into account, that is, the same as zoom would be '1'.
         * Value can be @type {null} in case reference to real DOM object is not set.
         */get:function get(){return this._ref.realSize;},enumerable:false,configurable:true});Object.defineProperty(NodeState.prototype,"connectedExternalPorts",{get:function get(){var keyValues=Object.values(this.ports).map(function(p){return[p.id,p.connectedPorts];});return Object.fromEntries(keyValues);},enumerable:false,configurable:true});Object.defineProperty(NodeState.prototype,"connectedLinks",{get:function get(){return this._rootStore.linksStore.getNodeLinks(this._id);},enumerable:false,configurable:true});Object.defineProperty(NodeState.prototype,"isSelectionEnabled",{get:function get(){return this._isSelectionEnabled===null?this._rootStore.diagramSettings.userInteraction.nodeSelection:this._isSelectionEnabled;},enumerable:false,configurable:true});Object.defineProperty(NodeState.prototype,"isDragEnabled",{get:function get(){return(this._isDragEnabled===null?this._rootStore.diagramSettings.userInteraction.nodeDrag:this._isDragEnabled)&&this.isSelectionEnabled;},enumerable:false,configurable:true});Object.defineProperty(NodeState.prototype,"isDragActive",{get:function get(){return this._isDragActive;},set:function set(value){if(this._isDragActive!=value){this._isDragActive=value;}},enumerable:false,configurable:true});return NodeState;}();function snapPositionToGrid(position,snap){if(!snap)return{position:position,remainder:undefined};var resultX=snapPositionValueToGridValue(position[0],snap[0]);var resultY=snapPositionValueToGridValue(position[1],snap[1]);return{position:[resultX.value,resultY.value],remainder:[resultX.remainder,resultY.remainder]};}function snapPositionValueToGridValue(value,snapValue){var mod=value%snapValue;var remainder=0;var newValue=value;if(snapValue/2>mod){newValue-=mod;remainder=mod;}else{newValue+=snapValue-mod;remainder=-(snapValue-mod);}return{value:newValue,remainder:remainder};}var NodesStore=/** @class */function(){function NodesStore(rootStore){var _this=this;this._nodes=new Map();this.import=function(newNodes){_this._nodes=new Map();if(newNodes){var results=_this._addNodesInternal(newNodes,false);results.length!=0&&_this._rootStore.callbacks.nodesAdded(results,true);}};this.export=function(){return Array.from(_this._nodes).map(function(_a){_a[0];var value=_a[1];return value.export();});};this.addNodes=function(nodes,rewriteIfExists){if(rewriteIfExists===void 0){rewriteIfExists=false;}var results=_this._addNodesInternal(nodes,rewriteIfExists);results.length!=0&&_this._rootStore.callbacks.nodesAdded(results,false);return results;};this._addNodesInternal=function(nodes,rewriteIfExists){if(!Array.isArray(nodes)||nodes.length==0)return[];var results=nodes.map(function(node){return _this._addNodeInternal(node,rewriteIfExists);});return results;};this.addNode=function(node,rewriteIfExists){if(rewriteIfExists===void 0){rewriteIfExists=false;}var result=_this._addNodeInternal(node,rewriteIfExists);_this._rootStore.callbacks.nodesAdded([result],false);return result;};this._addNodeInternal=function(node,rewriteIfExists){var _a;if(!node)return errorValueResult(node,'Node object is null or undefined');if(!rewriteIfExists&&node.id&&_this._nodes.has(node.id))return errorValueResult(node,"Node with id '"+node.id+"' already exists");var newNode=new NodeState(_this._rootStore,(_a=node.id)!==null&&_a!==void 0?_a:guidForcedUniqueness(function(id){return _this._nodes.has(id);}),node);_this._nodes.set(newNode.id,newNode);return successValueResult(newNode);};this.removeNode=function(nodeId){var node=_this._nodes.get(nodeId);if(node){_this._rootStore.linksStore.removeNodeLinks(nodeId);_this._rootStore.selectionState.unselect(node);_this._nodes.delete(nodeId);return true;}return false;};this.getNode=function(nodeId){return _this._nodes.get(nodeId);};/**
         * @returns Values are calculated without zoom taking into account, that is, the same as zoom would be '1'
         */this.getNodesBoundingBox=function(){var topLeftCorner=[Number.POSITIVE_INFINITY,Number.POSITIVE_INFINITY];var bottomRightCorner=[Number.NEGATIVE_INFINITY,Number.NEGATIVE_INFINITY];_this._nodes.forEach(function(node){var _a;var pos=node.position;var size=(_a=node.realSize)!==null&&_a!==void 0?_a:[0,0];topLeftCorner=[Math.min(topLeftCorner[0],pos[0]),Math.min(topLeftCorner[1],pos[1])];bottomRightCorner=[Math.max(bottomRightCorner[0],pos[0]+size[0]),Math.max(bottomRightCorner[1],pos[1]+size[1])];});if(_this._nodes.size==0){topLeftCorner=[0,0];bottomRightCorner=[100,100];}return{topLeftCorner:topLeftCorner,bottomRightCorner:bottomRightCorner,size:subtractPoints(bottomRightCorner,topLeftCorner)};};(0,mobx_esm/* makeAutoObservable */.ky)(this);this._rootStore=rootStore;}Object.defineProperty(NodesStore.prototype,"nodes",{get:function get(){return this._nodes;},enumerable:false,configurable:true});return NodesStore;}();var PortInnerDefault=(0,es/* observer */.Pi)(function(_a){var port=_a.entity,settings=_a.settings;var finalSettings=_assign(_assign({},portDefaultSettings),settings);var color=finalSettings.color;if(port.dragging)color=finalSettings.dragColor;else if(port.hovered&&port.validForConnection)color=finalSettings.hoverColor;else if(port.hovered&&!port.validForConnection)color=finalSettings.invalidColor;return/*#__PURE__*/react.createElement("div",{style:{width:finalSettings.size[0],height:finalSettings.size[1],opacity:finalSettings.opacity,backgroundColor:color,borderRadius:'2px'}});});var portDefaultSettings={size:[10,10],color:'#6eb7ff',dragColor:'#49f860',hoverColor:'#49f860',invalidColor:'#fa4040'};function createPortInnerDefault(settings){return{component:PortInnerDefault,settings:_assign(_assign({},portDefaultSettings),settings)};}var PortsSettings=/** @class */function(){function PortsSettings(){var _a;var _this=this;this._portVisualComponents=new VisualComponents((_a={},_a[componentDefaultType]=createPortInnerDefault(),_a));this.import=function(obj){_this.portVisualComponents.import({components:obj===null||obj===void 0?void 0:obj.portComponents,defaultType:obj===null||obj===void 0?void 0:obj.portDefaultType});};(0,mobx_esm/* makeAutoObservable */.ky)(this);}Object.defineProperty(PortsSettings.prototype,"portVisualComponents",{get:function get(){return this._portVisualComponents;},enumerable:false,configurable:true});return PortsSettings;}();var SelectionState=/** @class */function(){function SelectionState(){var _this=this;this._selectedItems=[];this.select=function(item,unselectOther){if(unselectOther===void 0){unselectOther=false;}if(unselectOther)_this.unselectAll();if(!item.selected){item.selected=true;_this._selectedItems=__spreadArrays(_this._selectedItems,[item]);return true;}else return false;};this.switch=function(item){if(item.selected){_this.unselect(item);}else{_this.select(item);}};this.unselect=function(item){if(item.selected){item.selected=false;_this._selectedItems=_this._selectedItems.filter(function(i){return i!==item;});return true;}else return false;};this.unselectAll=function(){_this._selectedItems.forEach(function(i){return i.selected=false;});_this._selectedItems=[];};this.unselectItems=function(itemsToClear){itemsToClear.forEach(function(i){return _this.unselect(i);});};(0,mobx_esm/* makeAutoObservable */.ky)(this);}Object.defineProperty(SelectionState.prototype,"selectedItems",{get:function get(){return this._selectedItems;},enumerable:false,configurable:true});Object.defineProperty(SelectionState.prototype,"selectedNodes",{get:function get(){return this.selectedItems.filter(function(i){return i instanceof NodeState;});},enumerable:false,configurable:true});return SelectionState;}();/**
 * Encapsulate logic for dragging mechanism. Right now only nodes are supposed to be dragged.
 */var DragState=/** @class */function(){function DragState(selectionState,callbacks){var _this=this;this._nodesBeingDragged=new Set();// In case the snap to grid option is enabled in settings
this._remaindersFromDrags=new Map();this.startDragging=function(nodeToDrag){if(!nodeToDrag.isDragEnabled||_this.isActive)return;if(nodeToDrag.selected){_this._selectionState.unselectItems(_this._selectionState.selectedItems.filter(function(i){return!(i instanceof NodeState)||!i.isDragEnabled;}));}else{_this._selectionState.unselectAll();_this._selectionState.select(nodeToDrag);}_this._selectionState.selectedNodes.forEach(function(n){n.isDragActive=true;_this._nodesBeingDragged.add(n);});_this._callbacks.dragStateChanged(_this._selectionState.selectedNodes,true);};/**
         * Drag by a vector
         * @param vector vector to drag by which takes into account diagram zoom
         */this.dragBy=function(vector){_this._nodesBeingDragged.forEach(function(n){var newPosition=addPoints(n.position,vector,_this._remaindersFromDrags.get(n.id));var newRemainder=n.setPosition(newPosition);_this._remaindersFromDrags.set(n.id,newRemainder);});};this.stopDragging=function(){_this._nodesBeingDragged.forEach(function(n){return n.isDragActive=false;});_this._nodesBeingDragged.clear();_this._remaindersFromDrags.clear();_this._callbacks.dragStateChanged(_this._selectionState.selectedNodes,false);};(0,mobx_esm/* makeAutoObservable */.ky)(this);this._selectionState=selectionState;this._callbacks=callbacks;}Object.defineProperty(DragState.prototype,"isActive",{get:function get(){return this._nodesBeingDragged.size!==0;},enumerable:false,configurable:true});return DragState;}();var CommandExecutor=/** @class */function(){function CommandExecutor(rootStore){var _this=this;this.execute=function(command){command.execute(_this._rootStore);};(0,mobx_esm/* makeAutoObservable */.ky)(this);this._rootStore=rootStore;}return CommandExecutor;}();var RootStore=/** @class */function(){function RootStore(){var _this=this;this.importState=function(nodes,links){_this._nodesStore.import(nodes);_this._linksStore.import(links);};this.export=function(){return{nodes:_this._nodesStore.export(),links:_this._linksStore.export()};};this.importSettings=function(settings){_this._diagramSettings.import(settings.diagram);_this._nodesSettings.import(settings.nodes);_this._linksSettings.import(settings.links);_this._portsSettings.import(settings.ports);_this._callbacks.import(settings.callbacks);};this._diagramSettings=new DiagramSettings();this._nodesSettings=new NodesSettings();this._linksSettings=new LinksSettings();this._portsSettings=new PortsSettings();this._callbacks=new Callbacks(this);this._diagramState=new DiagramState(this);this._commandExecutor=new CommandExecutor(this);this._nodesStore=new NodesStore(this);this._linksStore=new LinksStore(this);this._selectionState=new SelectionState();this._dragState=new DragState(this._selectionState,this._callbacks);}Object.defineProperty(RootStore.prototype,"diagramState",{get:function get(){return this._diagramState;},enumerable:false,configurable:true});Object.defineProperty(RootStore.prototype,"nodesStore",{get:function get(){return this._nodesStore;},enumerable:false,configurable:true});Object.defineProperty(RootStore.prototype,"linksStore",{get:function get(){return this._linksStore;},enumerable:false,configurable:true});Object.defineProperty(RootStore.prototype,"diagramSettings",{get:function get(){return this._diagramSettings;},enumerable:false,configurable:true});Object.defineProperty(RootStore.prototype,"nodesSettings",{get:function get(){return this._nodesSettings;},enumerable:false,configurable:true});Object.defineProperty(RootStore.prototype,"linksSettings",{get:function get(){return this._linksSettings;},enumerable:false,configurable:true});Object.defineProperty(RootStore.prototype,"portsSettings",{get:function get(){return this._portsSettings;},enumerable:false,configurable:true});Object.defineProperty(RootStore.prototype,"callbacks",{get:function get(){return this._callbacks;},enumerable:false,configurable:true});Object.defineProperty(RootStore.prototype,"selectionState",{get:function get(){return this._selectionState;},enumerable:false,configurable:true});Object.defineProperty(RootStore.prototype,"dragState",{get:function get(){return this._dragState;},enumerable:false,configurable:true});Object.defineProperty(RootStore.prototype,"commandExecutor",{get:function get(){return this._commandExecutor;},enumerable:false,configurable:true});return RootStore;}();function styleInject(css,ref){if(ref===void 0)ref={};var insertAt=ref.insertAt;if(!css||typeof document==='undefined'){return;}var head=document.head||document.getElementsByTagName('head')[0];var style=document.createElement('style');style.type='text/css';if(insertAt==='top'){if(head.firstChild){head.insertBefore(style,head.firstChild);}else{head.appendChild(style);}}else{head.appendChild(style);}if(style.styleSheet){style.styleSheet.cssText=css;}else{style.appendChild(document.createTextNode(css));}}var css_248z=".react_fast_diagram_DiagramInner {\n  width: 100%;\n  height: 100%;\n  min-height: 100%;\n  position: relative;\n  overflow: hidden;\n  touch-action: none;\n  -webkit-user-select: none;\n     -moz-user-select: none;\n      -ms-user-select: none;\n          user-select: none;\n}\n\n.react_fast_diagram_DiagramInner * {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box;\n  color: black;\n}\n\n.react_fast_diagram_DiagramInner_DraggablePart {\n  width: 100%;\n  height: 100%;\n  position: absolute;\n  overflow: visible;\n  transform-origin: 0px 0px;\n  top: 0px;\n  left: 0px;\n  /* useGestures hook use targetTouches instead of simply touches, \n  so we should set this property to Movable, otherwise if user put \n  one finger above Movable and another above DiagramInner, the hook \n  will not trigger pinch gesture */\n  pointer-events: none;\n}\n\n.react_fast_diagram_Layer {\n  position: absolute;\n  width: 100%;\n  height: 100%;\n  top: 0;\n  left: 0;  \n  overflow: visible;\n}\n\n.react_fast_diagram_NodeWrapper {\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: -webkit-fit-content;\n  width: -moz-fit-content;\n  width: fit-content;\n  height: -webkit-fit-content;\n  height: -moz-fit-content;\n  height: fit-content;\n  pointer-events: auto;\n}\n\n.react_fast_diagram_Node_Default {\n  min-width: 10px;\n  min-height: 10px;\n  border-radius: 3px;\n  background-color: white;\n  border: #c2c2c2 solid 1px;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  text-align: center;\n  margin: auto;\n  font-size: small;\n}\n\n.react_fast_diagram_PortContainer_Default {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n\n.react_fast_diagram_Node_Default > * {\n  text-align: center;\n  margin: auto;\n}\n\n.react_fast_diagram_disabled_user_select {\n  -webkit-user-select: none;\n     -moz-user-select: none;\n      -ms-user-select: none;\n          user-select: none;\n}\n\n.react_fast_diagram_BackgroundWrapper {\n  height: 100%;\n  width: 100%;\n  pointer-events: none;\n}\n\n.react_fast_diagram_Background_Default {\n  height: 100%;\n  width: 100%;\n}\n\n.react_fast_diagram_Minicontrol_Default {\n  position: absolute;\n  height: -webkit-fit-content;\n  height: -moz-fit-content;\n  height: fit-content;\n  display: flex;\n  flex-direction: column;\n}\n\n.react_fast_diagram_Minicontrol_Default_Btn {\n  background-color: white; \n  border: 1px solid rgb(209, 209, 209);\n  color: black; \n  padding: 2px;\n  font-size: 16px;\n  cursor: pointer;\n  text-align: center;\n}\n\n@media(hover: hover) and (pointer: fine) {\n  .react_fast_diagram_Minicontrol_Default_Btn:hover {\n    background-color: rgb(228, 228, 228);\n  }\n}\n\n.react_fast_diagram_Port {\n  cursor: pointer;\n}\n\n/* Containers with gap between items */\n\n.react_fast_diagram_flex_gap {\n  --gap: 12px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n\n.react_fast_diagram_flex_gap_y {\n  flex-direction: column;\n  height: 100%;\n}\n\n.react_fast_diagram_flex_gap_y > * {\n  margin: var(--gap) 0 0 0;\n}\n\n.react_fast_diagram_flex_gap_y > :first-child {\n  margin: 0;\n}\n\n.react_fast_diagram_flex_gap_x {\n  flex-direction: row;\n  width: 100%;\n}\n\n.react_fast_diagram_flex_gap_x > * {\n  margin: 0 0 0 var(--gap);\n}\n\n.react_fast_diagram_flex_gap_x > :first-child {\n  margin: 0;\n}\n\n/* Containers with gap between items */\n";styleInject(css_248z);var RootStoreContext=/*#__PURE__*/react.createContext(null);function _Diagram(props){var rootStore=(0,react.useMemo)(function(){var _a,_b,_c,_d;var store=new RootStore();props.settings&&store.importSettings(props.settings);store.importState((_b=(_a=props.initState)===null||_a===void 0?void 0:_a.nodes)!==null&&_b!==void 0?_b:[],(_d=(_c=props.initState)===null||_c===void 0?void 0:_c.links)!==null&&_d!==void 0?_d:[]);return store;},[]);(0,react.useEffect)(function(){if(props.storeRef){props.storeRef.current=rootStore;}},[rootStore,props.storeRef]);return/*#__PURE__*/react.createElement(RootStoreContext.Provider,{value:rootStore},/*#__PURE__*/react.createElement(InnerDiagram,null));}_Diagram.displayName='Diagram';var useRootStore=function useRootStore(){return (0,react.useContext)(RootStoreContext);};var BackgroundWrapper=(0,es/* observer */.Pi)(function(){var _a=useRootStore(),diagramSettings=_a.diagramSettings,diagramState=_a.diagramState;return/*#__PURE__*/react.createElement("div",{className:'react_fast_diagram_BackgroundWrapper'},/*#__PURE__*/react.createElement(diagramSettings.backgroundComponentState.component,{diagramOffset:diagramState.offset,diagramZoom:diagramState.zoom,settings:diagramSettings.backgroundComponentState.settings}));});var positionValues=['left','top','right','bottom'];var PortsContainer=(0,es/* observer */.Pi)(function(_a){var position=_a.position,ports=_a.ports,style=_a.style,gapBetweenPorts=_a.gapBetweenPorts,offsetFromOriginPosition=_a.offsetFromOriginPosition;var portsModified=(0,react.useMemo)(function(){return ports&&ports.map(function(p){return _assign({linkDirection:positionToDirection[position]},p);});},[position,ports]);if(!portsModified||portsModified.length===0)return null;var className='react_fast_diagram_flex_gap ';if(position==='top'||position==='bottom'){className+='react_fast_diagram_flex_gap_x';}else{className+='react_fast_diagram_flex_gap_y';}var positionStyle={position:'absolute',left:position==='left'?0:undefined,top:position==='left'||position==='right'||position==='top'?0:undefined,right:position==='right'?0:undefined,bottom:position==='bottom'?0:undefined,height:position==='left'||position==='right'?'100%':undefined,width:position==='top'||position==='bottom'?'100%':undefined};var offsetFromOriginPositionStyle={};if(offsetFromOriginPosition&&positionValues.includes(position)){offsetFromOriginPositionStyle[position]=-offsetFromOriginPosition;}return/*#__PURE__*/react.createElement("div",{className:className,style:_assign(_assign(_assign({// @ts-ignore
'--gap':gapBetweenPorts},style),positionStyle),offsetFromOriginPositionStyle)},portsModified&&portsModified.map(function(port){return/*#__PURE__*/react.createElement(Port,_assign({},port,{key:port.id}));}));});var positionToDirection={left:'left',top:'up',right:'right',bottom:'down'};function createPortsContainer(settings){return function(props){return/*#__PURE__*/react.createElement(PortsContainer,_assign({},_assign(_assign({},defaultPortsContainerSettings),settings),props));};}var defaultPortsContainerSettings={gapBetweenPorts:'8px'};var useDiagram=function useDiagram(initState,settings){var storeRef=useNotifyRef(null);var obj=(0,react.useMemo)(function(){return{Diagram:function Diagram(){return/*#__PURE__*/react.createElement(_Diagram,{storeRef:storeRef,initState:initState,settings:settings});},storeRef:storeRef};},[]);return obj;};function straightLinkPathConstructor(source,target){var path="M "+source.point[0]+" "+source.point[1]+", "+target.point[0]+" "+target.point[1];return path;}function createStraightLinkPathConstructor(){return straightLinkPathConstructor;}
...
"use strict";
/* harmony import */ var C_Users_tokar_Desktop_react_easy_diagram_node_modules_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9603);
/* harmony import */ var C_Users_tokar_Desktop_react_easy_diagram_node_modules_babel_runtime_helpers_esm_objectWithoutPropertiesLoose__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(120);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var IconMenu=function IconMenu(_ref){var _ref$width=_ref.width,width=_ref$width===void 0?30:_ref$width,_ref$height=_ref.height,height=_ref$height===void 0?30:_ref$height,className=_ref.className,restProps=(0,C_Users_tokar_Desktop_react_easy_diagram_node_modules_babel_runtime_helpers_esm_objectWithoutPropertiesLoose__WEBPACK_IMPORTED_MODULE_1__/* .default */ .Z)(_ref,["width","height","className"]);return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("svg",(0,C_Users_tokar_Desktop_react_easy_diagram_node_modules_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_2__/* .default */ .Z)({"aria-label":"Menu",className:className,width:width,height:height,viewBox:"0 0 30 30",role:"img",focusable:"false"},restProps),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("title",null,"Menu"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("path",{stroke:"currentColor",strokeLinecap:"round",strokeMiterlimit:"10",strokeWidth:"2",d:"M4 7h22M4 15h22M4 23h22"}));};/* harmony default export */ __webpack_exports__["Z"] = (IconMenu);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Logo=function Logo(props){var _useDocusaurusContext=(0,_docusaurus_useDocusaurusContext__WEBPACK_IMPORTED_MODULE_4__.default)(),isClient=_useDocusaurusContext.isClient;var _useThemeConfig=(0,_docusaurus_theme_common__WEBPACK_IMPORTED_MODULE_5__/* .useThemeConfig */ .LU)(),_useThemeConfig$navba=_useThemeConfig.navbar,title=_useThemeConfig$navba.title,_useThemeConfig$navba2=_useThemeConfig$navba.logo,logo=_useThemeConfig$navba2===void 0?{src:''}:_useThemeConfig$navba2;var imageClassName=props.imageClassName,titleClassName=props.titleClassName,propsRest=(0,C_Users_tokar_Desktop_react_easy_diagram_node_modules_babel_runtime_helpers_esm_objectWithoutPropertiesLoose__WEBPACK_IMPORTED_MODULE_6__/* .default */ .Z)(props,["imageClassName","titleClassName"]);var logoLink=(0,_docusaurus_useBaseUrl__WEBPACK_IMPORTED_MODULE_3__/* .default */ .Z)(logo.href||'/');var sources={light:(0,_docusaurus_useBaseUrl__WEBPACK_IMPORTED_MODULE_3__/* .default */ .Z)(logo.src),dark:(0,_docusaurus_useBaseUrl__WEBPACK_IMPORTED_MODULE_3__/* .default */ .Z)(logo.srcDark||logo.src)};return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_docusaurus_Link__WEBPACK_IMPORTED_MODULE_1__/* .default */ .Z,(0,C_Users_tokar_Desktop_react_easy_diagram_node_modules_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_7__/* .default */ .Z)({to:logoLink},propsRest,logo.target&&{target:logo.target}),logo.src&&/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_theme_ThemedImage__WEBPACK_IMPORTED_MODULE_2__/* .default */ .Z,{key:isClient,className:imageClassName,sources:sources,alt:logo.alt||title||'Logo'}),title!=null&&/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("strong",{className:titleClassName},title));};/* harmony default export */ __webpack_exports__["Z"] = (Logo);
...
"use strict";
/* harmony import */ var C_Users_tokar_Desktop_react_easy_diagram_node_modules_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(9603);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function NavLink(_ref){var activeBasePath=_ref.activeBasePath,activeBaseRegex=_ref.activeBaseRegex,to=_ref.to,href=_ref.href,label=_ref.label,_ref$activeClassName=_ref.activeClassName,activeClassName=_ref$activeClassName===void 0?'navbar__link--active':_ref$activeClassName,prependBaseUrlToHref=_ref.prependBaseUrlToHref,props=(0,C_Users_tokar_Desktop_react_easy_diagram_node_modules_babel_runtime_helpers_esm_objectWithoutPropertiesLoose__WEBPACK_IMPORTED_MODULE_4__/* .default */ .Z)(_ref,["activeBasePath","activeBaseRegex","to","href","label","activeClassName","prependBaseUrlToHref"]);// TODO all this seems hacky
// {to: 'version'} should probably be forbidden, in favor of {to: '/version'}
var toUrl=(0,_docusaurus_useBaseUrl__WEBPACK_IMPORTED_MODULE_2__/* .default */ .Z)(to);var activeBaseUrl=(0,_docusaurus_useBaseUrl__WEBPACK_IMPORTED_MODULE_2__/* .default */ .Z)(activeBasePath);var normalizedHref=(0,_docusaurus_useBaseUrl__WEBPACK_IMPORTED_MODULE_2__/* .default */ .Z)(href,{forcePrependBaseUrl:true});return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_docusaurus_Link__WEBPACK_IMPORTED_MODULE_1__/* .default */ .Z,(0,C_Users_tokar_Desktop_react_easy_diagram_node_modules_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_5__/* .default */ .Z)({},href?{href:prependBaseUrlToHref?normalizedHref:href}:Object.assign({isNavLink:true,activeClassName:activeClassName,to:toUrl},activeBasePath||activeBaseRegex?{isActive:function isActive(_match,location){return activeBaseRegex?new RegExp(activeBaseRegex).test(location.pathname):location.pathname.startsWith(activeBaseUrl);}}:null),props),label);}function NavItemDesktop(_ref2){var _props$children;var items=_ref2.items,position=_ref2.position,className=_ref2.className,props=(0,C_Users_tokar_Desktop_react_easy_diagram_node_modules_babel_runtime_helpers_esm_objectWithoutPropertiesLoose__WEBPACK_IMPORTED_MODULE_4__/* .default */ .Z)(_ref2,["items","position","className"]);var dropdownRef=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);var dropdownMenuRef=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);var _useState=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false),showDropdown=_useState[0],setShowDropdown=_useState[1];(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function(){var handleClickOutside=function handleClickOutside(event){if(!dropdownRef.current||dropdownRef.current.contains(event.target)){return;}setShowDropdown(false);};document.addEventListener('mousedown',handleClickOutside);document.addEventListener('touchstart',handleClickOutside);return function(){document.removeEventListener('mousedown',handleClickOutside);document.removeEventListener('touchstart',handleClickOutside);};},[dropdownRef]);var navLinkClassNames=function navLinkClassNames(extraClassName,isDropdownItem){if(isDropdownItem===void 0){isDropdownItem=false;}return (0,clsx__WEBPACK_IMPORTED_MODULE_6__/* .default */ .Z)({'navbar__item navbar__link':!isDropdownItem,dropdown__link:isDropdownItem},extraClassName);};if(!items){return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(NavLink,(0,C_Users_tokar_Desktop_react_easy_diagram_node_modules_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_5__/* .default */ .Z)({className:navLinkClassNames(className)},props));}return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div",{ref:dropdownRef,className:(0,clsx__WEBPACK_IMPORTED_MODULE_6__/* .default */ .Z)('navbar__item','dropdown','dropdown--hoverable',{'dropdown--left':position==='left','dropdown--right':position==='right','dropdown--show':showDropdown})},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(NavLink,(0,C_Users_tokar_Desktop_react_easy_diagram_node_modules_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_5__/* .default */ .Z)({className:navLinkClassNames(className)},props,{onClick:props.to?undefined:function(e){return e.preventDefault();},onKeyDown:function onKeyDown(e){if(e.key==='Enter'){e.preventDefault();setShowDropdown(!showDropdown);}}}),(_props$children=props.children)!=null?_props$children:props.label),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("ul",{ref:dropdownMenuRef,className:"dropdown__menu"},items.map(function(_ref3,i){var childItemClassName=_ref3.className,childItemProps=(0,C_Users_tokar_Desktop_react_easy_diagram_node_modules_babel_runtime_helpers_esm_objectWithoutPropertiesLoose__WEBPACK_IMPORTED_MODULE_4__/* .default */ .Z)(_ref3,["className"]);return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("li",{key:i},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(NavLink,(0,C_Users_tokar_Desktop_react_easy_diagram_node_modules_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_5__/* .default */ .Z)({onKeyDown:function onKeyDown(e){if(i===items.length-1&&e.key==='Tab'){e.preventDefault();setShowDropdown(false);var nextNavbarItem=dropdownRef.current.nextElementSibling;if(nextNavbarItem){nextNavbarItem.focus();}}},activeClassName:"dropdown__link--active",className:navLinkClassNames(childItemClassName,true)},childItemProps)));})));}function NavItemMobile(_ref4){var _menuListRef$current,_menuListRef$current2,_props$children2;var items=_ref4.items,className=_ref4.className,_position=_ref4.position,props=(0,C_Users_tokar_Desktop_react_easy_diagram_node_modules_babel_runtime_helpers_esm_objectWithoutPropertiesLoose__WEBPACK_IMPORTED_MODULE_4__/* .default */ .Z)(_ref4,["items","className","position"]);var menuListRef=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);var _useLocation=(0,_docusaurus_router__WEBPACK_IMPORTED_MODULE_7__/* .useLocation */ .TH)(),pathname=_useLocation.pathname;var _useState2=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(function(){var _items$some;return(_items$some=!(items!=null&&items.some(function(item){return (0,_docusaurus_theme_common__WEBPACK_IMPORTED_MODULE_3__/* .isSamePath */ .Mg)(item.to,pathname);})))!=null?_items$some:true;}),collapsed=_useState2[0],setCollapsed=_useState2[1];var navLinkClassNames=function navLinkClassNames(extraClassName,isSubList){if(isSubList===void 0){isSubList=false;}return (0,clsx__WEBPACK_IMPORTED_MODULE_6__/* .default */ .Z)('menu__link',{'menu__link--sublist':isSubList},extraClassName);};if(!items){return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("li",{className:"menu__list-item"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(NavLink,(0,C_Users_tokar_Desktop_react_easy_diagram_node_modules_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_5__/* .default */ .Z)({className:navLinkClassNames(className)},props)));}var menuListHeight=(_menuListRef$current=menuListRef.current)!=null&&_menuListRef$current.scrollHeight?((_menuListRef$current2=menuListRef.current)==null?void 0:_menuListRef$current2.scrollHeight)+"px":undefined;return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("li",{className:(0,clsx__WEBPACK_IMPORTED_MODULE_6__/* .default */ .Z)('menu__list-item',{'menu__list-item--collapsed':collapsed})},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(NavLink,(0,C_Users_tokar_Desktop_react_easy_diagram_node_modules_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_5__/* .default */ .Z)({role:"button",className:navLinkClassNames(className,true)},props,{onClick:function onClick(e){e.preventDefault();setCollapsed(function(state){return!state;});}}),(_props$children2=props.children)!=null?_props$children2:props.label),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("ul",{className:"menu__list",ref:menuListRef,style:{height:!collapsed?menuListHeight:undefined}},items.map(function(_ref5,i){var childItemClassName=_ref5.className,childItemProps=(0,C_Users_tokar_Desktop_react_easy_diagram_node_modules_babel_runtime_helpers_esm_objectWithoutPropertiesLoose__WEBPACK_IMPORTED_MODULE_4__/* .default */ .Z)(_ref5,["className"]);return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("li",{className:"menu__list-item",key:i},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(NavLink,(0,C_Users_tokar_Desktop_react_easy_diagram_node_modules_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_5__/* .default */ .Z)({activeClassName:"menu__link--active",className:navLinkClassNames(childItemClassName)},childItemProps,{onClick:props.onClick})));})));}function DefaultNavbarItem(_ref6){var _ref6$mobile=_ref6.mobile,mobile=_ref6$mobile===void 0?false:_ref6$mobile,props=(0,C_Users_tokar_Desktop_react_easy_diagram_node_modules_babel_runtime_helpers_esm_objectWithoutPropertiesLoose__WEBPACK_IMPORTED_MODULE_4__/* .default */ .Z)(_ref6,["mobile"]);var Comp=mobile?NavItemMobile:NavItemDesktop;return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Comp,props);}/* harmony default export */ __webpack_exports__["Z"] = (DefaultNavbarItem);
...
var _require=__webpack_require__(124),transform=_require.transform,bubleFeatures=_require.features;// This file is designed to mimic what's written in
...
__webpack_unused_export__=bubleFeatures;exports.v=function customTransform(source,options){return transform(source,Object.assign({},options,{transforms:{asyncAwait:false}}));};
...
var custom_buble = __webpack_require__(5597);
...
var CodeEditor = function (_Component) {
  ...
  CodeEditor.prototype.render = function render() {
    ...
    return react.createElement(lib/* default */.Z, react_live_es_extends({
      value: code,
      padding: 10,
...
var transform$1 = (function (code) {
  return (0,custom_buble/* transform */.v)(code, opts).code;
});
...
// eslint-disable-next-line consistent-return
  ...
  evalCode(transform$1(code), react_live_es_extends({}, scope, { render: render }));
};
...
function LiveEditor(props) {
  return react.createElement(
    ...
    function (_ref) {
      ...
      return react.createElement(CodeEditor, react_live_es_extends({
        theme: theme,
        code: code,
        language: language,
        disabled: disabled,
  ...
  var WithLive = function (_Component) {
    ...
    WithLive.prototype.render = function render() {
      ...
      return React.createElement(
        ...
        null,
        function (live) {
          return React.createElement(WrappedComponent, react_live_es_extends({ live: live }, _this2.props));
        }
      );
    };
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function Playground(_ref){var children=_ref.children,theme=_ref.theme,transformCode=_ref.transformCode,props=(0,objectWithoutPropertiesLoose/* default */.Z)(_ref,["children","theme","transformCode"]);return/*#__PURE__*/react.createElement(LiveProvider,(0,esm_extends/* default */.Z)({code:children.replace(/\n$/,''),transformCode:transformCode||function(code){return code+";";},theme:theme},props),/*#__PURE__*/react.createElement("div",{className:styles_module.playgroundPreview},/*#__PURE__*/react.createElement(LivePreview,null)),/*#__PURE__*/react.createElement(EditorWithHeader,null));}function EditorWithHeader(){return/*#__PURE__*/react.createElement(react.Fragment,null,/*#__PURE__*/react.createElement(Header,{translateId:"theme.Playground.liveEditor",description:"The live editor label of the live codeblocks",text:"Live Editor"}),/*#__PURE__*/react.createElement(LiveEditor,{className:styles_module.playgroundEditor}),/*#__PURE__*/react.createElement(LiveError,null));}function Header(_ref2){var translateId=_ref2.translateId,description=_ref2.description,text=_ref2.text;return/*#__PURE__*/react.createElement("div",{className:(0,clsx_m/* default */.Z)(styles_module.playgroundHeader)},/*#__PURE__*/react.createElement(Translate/* default */.Z,{id:translateId,description:description},text));}
...
var ReactLiveScope=Object.assign({React:react},react,index_esm,{observer:es/* observer */.Pi});/* harmony default export */ var theme_ReactLiveScope = (ReactLiveScope);
...
var useThemeContext = __webpack_require__(9237);
// EXTERNAL MODULE: ../node_modules/@docusaurus/theme-common/lib/index.js
var theme_common_lib = __webpack_require__(4801);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var usePrismTheme=function usePrismTheme(){var _useThemeConfig=(0,theme_common_lib/* useThemeConfig */.LU)(),prism=_useThemeConfig.prism;var _useThemeContext=(0,useThemeContext/* default */.Z)(),isDarkTheme=_useThemeContext.isDarkTheme;var lightModeTheme=prism.theme||palenight;var darkModeTheme=prism.darkTheme||lightModeTheme;var prismTheme=isDarkTheme?darkModeTheme:lightModeTheme;return prismTheme;};/* harmony default export */ var hooks_usePrismTheme = (usePrismTheme);
;// CONCATENATED MODULE: ../node_modules/@docusaurus/theme-classic/lib-next/theme/CodeBlock/styles.module.css
// extracted by mini-css-extract-plugin
/* harmony default export */ var CodeBlock_styles_module = ({"codeBlockContainer":"codeBlockContainer_1ukp","codeBlockContent":"codeBlockContent_3Y8q","codeBlockTitle":"codeBlockTitle_befg","codeBlock":"codeBlock_2Xgr","codeBlockWithTitle":"codeBlockWithTitle_FyOu","copyButton":"copyButton_1mju","codeBlockLines":"codeBlockLines_3Zfi"});
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var withLiveEditor=function withLiveEditor(Component){var WrappedComponent=function WrappedComponent(props){if(props.live){return/*#__PURE__*/react.createElement(Playground,(0,esm_extends/* default */.Z)({scope:theme_ReactLiveScope},props));}return/*#__PURE__*/react.createElement(Component,props);};return WrappedComponent;};/* harmony default export */ var theme_CodeBlock = (withLiveEditor(CodeBlock));
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "G": function() { return /* binding */ DiagramContainer; }
});
...
var isObject = __webpack_require__(1687);
module.exports = function (it) {
