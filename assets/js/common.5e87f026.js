...
__webpack_require__.d(__webpack_exports__, {
  ...
  "Diagram": function() { return /* binding */ Diagram; },
...
// EXTERNAL MODULE: ../node_modules/mobx/dist/mobx.esm.js
var mobx_esm = __webpack_require__(9588);
;// CONCATENATED MODULE: ./node_modules/react-easy-diagram/dist/index.esm.js
...
var BackgroundDefault = (0,es/* observer */.Pi)(function (_a) {
    ...
    var backgroundImage = (0,react.useMemo)(function () {
...
var useNotifyRef = function (init) {
    var _a = (0,react.useState)(0); _a[0]; var forceUpdate = _a[1];
...
var useLinkUserInteraction = function (linkState) {
    ...
    var selectionHandledRef = (0,react.useRef)(false);
    var selectionTimeoutRef = (0,react.useRef)(null);
...
var LinkWrapper = (0,es/* observer */.Pi)(function (_a) {
    var link = _a.link;
...
var LinksLayer = (0,es/* observer */.Pi)(function (_a) {
...
var HtmlElementRefState = /** @class */ (function () {
    function HtmlElementRefState(initValue) {
        ...
        this.offsetRelativeToParent = function (parent) {
            _this._triggerSizePositionRecalculation | 1;
            if (_this.current) {
                var iterElement = _this.current;
                var nextOffsetParent = null;
                var acumLeft = 0;
                var acumTop = 0;
                while (parent !== iterElement && iterElement) {
                    if (!nextOffsetParent || nextOffsetParent === iterElement) {
                        var translate = getTranslate(iterElement);
...
var PortState = /** @class */ (function () {
    function PortState(rootStore, id, nodeId, state) {
        ...
        this.update = function (state) {
            ...
            state.isConnectionEnabled && _this.setIsConnectionEnabled(state.isConnectionEnabled);
        };
        this.export = function () {
            var _a, _b;
            return deepCopy({
        ...
        (0,mobx_esm/* makeAutoObservable */.ky)(this);
        this._rootStore = rootStore;
        (0,mobx_esm/* reaction */.U5)(function () { return [
            _this._id,
            _this._nodeId,
            _this._label,
            _this._type,
...
var NodeState = /** @class */ (function () {
    function NodeState(rootStore, id, state) {
        ...
        this.getPort = function (portId) {
            if (portId && _this._ports[portId]) {
                return _this._ports[portId];
            }
            else
                return undefined;
        };
        this.addPort = function (port) {
            var _a;
            if (!port || (port.id && _this._ports[port.id])) {
                return errorResult();
            }
            var newPort = new PortState(_this._rootStore, (_a = port.id) !== null && _a !== void 0 ? _a : guidForcedUniqueness(function (id) { return !!_this._ports[id]; }), _this._id, port);
            _this._ports[newPort.id] = newPort;
            return successValueResult(newPort);
        };
        this.removePort = function (portId) {
            if (portId && _this._ports[portId]) {
                delete _this._ports[portId];
        ...
        this.recalculatePortsSizeAndPosition = function () {
            Object.values(_this._ports).forEach(function (p) { return p.recalculateSizeAndPosition(); });
        };
        this.setIsSelectionEnabled = function (value) {
            _this._isSelectionEnabled = isBoolean(value) ? value : null;
        };
        ...
        (0,mobx_esm/* reaction */.U5)(function () { return [_this._id, _this._label, _this._extra, _this._type]; }, function () {
...
function useCursor(active, cursor, ref) {
    var cursorBeforeSetRef = (0,react.useRef)('');
    (0,react.useEffect)(function () {
...
var useNodeUserInteraction = function (nodeState) {
    ...
    var remainderFromPreviousDragEventRef = (0,react.useRef)(new Map());
    var selectionHandledRef = (0,react.useRef)(false);
    var selectionTimeoutRef = (0,react.useRef)(null);
    var userInteractionElemRef = (0,react.useRef)(null);
    var handlers = (0,react.useMemo)(function () { return ({
        onDrag: function (_a) {
            var pinching = _a.pinching, delta = _a.delta, ctrlKey = _a.ctrlKey, movement = _a.movement;
            if (!activeRef.current ||
                pinching ||
                canDragGestureBeTapInstead(movement)) {
                return;
            }
            else if (nodeState.isSelectionEnabled &&
                !nodeState.selected &&
                !selectionHandledRef.current) {
                ...
                rootStore.selectionState.selectedItems
                    .filter(function (i) { return i instanceof NodeState; })
                    .forEach(function (n) {
                    var _a;
                    var newPosition = addPoints(n.position, multiplyPoint(delta, 1 / rootStore.diagramState.zoom), (_a = remainderFromPreviousDragEventRef.current.get(n)) !== null && _a !== void 0 ? _a : [0, 0]);
...
var NodeWrapper = (0,es/* observer */.Pi)(function (_a) {
    var node = _a.node;
...
var usePortsCleanUp = function (node) {
    ...
    var renderedPortsContextValue = (0,react.useMemo)(function () { return ({
        render: function (id) {
    ...
    (0,react.useEffect)(function () {
        ...
        (0,mobx_esm/* action */.aD)(function () { return extraPortsIds.forEach(function (id) { return node.removePort(id); }); });
    }, [renderedPortsRef.current]);
    return renderedPortsContextValue;
};

var NodesLayer = (0,es/* observer */.Pi)(function (_a) {
    var nodesStore = _a.nodesStore;
    var rootStore = useRootStore();
    (0,react.useEffect)(function () {
        rootStore.diagramState.zoomToFit();
    }, []);
    return (react.createElement("div", null, Array.from(nodesStore.nodes).map(function (_a) {
        _a[0]; var node = _a[1];
...
var useDiagramUserInteraction = function () {
    var diagramState = useRootStore().diagramState;
    var cancelGesture = (0,react.useCallback)(function (event) { return event.target !== diagramState.diagramInnerRef.current; }, [diagramState.diagramInnerRef]);
...
var MiniControlWrapper = (0,es/* observer */.Pi)(function () {
    var rootStore = useRootStore();
...
var InnerDiagram = (0,es/* observer */.Pi)(function (props) {
    var rootStore = useRootStore();
    var transform = useDiagramUserInteraction().transform;
    (0,react.useEffect)(function () {
        var resizeHandler = function () { return rootStore.nodesStore.nodes.forEach(function (n) { return n.recalculatePortsSizeAndPosition(); }); };
...
var Callbacks = /** @class */ (function () {
    ...
    Object.defineProperty(Callbacks.prototype, "validateLinkEndpoints", {
        get: function () {
...
var MiniControlDefault = (0,es/* observer */.Pi)(function (_a) {
    ...
    return (react.createElement("div", { className: 'react_fast_diagram_Minicontrol_Default', style: __assign(__assign({}, getOffsetStyles(settings)), settings === null || settings === void 0 ? void 0 : settings.containerStyle) },
        settings.buttons.deleteSelection &&
            rootStore.selectionState.selectedItems.length > 0 && (react.createElement(Button, { size: settings.buttonsSize, onClick: rootStore.selectionState.removeSelected },
            react.createElement(RubbishBinIcon, null))),
        settings.buttons.cloneSelectedNodes &&
            rootStore.selectionState.selectedItems.length > 0 && (react.createElement(Button, { size: settings.buttonsSize, onClick: rootStore.selectionState.cloneSelectedNodes },
...
var DiagramState = /** @class */ (function () {
    function DiagramState(rootStore) {
        ...
        this.zoomIn = function () { return _this._rootStore.diagramState.zoomIntoCenter(1 / 0.8); };
        this.zoomOut = function () { return _this._rootStore.diagramState.zoomIntoCenter(0.8); };
        ...
        this.zoomIntoCenter = function (zoomMultiplicator) {
            ...
            if (!diagramRealSize)
                return;
            _this._rootStore.diagramState.zoomInto(multiplyPoint(diagramRealSize, 0.5), zoomMultiplicator);
        };
    ...
    function LinkCreationState(rootStore) {
        ...
        this.stopLinking = function () {
            if (_this._targetPortCandidate && _this._source) {
                ...
                if (result.success) {
                    _this._rootStore.selectionState.select(result.value, false);
                }
            }
            _this._resetProps();
        };
...
var LinkDefault = (0,es/* observer */.Pi)(function (_a) {
    ...
    return (react.createElement("g", null,
        react.createElement("path", { d: path.svgPath, stroke: color, strokeWidth: finalSettings.strokeWidth, fill: 'none', strokeLinecap: "round" }),
        react.createElement("path", __assign({ d: path.svgPath, stroke: color, strokeWidth: finalSettings.strokeWidth + 5 }, bind(), { pointerEvents: 'auto', fill: "none", strokeLinecap: "round", strokeOpacity: entity.hovered ? 0.22 : 0 })),
        entity instanceof LinkCreationState && (react.createElement("circle", { cx: path.target[0], cy: path.target[1], r: finalSettings.cirleRadius, fill: 'orange' }))));
});
...
function curvedLinkPathConstructor(source, target, settings) {
    if (!source || !target)
        return '';
    var sourcePoint = roundPoint(source.point);
    var targetPoint = roundPoint(target.point);
    var sourceStr = source.point[0] + ", " + source.point[1];
    var targetStr = target.point[0] + ", " + target.point[1];
    var directionFactor = settings.tweakDirectionFactorBasedOnDistance(distanceBetweenPoints(sourcePoint, targetPoint), settings.directionFactor);
    function getControl(endpoint, direction) {
        switch (direction) {
            case 'left':
            ...
            case 'down':
                return createControl(endpoint[0], endpoint[1] + directionFactor);
            case 'left-up':
                return createControl(endpoint[0] - directionFactor, endpoint[1] - directionFactor);
            case 'right-up':
                return createControl(endpoint[0] + directionFactor, endpoint[1] - directionFactor);
            case 'right-down':
                return createControl(endpoint[0] + directionFactor, endpoint[1] + directionFactor);
    ...
    if (source.direction || target.direction) {
        var sourceControl = getControl(sourcePoint, source.direction);
        var targetControl = getControl(targetPoint, target.direction);
...
var LinksSettings = /** @class */ (function () {
    function LinksSettings() {
        ...
        this._visualComponents = new VisualComponents((_a = {},
            ...
            _a[linkCreationComponentType] = LinkDefault,
            _a));
        this.import = function (obj) {
            var _a;
...
var LinksStore = /** @class */ (function () {
    function LinksStore(rootStore) {
        ...
        this.validateLink = function (link) {
            ...
            if (((_b = (_a = _this._rootStore.callbacks).validateLinkEndpoints) === null || _b === void 0 ? void 0 : _b.call(_a, sourcePortResult.value, targetPortResult.value, _this._rootStore)) === false) {
...
var NodeLabel = (0,es/* observer */.Pi)(function (_a) {
    var node = _a.node;
...
var Port = (0,es/* observer */.Pi)(function (props) {
    var node = (0,react.useContext)(NodeContext); // node should already exist
...
var useRenderingReport = function (id) {
    var _a = (0,react.useContext)(RenderedPortsComponentsContext), render = _a.render, unrender = _a.unrender;
    (0,react.useEffect)(function () {
        render(id);
...
var Node = (0,es/* observer */.Pi)(function (_a) {
...
var NodesStore = /** @class */ (function () {
    function NodesStore(rootStore) {
        ...
        this.import = function (newNodes) {
            ...
            newNodes === null || newNodes === void 0 ? void 0 : newNodes.forEach(function (node) { return _this.addNode(node, true); });
        };
        this.export = function () {
        ...
        this.addNode = function (node, rewriteIfExists) {
            var _a;
            if (!node || (!rewriteIfExists && node.id && _this._nodes.has(node.id))) {
                return errorResult('');
            }
        ...
        this.getNodeOrThrowException = function (nodeId) {
            var node = _this.getNode(nodeId);
            if (node)
                return node;
            else
                throw "Node with id '" + nodeId + "' does not exist";
        };
        /**
        ...
        this.getNodesBoundingBox = function () {
            ...
            _this._nodes.forEach(function (node) {
                ...
                var size = (_a = node.realSize) !== null && _a !== void 0 ? _a : [1, 1];
...
var PortInnerDefault = (0,es/* observer */.Pi)(function (_a) {
...
var SelectionState = /** @class */ (function () {
    function SelectionState(rootStore) {
        var _this = this;
        this._selectedItems = [];
        this.select = function (item, multipleActivated) {
            if (multipleActivated) {
                if (_this._selectedItems.includes(item)) {
                    _this.unselect(item);
                }
                else {
                    item.selected = true;
        ...
        this.removeSelected = function () {
            ...
            _this.removeSelectedLinks();
        };
        this.removeSelectedNodes = function () {
            _this._selectedItems
                .filter(function (i) { return i instanceof NodeState; })
                .forEach(function (node) {
                _this._rootStore.nodesStore.removeNode(node.id);
            });
        };
        this.removeSelectedLinks = function () {
            _this._selectedItems
                .filter(function (i) { return i instanceof LinkState; })
                .forEach(function (link) {
                _this._rootStore.linksStore.removeLink(link.id);
            });
        };
        this.cloneSelectedNodes = function () {
            _this._selectedItems
                .filter(function (i) { return i instanceof NodeState; })
                .forEach(function (node) {
                ...
                _this._rootStore.nodesStore.addNode(nodeObj, false);
            });
        };
        (0,mobx_esm/* makeAutoObservable */.ky)(this);
        this._rootStore = rootStore;
...
function Diagram(props) {
    var rootStore = (0,react.useMemo)(function () {
        var _a, _b, _c, _d;
...
var useRootStore = function () { return (0,react.useContext)(RootStoreContext); };

var BackgroundWrapper = (0,es/* observer */.Pi)(function () {
...
var PortsContainer = (0,es/* observer */.Pi)(function (_a) {
    ...
    var portsModified = (0,react.useMemo)(function () {
        return ports &&
...
var useDiagram = function (initState, settings) {
    ...
    var obj = (0,react.useMemo)(function () { return ({
