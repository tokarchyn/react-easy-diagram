(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[1],Array(88).concat([
/* 88 */
 ...
 */Object.defineProperty(exports,"__esModule",{value:true});var useThemeConfig_1=__webpack_require__(118);Object.defineProperty(exports,"useThemeConfig",{enumerable:true,get:function(){return useThemeConfig_1.useThemeConfig;}});var useAlternatePageUtils_1=__webpack_require__(139);Object.defineProperty(exports,"useAlternatePageUtils",{enumerable:true,get:function(){return useAlternatePageUtils_1.useAlternatePageUtils;}});var searchUtils_1=__webpack_require__(140);Object.defineProperty(exports,"docVersionSearchTag",{enumerable:true,get:function(){return searchUtils_1.docVersionSearchTag;}});Object.defineProperty(exports,"DEFAULT_SEARCH_TAG",{enumerable:true,get:function(){return searchUtils_1.DEFAULT_SEARCH_TAG;}});var docsUtils_1=__webpack_require__(119);Object.defineProperty(exports,"isDocsPluginEnabled",{enumerable:true,get:function(){return docsUtils_1.isDocsPluginEnabled;}});var pathUtils_1=__webpack_require__(144);Object.defineProperty(exports,"isSamePath",{enumerable:true,get:function(){return pathUtils_1.isSamePath;}});var generalUtils_1=__webpack_require__(145);Object.defineProperty(exports,"useTitleFormatter",{enumerable:true,get:function(){return generalUtils_1.useTitleFormatter;}});var usePluralForm_1=__webpack_require__(146);Object.defineProperty(exports,"usePluralForm",{enumerable:true,get:function(){return usePluralForm_1.usePluralForm;}});var useDocsPreferredVersion_1=__webpack_require__(147);Object.defineProperty(exports,"useDocsPreferredVersion",{enumerable:true,get:function(){return useDocsPreferredVersion_1.useDocsPreferredVersion;}});Object.defineProperty(exports,"useDocsPreferredVersionByPluginId",{enumerable:true,get:function(){return useDocsPreferredVersion_1.useDocsPreferredVersionByPluginId;}});var DocsPreferredVersionProvider_1=__webpack_require__(120);Object.defineProperty(exports,"DocsPreferredVersionContextProvider",{enumerable:true,get:function(){return DocsPreferredVersionProvider_1.DocsPreferredVersionContextProvider;}});
...
try{module.exports=__webpack_require__(141);}catch(e){// In case the docs plugin is not available, might be useful to stub some methods here
...
var custom_buble = __webpack_require__(159);

// EXTERNAL MODULE: ../node_modules/react-live/node_modules/core-js/fn/object/assign.js
var object_assign = __webpack_require__(165);
...
var parse_numeric_range = __webpack_require__(191);
...
var useThemeContext = __webpack_require__(111);

// EXTERNAL MODULE: ../node_modules/@docusaurus/theme-common/lib/index.js
var theme_common_lib = __webpack_require__(88);
...
var useBaseUrl = __webpack_require__(95);
...
__webpack_require__.d(__webpack_exports__, "PortDefault", function() { return /* binding */ PortDefault; });
__webpack_require__.d(__webpack_exports__, "PortState", function() { return /* binding */ index_esm_PortState; });
__webpack_require__.d(__webpack_exports__, "PortWrapper", function() { return /* binding */ PortWrapper; });
...
__webpack_require__.d(__webpack_exports__, "allTouchTargetsContainsClass", function() { return /* binding */ allTouchTargetsContainsClass; });
...
__webpack_require__.d(__webpack_exports__, "createPortDefault", function() { return /* binding */ createPortDefault; });
...
__webpack_require__.d(__webpack_exports__, "eventTargetContainsClass", function() { return /* binding */ eventTargetContainsClass; });
...
var mobx_esm = __webpack_require__(116);
 ...
 */function canDragGestureBeTapInstead(movement){return Math.max(Math.abs(movement[0]),Math.abs(movement[1]))<3;}function useDiagramDragHandlers(activeRef,getPosition,setPosition,cancel){var rootStore=index_esm_useRootStore();var handlers=Object(react["useMemo"])(function(){return{onDrag:function onDrag(_a){var pinching=_a.pinching,delta=_a.delta;if(!activeRef.current||pinching){return;}var currentPosition=getPosition();setPosition([currentPosition[0]+delta[0],currentPosition[1]+delta[1]]);},onDragStart:function onDragStart(_a){var event=_a.event;if(cancel&&cancel(event)){return;}activeRef.current=true;},onDragEnd:function onDragEnd(_a){var tap=_a.tap;if(activeRef.current){activeRef.current=false;if(tap){rootStore.selectionState.clear();}}}};},[activeRef,getPosition,setPosition,cancel,rootStore]);return handlers;}var generateTransform=function generateTransform(translate,scale){var translatePart="translate("+translate[0]+"px, "+translate[1]+"px)";if(scale){var scalePart="scale("+scale+")";return translatePart+' '+scalePart;}else{return translatePart;}};var distanceBetweenPoints=function distanceBetweenPoints(a,b){return Math.sqrt(Math.pow(a[0]-b[0],2)+Math.pow(a[1]-b[1],2));};var roundPoint=function roundPoint(point){return[Math.round(point[0]),Math.round(point[1])];};var addPoints=function addPoints(a,b){return[a[0]+b[0],a[1]+b[1]];};var subtractPoints=function subtractPoints(a,b){return[a[0]-b[0],a[1]-b[1]];};var multiplyPoint=function multiplyPoint(a,m){return[a[0]*m,a[1]*m];};var arePointsEqual=function arePointsEqual(a,b){return a===b||a&&b&&a[0]===b[0]&&a[1]===b[1];};var areTranformationsEqual=function areTranformationsEqual(a,b){return a===b||a&&b&&a.zoom===b.zoom&&arePointsEqual(a.offset,b.offset);};function clampValue(value,interval){return Math.min(Math.max(value,interval[0]),interval[1]);}function guidS4(){return Math.floor((1+Math.random())*0x10000).toString(16).substring(1);}function guid(){//return id of format 'aaaaaaaa'-'aaaa'-'aaaa'-'aaaa'-'aaaaaaaaaaaa'
return guidS4()+guidS4()+'-'+guidS4()+'-'+guidS4()+'-'+guidS4()+'-'+guidS4()+guidS4()+guidS4();}function guidForcedUniqueness(alreadyExistedItemsWithIdAsKey){var id=guid();while(id in alreadyExistedItemsWithIdAsKey){id=guid();}return id;}function deepCopy(value){return JSON.parse(JSON.stringify(value));}function useDiagramPinchHandlers(elemToAttachToRef,activeRef,state,cancel){var pinchState=Object(react["useRef"])({distance:0,origin:[0,0]});var handlers=Object(react["useMemo"])(function(){return{onPinch:function onPinch(_a){var distance=_a.da[0],origin=_a.origin;if(!activeRef.current||!elemToAttachToRef.current){return;}var originDiff=subtractPoints(origin,pinchState.current.origin);var rect=elemToAttachToRef.current.getBoundingClientRect();var originPositionOnElement=subtractPoints(origin,[rect.left,rect.top]);state.tranlsateAndZoomInto(originDiff,originPositionOnElement,distance/pinchState.current.distance);pinchState.current={distance:distance,origin:origin};},onPinchStart:function onPinchStart(_a){var distance=_a.da[0],origin=_a.origin,event=_a.event;if(cancel(event)){return;}pinchState.current={distance:distance,origin:origin};activeRef.current=true;},onPinchEnd:function onPinchEnd(){return activeRef.current=false;}};},[elemToAttachToRef,activeRef,state,cancel]);return handlers;}var DISABLED_USER_SELECT_CSS_CLASS='react_fast_diagram_disabled_user_select';function useUserAbilityToSelectSwitcher(active,elementToSwitchUserSelectOn){Object(react["useEffect"])(function(){if(!active||!elementToSwitchUserSelectOn){return;}if(elementToSwitchUserSelectOn.classList.contains(DISABLED_USER_SELECT_CSS_CLASS)){return;}elementToSwitchUserSelectOn.classList.add(DISABLED_USER_SELECT_CSS_CLASS);return function(){elementToSwitchUserSelectOn.classList.remove(DISABLED_USER_SELECT_CSS_CLASS);};},[active,elementToSwitchUserSelectOn]);}function useDiagramWheelHandler(elemToAttachToRef,activeRef,state){var handlers=Object(react["useMemo"])(function(){return{onWheel:function onWheel(_a){var _b=_a.direction;_b[0];var yDirection=_b[1],_c=_a.event,clientX=_c.clientX,clientY=_c.clientY;if(!elemToAttachToRef.current)return;event===null||event===void 0?void 0:event.preventDefault();var rect=elemToAttachToRef.current.getBoundingClientRect();var mousePositionOnElement=subtractPoints([clientX,clientY],[rect.left,rect.top]);var factor=0.9;if(yDirection<0){factor=1/factor;}state.tranlsateAndZoomInto([0,0],mousePositionOnElement,factor);}};},[elemToAttachToRef,activeRef,state]);return handlers;}var index_esm_useDiagramUserInteraction=function useDiagramUserInteraction(enable){var _a,_b;var diagramState=index_esm_useRootStore().diagramState;var activeRef=index_esm_useNotifyRef(false);var cancelGesture=Object(react["useCallback"])(function(event){return event.target!==diagramState.diagramInnerRef.current;},[diagramState.diagramInnerRef]);var getOffset=Object(react["useCallback"])(function(){return diagramState.offset;},[diagramState]);var setOffset=Object(react["useCallback"])(diagramState.setOffset,[diagramState]);var dragHandlers=useDiagramDragHandlers(activeRef,getOffset,setOffset,cancelGesture);var pinchHandlers=useDiagramPinchHandlers(diagramState.diagramInnerRef,activeRef,diagramState,cancelGesture);var wheelHandler=useDiagramWheelHandler(diagramState.diagramInnerRef,activeRef,diagramState);useGesture(_assign(_assign(_assign({},dragHandlers),pinchHandlers),wheelHandler),{domTarget:diagramState.diagramInnerRef,eventOptions:{passive:false},enabled:enable});useUserAbilityToSelectSwitcher(activeRef.current,(_b=(_a=diagramState.diagramInnerRef.current)===null||_a===void 0?void 0:_a.ownerDocument)===null||_b===void 0?void 0:_b.body);return{transform:diagramState.transformString,active:activeRef.current};};var index_esm_LinkPortEndpointState=/** @class */function(){function LinkPortEndpointState(nodeId,portId,rootStore){var _this=this;this.export=function(){return deepCopy({nodeId:_this._nodeId,portId:_this._portId});};this._nodeId=nodeId;this._portId=portId;rootStore.nodesStore.getNodeOrThrowException(this._nodeId).getPortOrThrowException(this._portId);Object(mobx_esm["c" /* makeAutoObservable */])(this);this._rootStore=rootStore;}Object.defineProperty(LinkPortEndpointState.prototype,"nodeId",{get:function get(){return this._nodeId;},enumerable:false,configurable:true});Object.defineProperty(LinkPortEndpointState.prototype,"portId",{get:function get(){return this._portId;},enumerable:false,configurable:true});Object.defineProperty(LinkPortEndpointState.prototype,"node",{get:function get(){return this._rootStore.nodesStore.getNodeOrThrowException(this._nodeId);},enumerable:false,configurable:true});Object.defineProperty(LinkPortEndpointState.prototype,"port",{get:function get(){return this.node.getPortOrThrowException(this._portId);},enumerable:false,configurable:true});Object.defineProperty(LinkPortEndpointState.prototype,"point",{get:function get(){if(this.port.offsetRelativeToNode&&this.port.realSize){return addPoints(this.node.position,addPoints(this.port.offsetRelativeToNode,multiplyPoint(this.port.realSize,0.5)));}return undefined;},enumerable:false,configurable:true});return LinkPortEndpointState;}();function linkPortEndpointsEquals(a,b){return a.nodeId===b.nodeId&&a.portId===b.portId;}var Callbacks=/** @class */function(){function Callbacks(rootStore){var _this=this;this.import=function(callbacks){_this._validateLinkEndpoints=callbacks===null||callbacks===void 0?void 0:callbacks.validateLinkEndpoints;};this.export=function(){return{validateLinkEndpoints:_this._validateLinkEndpoints};};this._rootStore=rootStore;}Object.defineProperty(Callbacks.prototype,"validateLinkEndpoints",{get:function get(){return this._validateLinkEndpoints;},enumerable:false,configurable:true});return Callbacks;}();function curvedLinkPathConstructor(source,target,settings){if(!source||!target)return'';var sourcePoint=roundPoint(source.point);var targetPoint=roundPoint(target.point);var sourceStr=source.point[0]+", "+source.point[1];var targetStr=target.point[0]+", "+target.point[1];var directionFactor=settings.tweakDirectionFactorBasedOnDistance(distanceBetweenPoints(sourcePoint,targetPoint),settings.directionFactor);function getControl(endpoint,direction){switch(direction){case'left':return endpoint[0]-directionFactor+", "+endpoint[1];case'up':return endpoint[0]+", "+(endpoint[1]-directionFactor);case'right':return endpoint[0]+directionFactor+", "+endpoint[1];case'down':return endpoint[0]+", "+(endpoint[1]+directionFactor);default:return endpoint[0]+", "+endpoint[1];}}if(source.direction||target.direction){var sourceControl=getControl(sourcePoint,source.direction);var targetControl=getControl(targetPoint,target.direction);return"M "+sourceStr+" C "+sourceControl+" "+targetControl+", "+targetStr;}else{return"M "+sourceStr+" Q "+target.point[0]+", "+source.point[1]+", "+targetStr;}}var defualtSettings={directionFactor:60,tweakDirectionFactorBasedOnDistance:function tweakDirectionFactorBasedOnDistance(distance,directionFactor){if(distance<100){return directionFactor*(distance/100);}return directionFactor;}};function createCurvedLinkPathConstructor(settings){return function(source,target){return curvedLinkPathConstructor(source,target,settings?_assign(_assign({},defualtSettings),settings):defualtSettings);};}function straightLinkPathConstructor(source,target){var path="M "+source.point[0]+" "+source.point[1]+", "+target.point[0]+" "+target.point[1];return path;}function createStraightLinkPathConstructor(){return straightLinkPathConstructor;}var positionValues=['left','top','right','bottom'];var relativeXYPositionValues=['center-center','center-bottom','center-top','left-center','left-bottom','left-top','right-center','right-bottom','right-top'];function splitRelativeXYPostionByAxis(position){return position.split('-');}function successResult(){return{success:true};}function successValueResult(value){return{success:true,value:value};}function errorResult(error){return{success:false,error:error};}var index_esm_VisualComponentState=/** @class */function(){function VisualComponentState(component){var _this=this;this._settings={};this.import=function(newComponent){var _a;if('component'in newComponent){_this._component=newComponent.component;_this._settings=(_a=newComponent.settings)!==null&&_a!==void 0?_a:{};}else{_this._component=newComponent;_this._settings={};}};this.import(component);Object(mobx_esm["c" /* makeAutoObservable */])(this);}Object.defineProperty(VisualComponentState.prototype,"component",{get:function get(){return this._component;},enumerable:false,configurable:true});Object.defineProperty(VisualComponentState.prototype,"settings",{get:function get(){return this._settings;},enumerable:false,configurable:true});return VisualComponentState;}();var index_esm_VisualComponentWithDefault=/** @class */function(){function VisualComponentWithDefault(defaultComponent){var _this=this;this.import=function(newComponent){_this._innerComponent=newComponent?new index_esm_VisualComponentState(newComponent):_this._defaultComponent;};this._innerComponent=new index_esm_VisualComponentState(defaultComponent);this._defaultComponent=this._innerComponent;Object(mobx_esm["c" /* makeAutoObservable */])(this);}Object.defineProperty(VisualComponentWithDefault.prototype,"component",{get:function get(){return this._innerComponent.component;},enumerable:false,configurable:true});Object.defineProperty(VisualComponentWithDefault.prototype,"settings",{get:function get(){return this._innerComponent.settings;},enumerable:false,configurable:true});return VisualComponentWithDefault;}();var index_esm_DiagramSettings=/** @class */function(){function DiagramSettings(){var _this=this;this._zoomInterval=defaultZoomInterval;this._zoomToFitSettings=defaultZoomToFitSettings;this.import=function(obj){_this._backgroundComponentState.import(obj===null||obj===void 0?void 0:obj.backgroundComponent);_this._miniControlComponentState.import(obj===null||obj===void 0?void 0:obj.miniControlComponent);_this.setZoomInterval(obj===null||obj===void 0?void 0:obj.zoomInterval);_this._zoomToFitSettings=_assign(_assign({},defaultZoomToFitSettings),obj===null||obj===void 0?void 0:obj.zoomToFitSettings);};this.setZoomInterval=function(value){_this._zoomInterval=value!==null&&value!==void 0?value:defaultZoomInterval;};this._backgroundComponentState=new index_esm_VisualComponentWithDefault(createDefaultBackground());this._miniControlComponentState=new index_esm_VisualComponentWithDefault(createDefaultMiniControl());Object(mobx_esm["c" /* makeAutoObservable */])(this);}Object.defineProperty(DiagramSettings.prototype,"backgroundComponentState",{get:function get(){return this._backgroundComponentState;},enumerable:false,configurable:true});Object.defineProperty(DiagramSettings.prototype,"miniControlComponentState",{get:function get(){return this._miniControlComponentState;},enumerable:false,configurable:true});Object.defineProperty(DiagramSettings.prototype,"zoomInterval",{get:function get(){return this._zoomInterval;},enumerable:false,configurable:true});Object.defineProperty(DiagramSettings.prototype,"zoomToFitSettings",{get:function get(){return this._zoomToFitSettings;},enumerable:false,configurable:true});return DiagramSettings;}();var defaultZoomInterval=[0.1,3];var defaultZoomToFitSettings={padding:[30,30]};var index_esm_HtmlElementRefState=/** @class */function(){function HtmlElementRefState(initValue){var _this=this;this.offsetRelativeToParent=function(parent){if(_this.current){var iterElement=_this.current;var acumLeft=0;var acumTop=0;while(parent!==iterElement&&iterElement){var translate=getTranslate(iterElement);acumLeft+=iterElement.offsetLeft+translate[0];acumTop+=iterElement.offsetTop+translate[1];iterElement=iterElement.parentElement;}return[acumLeft,acumTop];}return null;};this._currentInternal=initValue;Object(mobx_esm["c" /* makeAutoObservable */])(this);}Object.defineProperty(HtmlElementRefState.prototype,"current",{get:function get(){return this._currentInternal;},set:function set(value){this._currentInternal=value;},enumerable:false,configurable:true});Object.defineProperty(HtmlElementRefState.prototype,"realSize",{/**
         ...
         */get:function get(){if(this.current){return[this.current.clientWidth,this.current.clientHeight];}else{return null;}},enumerable:false,configurable:true});return HtmlElementRefState;}();// https://stackoverflow.com/questions/21912684/how-to-get-value-of-translatex-and-translatey
...
);}var LinkPointEndpointState$1=/** @class */function(){function LinkPointEndpointState(pos){var _this=this;this.translateBy=function(pointToTranslateBy){_this._point=addPoints(_this._point,pointToTranslateBy);};this._point=pos;Object(mobx_esm["c" /* makeAutoObservable */])(this);}Object.defineProperty(LinkPointEndpointState.prototype,"point",{get:function get(){return this._point;},enumerable:false,configurable:true});return LinkPointEndpointState;}();var index_esm_LinkCreationState=/** @class */function(){function LinkCreationState(rootStore){var _this=this;this._source=null;this._target=null;this._targetPortCandidate=null;this.startLinking=function(portState,pointOnPort){_this._resetProps();_this._source=new index_esm_LinkPortEndpointState(portState.nodeId,portState.id,_this._rootStore);var sourcePoint=_this._source.point;var portSize=_this._source.port.realSize;if(sourcePoint&&portSize){// endpoint point is calculated for center of port
var topLeftCornerPoint=subtractPoints(sourcePoint,multiplyPoint(portSize,0.5));_this._target=new LinkPointEndpointState$1(addPoints(topLeftCornerPoint,multiplyPoint(pointOnPort,1/_this._rootStore.diagramState.zoom)));}else{_this._resetProps();return false;}return true;};this.setTargetPortCandidate=function(portState){if(!_this._source)return;var canAddLink=_this._rootStore.linksStore.canAddLink({source:{nodeId:_this._source.nodeId,portId:_this._source.portId},target:{nodeId:portState.nodeId,portId:portState.id}});_this._targetPortCandidate=portState;if(canAddLink.success){portState.validForConnection=true;}else{portState.validForConnection=false;}};this.resetTargetPortCandidate=function(portState){if(_this._targetPortCandidate===portState){_this._targetPortCandidate=null;}portState.validForConnection=true;};this.stopLinking=function(){if(_this._targetPortCandidate&&_this._source){var result=_this._rootStore.linksStore.addLink({source:{nodeId:_this._source.nodeId,portId:_this._source.portId},target:{nodeId:_this._targetPortCandidate.nodeId,portId:_this._targetPortCandidate.id}});if(result.success){_this._rootStore.selectionState.select(result.value,false);}}_this._resetProps();};this._resetProps=function(){if(_this._source){_this._source.port.validForConnection=true;_this._source=null;}_this._target=null;if(_this._targetPortCandidate){_this._targetPortCandidate.validForConnection=true;_this._targetPortCandidate=null;}};Object(mobx_esm["c" /* makeAutoObservable */])(this);this._rootStore=rootStore;}Object.defineProperty(LinkCreationState.prototype,"selected",{get:function get(){return true;},enumerable:false,configurable:true});Object.defineProperty(LinkCreationState.prototype,"hovered",{get:function get(){return true;},enumerable:false,configurable:true});Object.defineProperty(LinkCreationState.prototype,"source",{get:function get(){return this._source;},enumerable:false,configurable:true});Object.defineProperty(LinkCreationState.prototype,"target",{get:function get(){return this._target;},enumerable:false,configurable:true});Object.defineProperty(LinkCreationState.prototype,"targetPortCandidate",{get:function get(){return this._targetPortCandidate;},enumerable:false,configurable:true});Object.defineProperty(LinkCreationState.prototype,"componentDefinition",{get:function get(){var visualComponents=this._rootStore.linksSettings.visualComponents;return visualComponents.getComponent(linkCreationComponentType);},enumerable:false,configurable:true});Object.defineProperty(LinkCreationState.prototype,"path",{get:function get(){if(!this._source||!this._target)return undefined;else return createLinkPath(this._rootStore,this._source,this._target);},enumerable:false,configurable:true});return LinkCreationState;}();var linkCreationComponentType='linkCreation';var index_esm_LinkPointEndpointState=/** @class */function(){function LinkPointEndpointState(pos){var _this=this;this.translateBy=function(pointToTranslateBy){_this._point=addPoints(_this._point,pointToTranslateBy);};this._point=pos;Object(mobx_esm["c" /* makeAutoObservable */])(this);}Object.defineProperty(LinkPointEndpointState.prototype,"point",{get:function get(){return this._point;},enumerable:false,configurable:true});return LinkPointEndpointState;}();var LinkDefault=Object(observer["a" /* observer */])(function(_a){var entity=_a.entity,settings=_a.settings,bind=_a.bind;var finalSettings=_assign(_assign({},linkDefaultSettings),settings);var path=entity.path;if(!path)return null;var color=finalSettings.color;if(entity.selected)color=finalSettings.selectedColor;return/*#__PURE__*/react_default.a.createElement("g",null,/*#__PURE__*/react_default.a.createElement("path",{d:path.svgPath,stroke:color,strokeWidth:finalSettings.strokeWidth,fill:'none',strokeLinecap:"round"}),/*#__PURE__*/react_default.a.createElement("path",_assign({d:path.svgPath,stroke:color,strokeWidth:finalSettings.strokeWidth+5},bind(),{pointerEvents:'auto',fill:"none",strokeLinecap:"round",strokeOpacity:entity.hovered?0.22:0})),entity instanceof index_esm_LinkCreationState&&/*#__PURE__*/react_default.a.createElement("circle",{cx:path.target[0],cy:path.target[1],r:finalSettings.cirleRadius,fill:'orange'}));});var linkDefaultSettings={color:'#c2c2c2',selectedColor:'#6eb7ff',strokeWidth:1,cirleRadius:3};function createLinkDefault(settings){return{component:LinkDefault,settings:settings};}var index_esm_LinksSettings=/** @class */function(){function LinksSettings(){var _a;var _this=this;this._visualComponents=new index_esm_VisualComponents((_a={},_a[componentDefaultType]=LinkDefault,_a[linkCreationComponentType]=LinkDefault,_a));this.import=function(obj){var _a;_this._visualComponents.import(obj);_this.setPathConstructor(obj===null||obj===void 0?void 0:obj.pathConstructor);_this._preferLinksDirection=(_a=obj===null||obj===void 0?void 0:obj.preferLinksDirection)!==null&&_a!==void 0?_a:'horizontal';};this.setPathConstructor=function(value){_this._pathConstructor=value!==null&&value!==void 0?value:defaultPathConstructor;};this.import();Object(mobx_esm["c" /* makeAutoObservable */])(this);}Object.defineProperty(LinksSettings.prototype,"pathConstructor",{get:function get(){return this._pathConstructor;},enumerable:false,configurable:true});Object.defineProperty(LinksSettings.prototype,"visualComponents",{get:function get(){return this._visualComponents;},enumerable:false,configurable:true});Object.defineProperty(LinksSettings.prototype,"preferLinksDirection",{get:function get(){return this._preferLinksDirection;},enumerable:false,configurable:true});return LinksSettings;}();var defaultPathConstructor=createCurvedLinkPathConstructor();var index_esm_PortState=/** @class */function(){function PortState(rootStore,id,nodeId,state){var _this=this;this._ref=new index_esm_HtmlElementRefState(null);this._dragging=false;this._hovered=false;this._validForConnection=true;this.setLabel=function(value){_this._label=value!==null&&value!==void 0?value:'';};this.setType=function(value){_this._type=value!==null&&value!==void 0?value:componentDefaultType;};this.import=function(state){var _a;_this.setType(state===null||state===void 0?void 0:state.type);_this.setLabel(state===null||state===void 0?void 0:state.label);_this.setExtra(state===null||state===void 0?void 0:state.extra);_this.setComponent(state===null||state===void 0?void 0:state.component);_this._linkDirection=(_a=state===null||state===void 0?void 0:state.linkDirection)!==null&&_a!==void 0?_a:null;};this.export=function(){return deepCopy({id:_this._id,nodeId:_this._nodeId,label:_this._label,type:_this._type});};this.setExtra=function(value){_this._extra=value!==null&&value!==void 0?value:null;};this._id=id;this._nodeId=nodeId;this.import(state);Object(mobx_esm["c" /* makeAutoObservable */])(this);this._rootStore=rootStore;}Object.defineProperty(PortState.prototype,"id",{get:function get(){return this._id;},enumerable:false,configurable:true});Object.defineProperty(PortState.prototype,"nodeId",{get:function get(){return this._nodeId;},enumerable:false,configurable:true});Object.defineProperty(PortState.prototype,"fullId",{get:function get(){return createFullPortId(this.nodeId,this.id);},enumerable:false,configurable:true});Object.defineProperty(PortState.prototype,"ref",{get:function get(){return this._ref;},enumerable:false,configurable:true});Object.defineProperty(PortState.prototype,"dragging",{get:function get(){return this._dragging;},set:function set(value){this._dragging=value;},enumerable:false,configurable:true});Object.defineProperty(PortState.prototype,"hovered",{get:function get(){return this._hovered;},set:function set(value){this._hovered=value;},enumerable:false,configurable:true});Object.defineProperty(PortState.prototype,"validForConnection",{get:function get(){return this._validForConnection;},set:function set(value){this._validForConnection=value;},enumerable:false,configurable:true});Object.defineProperty(PortState.prototype,"label",{get:function get(){return this._label;},enumerable:false,configurable:true});Object.defineProperty(PortState.prototype,"type",{get:function get(){return this._type;},enumerable:false,configurable:true});Object.defineProperty(PortState.prototype,"extra",{get:function get(){return this._extra;},enumerable:false,configurable:true});Object.defineProperty(PortState.prototype,"node",{get:function get(){return this._rootStore.nodesStore.getNodeOrThrowException(this.nodeId);},enumerable:false,configurable:true});Object.defineProperty(PortState.prototype,"offsetRelativeToNode",{get:function get(){if(this.node.ref.current){return this._ref.offsetRelativeToParent(this.node.ref.current);}return null;},enumerable:false,configurable:true});Object.defineProperty(PortState.prototype,"realSize",{/**
         * @returns Value is calculated without zoom taking into account, that is, the same as zoom would be '1'.
         * Value can be @type {null} in case reference to real DOM object is not set.
         */get:function get(){return this._ref.realSize;},enumerable:false,configurable:true});PortState.prototype.setComponent=function(value){if(!value){this._component=null;}else{this._component=new index_esm_VisualComponentState(value);}};Object.defineProperty(PortState.prototype,"componentDefinition",{get:function get(){if(this._component)return this._component;var portVisualComponents=this._rootStore.portsSettings.portVisualComponents;return portVisualComponents.getComponent(this.type);},enumerable:false,configurable:true});Object.defineProperty(PortState.prototype,"connectedLinks",{get:function get(){return this._rootStore.linksStore.getPortLinks(this.nodeId,this.id);},enumerable:false,configurable:true});Object.defineProperty(PortState.prototype,"connectedPorts",{get:function get(){var _this=this;return this.connectedLinks.map(function(v){return v.source.portId===_this._id?v.target.port:v.source.port;});},enumerable:false,configurable:true});Object.defineProperty(PortState.prototype,"linkDirection",{get:function get(){if(this._linkDirection)return this._linkDirection;// Try to guess
if(!this.offsetRelativeToNode)return undefined;var nodeCenter=this.node.realSize&&multiplyPoint(this.node.realSize,0.5);if(!nodeCenter)return undefined;if(this._rootStore.linksSettings.preferLinksDirection==='horizontal'){return this.offsetRelativeToNode[0]<nodeCenter[0]?'left':'right';}else if(this._rootStore.linksSettings.preferLinksDirection==='vertical'){return this.offsetRelativeToNode[1]<nodeCenter[1]?'up':'down';}else;},enumerable:false,configurable:true});return PortState;}();function createFullPortId(nodeId,portId){return nodeId+"-"+portId;}var index_esm_LinksStore=/** @class */function(){function LinksStore(rootStore){var _this=this;this.import=function(newLinks){_this._links=new Map();_this._nodesLinksCollection=new Map();newLinks&&newLinks.forEach(_this.addLink);};this.export=function(){return Array.from(_this._links).map(function(_a){_a[0];var value=_a[1];return value.export();});};this.getNodeLinks=function(nodeId){var _a;return(_a=_this._nodesLinksCollection.get(nodeId))!==null&&_a!==void 0?_a:[];};this.getPortLinks=function(nodeId,portId){var nodeLinks=_this.getNodeLinks(nodeId);var fullPortId=createFullPortId(nodeId,portId);return nodeLinks.filter(function(l){return l.source.port.fullId===fullPortId||l.target.port.fullId===fullPortId;});};this.removeNodeLinks=function(nodeId){var links=_this.getNodeLinks(nodeId);links.forEach(function(l){return _this.removeLink(l.id);});};this.removePortLinks=function(nodeId,portId){if(!nodeId||!portId)return;var links=_this.getNodeLinks(nodeId);var endpointToRemove={nodeId:nodeId,portId:portId};links.forEach(function(l){if(linkPortEndpointsEquals(l.source,endpointToRemove)||linkPortEndpointsEquals(l.target,endpointToRemove)){_this.removeLink(l.id);}});};this.addLink=function(link){var _a;var canAdd=_this.canAddLink(link);if(!canAdd.success)return canAdd;var newLink=new index_esm_LinkState(_this._rootStore,(_a=link.id)!==null&&_a!==void 0?_a:guidForcedUniqueness(_this._links),link);_this._links.set(newLink.id,newLink);_this._addLinkToNodeLinksCollection(newLink,link.source.nodeId);_this._addLinkToNodeLinksCollection(newLink,link.target.nodeId);return successValueResult(newLink);};this.removeLink=function(linkId){var linkToRemove=_this._links.get(linkId);if(linkToRemove){_this._removeLinkFromNodeLinksCollection(linkToRemove,linkToRemove.source.nodeId);_this._removeLinkFromNodeLinksCollection(linkToRemove,linkToRemove.target.nodeId);_this._rootStore.selectionState.unselect(linkToRemove);_this._links.delete(linkId);return true;}return false;};this.canAddLink=function(link){var _a,_b;if(!link)return errorResult("Cannot add empty");if(link.id&&_this._links.has(link.id))return errorResult("Cannot add link with id '"+link.id+"', as it already exists");var isSourceValid=_this.isEndpointValid(link.source);if(!isSourceValid.success)return isSourceValid;var isTargetValid=_this.isEndpointValid(link.target);if(!isTargetValid.success)return isTargetValid;if(link.source.nodeId===link.target.nodeId)return errorResult("Link's endpoints are located in the same node");if(_this.areEndpointsConnected(link.source,link.target))return errorResult("Link's endpoints are already connected");if(((_b=(_a=_this._rootStore.callbacks).validateLinkEndpoints)===null||_b===void 0?void 0:_b.call(_a,_this.getEndpointPort(link.source),_this.getEndpointPort(link.target),_this._rootStore))===false){return errorResult("Link's endpoints are not valid according to validation callback");}return successResult();};this.isEndpointValid=function(endpoint){try{_this.getEndpointPort(endpoint);}catch(ex){return errorResult(''+ex);}return successResult();};this.getEndpointPort=function(endpoint){return _this._rootStore.nodesStore.getNodeOrThrowException(endpoint.nodeId).getPortOrThrowException(endpoint.portId);};this.areEndpointsConnected=function(source,target){return!!_this.getLinkForEndpointsIfExists(source,target);};this.getLinkForEndpointsIfExists=function(source,target){var links=_this._nodesLinksCollection.get(source.nodeId);if(links){return links.find(function(l){return linkPortEndpointsEquals(l.source,source)&&linkPortEndpointsEquals(l.target,target)||linkPortEndpointsEquals(l.target,source)&&linkPortEndpointsEquals(l.source,target);});}};this._addLinkToNodeLinksCollection=function(link,nodeId){var links=_this._nodesLinksCollection.get(nodeId);if(!links){_this._nodesLinksCollection.set(nodeId,[link]);}else{links.push(link);}};this._removeLinkFromNodeLinksCollection=function(link,nodeId){var collection=_this._nodesLinksCollection.get(nodeId);if(collection){collection=collection.filter(function(l){return l.id!==link.id;});if(collection.length>0){_this._nodesLinksCollection.set(nodeId,collection);}else{_this._nodesLinksCollection.delete(nodeId);}}};this._linkCreation=new index_esm_LinkCreationState(rootStore);this.import();Object(mobx_esm["c" /* makeAutoObservable */])(this);this._rootStore=rootStore;}Object.defineProperty(LinksStore.prototype,"links",{get:function get(){return this._links;},enumerable:false,configurable:true});Object.defineProperty(LinksStore.prototype,"linkCreation",{get:function get(){return this._linkCreation;},enumerable:false,configurable:true});return LinksStore;}();var index_esm_usePortUserInteraction=function usePortUserInteraction(portState,enable){var _a,_b;var _c=index_esm_useRootStore(),linkCreation=_c.linksStore.linkCreation,diagramState=_c.diagramState;var handlers=Object(react["useMemo"])(function(){return{onDrag:function onDrag(_a){var _b;var delta=_a.delta;if(!portState||!portState.dragging)return;var parentScale=diagramState.zoom;(_b=linkCreation.target)===null||_b===void 0?void 0:_b.translateBy(multiplyPoint(delta,1/parentScale));},onDragStart:function onDragStart(_a){var event=_a.event,xy=_a.xy;if(!portState)return;// Important! Otherwise on touch display onPointerEnter will not work!
var portHtmlElement=event.target;portHtmlElement.releasePointerCapture(event.pointerId);var pointOnPort=subtractPoints(xy,[portHtmlElement.getBoundingClientRect().x,portHtmlElement.getBoundingClientRect().y]);if(linkCreation.startLinking(portState,pointOnPort)){portState.dragging=true;}},onDragEnd:function onDragEnd(){if(!portState)return;portState.dragging=false;linkCreation.stopLinking();},onPointerEnter:function onPointerEnter(){if(!portState)return;portState.hovered=true;linkCreation.setTargetPortCandidate(portState);},onPointerLeave:function onPointerLeave(){if(!portState)return;portState.hovered=false;linkCreation.resetTargetPortCandidate(portState);}};},[portState,linkCreation]);// Temporary bug fix when pointer events handlers are not reasigned.
...
/* harmony import */ var _isInternalUrl__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(112);
/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
...
/* harmony import */ var _theme_SkipToContent__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(100);
/* harmony import */ var _theme_AnnouncementBar__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(101);
/* harmony import */ var _theme_Navbar__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(107);
/* harmony import */ var _theme_Footer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(102);
/* harmony import */ var _theme_LayoutProviders__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(108);
/* harmony import */ var _theme_LayoutHead__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(109);
/* harmony import */ var _theme_hooks_useKeyboardNavigation__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(103);
...
/* harmony import */ var clsx__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(89);
/* harmony import */ var _docusaurus_Link__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(93);
/* harmony import */ var _docusaurus_useBaseUrl__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(95);
/* harmony import */ var _docusaurus_router__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(23);
/* harmony import */ var _docusaurus_theme_common__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(88);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _docusaurus_Translate__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(90);
...
/* harmony import */ var _docusaurus_theme_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(88);
...
/* harmony import */ var _theme_hooks_useUserPreferencesContext__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(121);
/* harmony import */ var _docusaurus_Translate__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(90);
...
/* harmony import */ var clsx__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(89);
/* harmony import */ var _docusaurus_Link__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(93);
/* harmony import */ var _docusaurus_theme_common__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(88);
...
/* harmony import */ var _docusaurus_useBaseUrl__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(95);
...
/* harmony import */ var _theme_ThemedImage__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(128);
/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
...
var DefaultNavbarItem = __webpack_require__(99);
...
__webpack_require__(155).default,docsVersionDropdown:()=>// eslint-disable-next-line @typescript-eslint/no-var-requires
__webpack_require__(156).default,doc:()=>// eslint-disable-next-line @typescript-eslint/no-var-requires
...
var ThemeContext = __webpack_require__(123);
...
var UserPreferencesContext = __webpack_require__(122);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _theme_ThemeContext__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(123);
/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */Object.defineProperty(exports,"__esModule",{value:true});exports.isDocsPluginEnabled=void 0;const useDocs_1=__webpack_require__(91);// TODO not ideal, see also "useDocs"
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const react_1=__importStar(__webpack_require__(0));const useThemeConfig_1=__webpack_require__(118);const docsUtils_1=__webpack_require__(119);const useDocs_1=__webpack_require__(91);const DocsPreferredVersionStorage_1=__importDefault(__webpack_require__(148));// Initial state is always null as we can't read localstorage from node SSR
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _theme_UserPreferencesContext__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(122);
/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(0);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _docusaurus_Link__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(93);
/* harmony import */ var _theme_ThemedImage__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(128);
/* harmony import */ var _docusaurus_useBaseUrl__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(95);
...
/* harmony import */ var _theme_hooks_useThemeContext__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(111);
...
/* harmony import */ var _docusaurus_useBaseUrl__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(95);
/* harmony import */ var _docusaurus_theme_common__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(88);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const react_1=__webpack_require__(0);const DocsPreferredVersionProvider_1=__webpack_require__(120);const useDocs_1=__webpack_require__(91);const constants_1=__webpack_require__(149);// TODO improve typing
...
var _check = __webpack_require__(152);

var _check2 = _interopRequireDefault(_check);

var _x = __webpack_require__(153);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(0);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _theme_NavbarItem_DefaultNavbarItem__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(99);
/* harmony import */ var _theme_hooks_useDocs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(91);
...
/* harmony import */ var _theme_hooks_useDocs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(91);
/* harmony import */ var _theme_hooks_useDocs__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_theme_hooks_useDocs__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var clsx__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(89);
/* harmony import */ var _docusaurus_theme_common__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(88);
...
const{transform,features:bubleFeatures}=__webpack_require__(160);// This file is designed to mimic what's written in
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(161).Buffer))
...
module.exports = !__webpack_require__(106) && !__webpack_require__(115)(function () {
