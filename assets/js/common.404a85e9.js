...
if(this.current){return[this.current.clientWidth,this.current.clientHeight];}else{return null;}},enumerable:false,configurable:true});return HtmlElementRefState;}();// https://stackoverflow.com/questions/21912684/how-to-get-value-of-translatex-and-translatey
...
var mat=transform.match(/^matrix\((.+)\)$/);if(mat){transArr[0]=parseInt(mat[1].split(', ')[4],10);transArr[1]=parseInt(mat[1].split(', ')[5],10);}return transArr;}var generateTransform=function generateTransform(translate,scale){var translatePart="translate("+translate[0]+"px, "+translate[1]+"px)";if(scale){var scalePart="scale("+scale+")";return translatePart+' '+scalePart;}else{return translatePart;}};var areTranformationsEqual=function areTranformationsEqual(a,b){return a===b||a&&b&&a.zoom===b.zoom&&arePointsEqual(a.offset,b.offset);};var DiagramState=/** @class */function(){function DiagramState(rootStore){var _this=this;this.import=function(state){_this.setOffset(state===null||state===void 0?void 0:state.offset);_this.setZoom(state===null||state===void 0?void 0:state.zoom);};this.export=function(){return deepCopy({offset:_this._offset,zoom:_this._zoom});};this.setOffset=function(newOffset){_this._offset=newOffset!==null&&newOffset!==void 0?newOffset:[0,0];};this.setZoom=function(newZoom){_this._zoom=clampValue(newZoom!==null&&newZoom!==void 0?newZoom:1,_this._rootStore.diagramSettings.zoomInterval);};this.zoomIn=function(){return _this.zoomIntoCenter(1/0.8);};this.zoomOut=function(){return _this.zoomIntoCenter(0.8);};// See: https://stackoverflow.com/a/30039971/9142642
