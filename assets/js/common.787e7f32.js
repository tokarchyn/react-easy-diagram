...
"use strict";
Object.defineProperty(exports, "__esModule", ({value:true}));var mobxReactLite=__webpack_require__(5479);var React=__webpack_require__(7378);var reactUseGesture=__webpack_require__(2340);var mobx=__webpack_require__(9588);function _interopDefaultLegacy(e){return e&&typeof e==='object'&&'default'in e?e:{'default':e};}var React__default=/*#__PURE__*/_interopDefaultLegacy(React);/*! *****************************************************************************
 ...
 */function canDragGestureBeTapInstead(movement){return Math.max(Math.abs(movement[0]),Math.abs(movement[1]))<3;}function useCursor(active,cursor,ref){var cursorBeforeSetRef=React.useRef('');React.useEffect(function(){if(!active||!ref||!cursor||ref.style.cursor===cursor){return;}cursorBeforeSetRef.current=ref.style.cursor;ref.style.cursor=cursor;return function(){ref.style.cursor=cursorBeforeSetRef.current;};},[active,ref]);}function useDiagramCursor(active,cursor){var diagramState=useRootStore().diagramState;var ref=diagramState.diagramInnerRef.current;useCursor(active,cursor,ref);}var useNodeUserInteraction=function useNodeUserInteraction(nodeState){var _a,_b;var rootStore=useRootStore();// Should trigger rendering on change, otherwise useUserSelectSwitcher will not be invoked
var activeRef=useNotifyRef(false);// In case the snap to grid option is enabled in settings
var remainderFromPreviousDragEventRef=React.useRef(new Map());var selectionHandledRef=React.useRef(false);var selectionTimeoutRef=React.useRef(null);var userInteractionElemRef=React.useRef(null);var handlers=React.useMemo(function(){return{onDrag:function onDrag(_a){var pinching=_a.pinching,delta=_a.delta,ctrlKey=_a.ctrlKey,movement=_a.movement;if(!activeRef.current||pinching||canDragGestureBeTapInstead(movement)){return;}else if(nodeState.isSelectionEnabled&&!nodeState.selected&&!selectionHandledRef.current){rootStore.selectionState.select(nodeState,ctrlKey);selectionHandledRef.current=true;}else if(nodeState.isDragEnabled&&nodeState.selected){// prevent canceling selection on timeout
selectionHandledRef.current=true;rootStore.selectionState.selectedItems.filter(function(i){return i instanceof NodeState;}).forEach(function(n){var _a;var newPosition=addPoints(n.position,multiplyPoint(delta,1/rootStore.diagramState.zoom),(_a=remainderFromPreviousDragEventRef.current.get(n))!==null&&_a!==void 0?_a:[0,0]);var newRemainder=n.setPosition(newPosition);remainderFromPreviousDragEventRef.current.set(n,newRemainder);});}},onDragStart:function onDragStart(_a){var event=_a.event;if(!allowNodeInteraction(event)){return;}activeRef.current=true;selectionHandledRef.current=false;if(nodeState.isSelectionEnabled){selectionTimeoutRef.current=setTimeout(function(){if(activeRef.current&&!selectionHandledRef.current){selectionHandledRef.current=true;rootStore.selectionState.select(nodeState,true);}},selectDelay);}},onDragEnd:function onDragEnd(_a){var tap=_a.tap,ctrlKey=_a.ctrlKey;if(selectionTimeoutRef.current){clearTimeout(selectionTimeoutRef.current);}activeRef.current=false;if(nodeState.isSelectionEnabled&&tap&&!selectionHandledRef.current){rootStore.selectionState.select(nodeState,ctrlKey);}remainderFromPreviousDragEventRef.current.clear();}};},[activeRef,nodeState,rootStore]);reactUseGesture.useGesture(handlers,{domTarget:userInteractionElemRef,eventOptions:{passive:false}});useUserAbilityToSelectSwitcher(activeRef.current,(_b=(_a=userInteractionElemRef.current)===null||_a===void 0?void 0:_a.ownerDocument)===null||_b===void 0?void 0:_b.body);useDiagramCursor(activeRef.current,'move');useCursor(activeRef.current,'move',nodeState.ref.current);return{active:activeRef.current,userInteractionElemRef:userInteractionElemRef};};var selectDelay=500;function allowNodeInteraction(event){return eventPathContainsClass(event,enableNodeUserInteractionClassName,disableNodeUserInteractionClassName);}var enableNodeUserInteractionClassName='react_easy_diagram_enable_node_user_interaction';var disableNodeUserInteractionClassName='react_easy_diagram_disable_node_user_interaction';var NodeWrapper=mobxReactLite.observer(function(_a){var node=_a.node;var userInteractionElemRef=useNodeUserInteraction(node).userInteractionElemRef;var renderedPortsContextValue=usePortsCleanUp(node);return React__default['default'].createElement(NodeContext.Provider,{value:node},React__default['default'].createElement(RenderedPortsComponentsContext.Provider,{value:renderedPortsContextValue},React__default['default'].createElement("div",{id:node.id,className:className$1,style:{transform:"translate("+node.position[0]+"px, "+node.position[1]+"px)",zIndex:node.selected?10:undefined},ref:node.ref},React__default['default'].createElement(node.componentDefinition.component,{draggableRef:userInteractionElemRef,entity:node,settings:node.componentDefinition.settings}))));});var NodeContext=React__default['default'].createContext(null);var RenderedPortsComponentsContext=React__default['default'].createContext({render:function render(){return undefined;},unrender:function unrender(){return undefined;}});var className$1="react_fast_diagram_NodeWrapper "+enableNodeUserInteractionClassName;/**
 * Clean up old ports.
 * @param node
 * @returns ports that are currently rendered
 */var usePortsCleanUp=function usePortsCleanUp(node){var renderedPortsRef=useNotifyRef([]);var renderedPortsContextValue=React.useMemo(function(){return{render:function render(id){if(!renderedPortsRef.current.includes(id)){renderedPortsRef.current=__spreadArrays(renderedPortsRef.current,[id]);}},unrender:function unrender(id){if(renderedPortsRef.current.includes(id)){renderedPortsRef.current=renderedPortsRef.current.filter(function(oldId){return oldId!==id;});}}};},[renderedPortsRef]);React.useLayoutEffect(function(){renderedPortsRef.current=[];},[node,renderedPortsRef]);React.useEffect(function(){var extraPortsIds=Object.keys(node.ports).filter(function(id){return!renderedPortsRef.current.includes(id);});mobx.action(function(){return extraPortsIds.forEach(function(id){return node.removePort(id);});});},[renderedPortsRef.current]);return renderedPortsContextValue;};var NodesLayer=mobxReactLite.observer(function(_a){var nodesStore=_a.nodesStore;var rootStore=useRootStore();React.useEffect(function(){rootStore.diagramState.zoomToFit();},[]);return React__default['default'].createElement("div",null,Array.from(nodesStore.nodes).map(function(_a){_a[0];var node=_a[1];return React__default['default'].createElement(NodeWrapper,{key:node.id,node:node});}));});function useDiagramDragHandlers(cancelEvent){var _a,_b;var rootStore=useRootStore();var diagramState=rootStore.diagramState;var activeRef=useNotifyRef(false);var handlers=React.useMemo(function(){return{onDrag:function onDrag(_a){var pinching=_a.pinching,delta=_a.delta;if(!activeRef.current||pinching){return;}diagramState.setOffset(addPoints(diagramState.offset,delta));},onDragStart:function onDragStart(_a){var event=_a.event,cancel=_a.cancel;if(cancelEvent&&cancelEvent(event)){cancel();return;}// Do not activate so drag will not be performed, but also don't cancel, as it would not be possible to clear selection
if(!rootStore.diagramSettings.userInteraction.diagramPan||event.buttons!==1){return;}activeRef.current=true;},onDragEnd:function onDragEnd(_a){var tap=_a.tap;if(tap){rootStore.selectionState.clear();}activeRef.current=false;}};},[activeRef,diagramState,cancelEvent,rootStore]);useUserAbilityToSelectSwitcher(activeRef.current,(_b=(_a=diagramState.diagramInnerRef.current)===null||_a===void 0?void 0:_a.ownerDocument)===null||_b===void 0?void 0:_b.body);useDiagramCursor(activeRef.current,'grabbing');return handlers;}function useDiagramPinchHandlers(cancel){var _a,_b;var _c=useRootStore(),diagramState=_c.diagramState,diagramSettings=_c.diagramSettings;var activeRef=useNotifyRef(false);var pinchState=React.useRef({distance:0,origin:[0,0],elementLeftTop:[0,0]});var handlers=React.useMemo(function(){return{onPinch:function onPinch(_a){var distance=_a.da[0],origin=_a.origin;if(!activeRef.current||!diagramState.diagramInnerRef.current){return;}var originDiff=diagramSettings.userInteraction.diagramPan?subtractPoints(origin,pinchState.current.origin):[0,0];var originPositionOnElement=subtractPoints(origin,pinchState.current.elementLeftTop);diagramState.tranlsateAndZoomInto(originDiff,originPositionOnElement,distance/pinchState.current.distance);pinchState.current={distance:distance,origin:origin,elementLeftTop:pinchState.current.elementLeftTop};},onPinchStart:function onPinchStart(_a){var distance=_a.da[0],origin=_a.origin,event=_a.event;if(!diagramSettings.userInteraction.diagramZoom||cancel(event)||!diagramState.diagramInnerRef.current){return;}var rect=diagramState.diagramInnerRef.current.getBoundingClientRect();pinchState.current={distance:distance,origin:origin,elementLeftTop:[rect.left,rect.top]};activeRef.current=true;},onPinchEnd:function onPinchEnd(){return activeRef.current=false;}};},[diagramState.diagramInnerRef.current,activeRef,diagramState,cancel,diagramSettings]);useUserAbilityToSelectSwitcher(activeRef.current,(_b=(_a=diagramState.diagramInnerRef.current)===null||_a===void 0?void 0:_a.ownerDocument)===null||_b===void 0?void 0:_b.body);return handlers;}function useDiagramWheelHandler(state){var _a=useRootStore(),diagramState=_a.diagramState,diagramSettings=_a.diagramSettings;var handlers=React.useMemo(function(){return{onWheel:function onWheel(_a){var _b=_a.direction;_b[0];var yDirection=_b[1],event=_a.event;if(!diagramState.diagramInnerRef.current||!diagramSettings.userInteraction.diagramZoom)return;event===null||event===void 0?void 0:event.preventDefault();var rect=diagramState.diagramInnerRef.current.getBoundingClientRect();var mousePositionOnElement=subtractPoints([event.clientX,event.clientY],[rect.left,rect.top]);var factor=0.9;if(yDirection<0){factor=1/factor;}state.tranlsateAndZoomInto([0,0],mousePositionOnElement,factor);}};},[diagramState.diagramInnerRef,state,diagramSettings]);return handlers;}var useDiagramUserInteraction=function useDiagramUserInteraction(){var diagramState=useRootStore().diagramState;var cancelGesture=React.useCallback(function(event){return event.target!==diagramState.diagramInnerRef.current;},[diagramState.diagramInnerRef]);var dragHandlers=useDiagramDragHandlers(cancelGesture);var pinchHandlers=useDiagramPinchHandlers(cancelGesture);var wheelHandler=useDiagramWheelHandler(diagramState);reactUseGesture.useGesture(_assign(_assign(_assign({},dragHandlers),pinchHandlers),wheelHandler),{domTarget:diagramState.diagramInnerRef,eventOptions:{passive:false}});return{transform:diagramState.transformString};};var MiniControlWrapper=mobxReactLite.observer(function(){var rootStore=useRootStore();var minicontrolComponentState=rootStore.diagramSettings.miniControlComponentState;return minicontrolComponentState.component&&React__default['default'].createElement(minicontrolComponentState.component,{rootStore:rootStore,settings:minicontrolComponentState.settings});});var InnerDiagram=mobxReactLite.observer(function(props){var rootStore=useRootStore();var transform=useDiagramUserInteraction().transform;React.useEffect(function(){var resizeHandler=function resizeHandler(){return rootStore.nodesStore.nodes.forEach(function(n){return n.recalculatePortsSizeAndPosition();});};window.addEventListener('resize',resizeHandler);return function(){return window.removeEventListener('resize',resizeHandler);};},[rootStore]);return React__default['default'].createElement("div",{ref:rootStore.diagramState.diagramInnerRef,style:_assign({},props.diagramStyles),className:'react_fast_diagram_DiagramInner'},React__default['default'].createElement(BackgroundWrapper,null),React__default['default'].createElement("div",{className:'react_fast_diagram_DiagramInner_DraggablePart',style:{transform:transform}},React__default['default'].createElement(LinksLayer,{linksStore:rootStore.linksStore}),React__default['default'].createElement(NodesLayer,{nodesStore:rootStore.nodesStore})),React__default['default'].createElement(MiniControlWrapper,null));});InnerDiagram.displayName='InnerDiagram';var Callbacks=/** @class */function(){function Callbacks(rootStore){var _this=this;this.import=function(callbacks){_this._validateLinkEndpoints=callbacks===null||callbacks===void 0?void 0:callbacks.validateLinkEndpoints;};this.export=function(){return{validateLinkEndpoints:_this._validateLinkEndpoints};};this._rootStore=rootStore;}Object.defineProperty(Callbacks.prototype,"validateLinkEndpoints",{get:function get(){return this._validateLinkEndpoints;},enumerable:false,configurable:true});return Callbacks;}();var VisualComponentWithDefault=/** @class */function(){function VisualComponentWithDefault(defaultComponent){var _this=this;this.import=function(newComponent){_this._innerComponent=newComponent?new VisualComponentState(newComponent):_this._defaultComponent;};this._innerComponent=new VisualComponentState(defaultComponent);this._defaultComponent=this._innerComponent;mobx.makeAutoObservable(this);}Object.defineProperty(VisualComponentWithDefault.prototype,"component",{get:function get(){return this._innerComponent.component;},enumerable:false,configurable:true});Object.defineProperty(VisualComponentWithDefault.prototype,"settings",{get:function get(){return this._innerComponent.settings;},enumerable:false,configurable:true});return VisualComponentWithDefault;}();// Icons from https://material-ui.com/components/material-icons/
var RubbishBinIcon=function RubbishBinIcon(){return React__default['default'].createElement("svg",{viewBox:'0 0 24 24'},React__default['default'].createElement("path",{d:"M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zm2.46-7.12l1.41-1.41L12 12.59l2.12-2.12 1.41 1.41L13.41 14l2.12 2.12-1.41 1.41L12 15.41l-2.12 2.12-1.41-1.41L10.59 14l-2.13-2.12zM15.5 4l-1-1h-5l-1 1H5v2h14V4z"}));};var CopyIcon=function CopyIcon(){return React__default['default'].createElement("svg",{viewBox:'0 0 24 24'},React__default['default'].createElement("path",{d:'M16 1H4c-1.1 0-2 .9-2 2v14h2V3h12V1zm-1 4H8c-1.1 0-1.99.9-1.99 2L6 21c0 1.1.89 2 1.99 2H19c1.1 0 2-.9 2-2V11l-6-6zM8 21V7h6v5h5v9H8z'}));};var FilterCenterFocusIcon=function FilterCenterFocusIcon(){return React__default['default'].createElement("svg",{viewBox:'0 0 24 24'},React__default['default'].createElement("path",{d:"M5 15H3v4c0 1.1.9 2 2 2h4v-2H5v-4zM5 5h4V3H5c-1.1 0-2 .9-2 2v4h2V5zm14-2h-4v2h4v4h2V5c0-1.1-.9-2-2-2zm0 16h-4v2h4c1.1 0 2-.9 2-2v-4h-2v4zM12 9c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z"}));};var MiniControlDefault=mobxReactLite.observer(function(_a){var rootStore=_a.rootStore,settings=_a.settings;settings=settings!==null&&settings!==void 0?settings:defaultSettings;if(Object.values(settings.buttons).every(function(v){return v===false;}))return null;return React__default['default'].createElement("div",{className:'react_fast_diagram_Minicontrol_Default',style:_assign(_assign({},getOffsetStyles(settings)),settings===null||settings===void 0?void 0:settings.containerStyle)},settings.buttons.deleteSelection&&rootStore.selectionState.selectedItems.length>0&&React__default['default'].createElement(Button,{size:settings.buttonsSize,onClick:rootStore.selectionState.removeSelected},React__default['default'].createElement(RubbishBinIcon,null)),settings.buttons.cloneSelectedNodes&&rootStore.selectionState.selectedItems.length>0&&React__default['default'].createElement(Button,{size:settings.buttonsSize,onClick:rootStore.selectionState.cloneSelectedNodes},React__default['default'].createElement(CopyIcon,null)),settings.buttons.zoomIn&&React__default['default'].createElement(Button,{size:settings.buttonsSize,onClick:rootStore.diagramState.zoomIn,children:'+'}),settings.buttons.zoomOut&&React__default['default'].createElement(Button,{size:settings.buttonsSize,onClick:rootStore.diagramState.zoomOut,children:'-'}),settings.buttons.zoomToFit&&React__default['default'].createElement(Button,{size:settings.buttonsSize,onClick:rootStore.diagramState.zoomToFit},React__default['default'].createElement(FilterCenterFocusIcon,null)));});function getOffsetStyles(settings){return{top:settings.position=='left-top'||settings.position=='right-top'?settings.parentOffset:undefined,right:settings.position=='right-bottom'||settings.position=='right-top'?settings.parentOffset:undefined,bottom:settings.position=='left-bottom'||settings.position=='right-bottom'?settings.parentOffset:undefined,left:settings.position=='left-top'||settings.position=='left-bottom'?settings.parentOffset:undefined};}var Button=function Button(props){return React__default['default'].createElement("button",{onClick:props.onClick,className:'react_fast_diagram_Minicontrol_Default_Btn',style:{width:props.size+'px',height:props.size+'px',padding:5}},props.children);};var createDefaultMiniControl=function createDefaultMiniControl(settings){var finalSettings=_assign(_assign({},defaultSettings),settings?settings:{});return{component:MiniControlDefault,settings:finalSettings};};var defaultSettings={position:'left-bottom',containerStyle:{},buttonsSize:30,buttons:{zoomIn:true,zoomOut:true,deleteSelection:true,cloneSelectedNodes:true,zoomToFit:true},parentOffset:20};var UserInteractionSettings=/** @class */function(){function UserInteractionSettings(){var _this=this;this.import=function(obj){var _a,_b,_c,_d,_e,_f;if(obj===true||obj===undefined||obj===null)_this.setAll(true);else if(obj===false)_this.setAll(false);else if(isObject(obj)){_this._diagramZoom=(_a=obj.diagramZoom)!==null&&_a!==void 0?_a:true;_this._diagramPan=(_b=obj.diagramPan)!==null&&_b!==void 0?_b:true;_this._nodeDrag=(_c=obj.nodeDrag)!==null&&_c!==void 0?_c:true;_this._portConnection=(_d=obj.portConnection)!==null&&_d!==void 0?_d:true;_this._nodeSelection=(_e=obj.nodeSelection)!==null&&_e!==void 0?_e:true;_this._linkSelection=(_f=obj.linkSelection)!==null&&_f!==void 0?_f:true;}};this.setAll=function(value){_this._diagramZoom=value;_this._diagramPan=value;_this._nodeDrag=value;_this._portConnection=value;_this._nodeSelection=value;_this._linkSelection=value;};this.import();mobx.makeAutoObservable(this);}Object.defineProperty(UserInteractionSettings.prototype,"diagramZoom",{get:function get(){return this._diagramZoom;},set:function set(value){this._diagramZoom=value;},enumerable:false,configurable:true});Object.defineProperty(UserInteractionSettings.prototype,"diagramPan",{get:function get(){return this._diagramPan;},set:function set(value){this._diagramPan=value;},enumerable:false,configurable:true});Object.defineProperty(UserInteractionSettings.prototype,"nodeDrag",{get:function get(){return this._nodeDrag;},set:function set(value){this._nodeDrag=value;},enumerable:false,configurable:true});Object.defineProperty(UserInteractionSettings.prototype,"portConnection",{get:function get(){return this._portConnection;},set:function set(value){this._portConnection=value;},enumerable:false,configurable:true});Object.defineProperty(UserInteractionSettings.prototype,"nodeSelection",{get:function get(){return this._nodeSelection;},set:function set(value){this._nodeSelection=value;},enumerable:false,configurable:true});Object.defineProperty(UserInteractionSettings.prototype,"linkSelection",{get:function get(){return this._linkSelection;},set:function set(value){this._linkSelection=value;},enumerable:false,configurable:true});return UserInteractionSettings;}();var DiagramSettings=/** @class */function(){function DiagramSettings(){var _this=this;this._zoomInterval=defaultZoomInterval;this._zoomToFitSettings=defaultZoomToFitSettings;this.import=function(obj){_this._backgroundComponentState.import(obj===null||obj===void 0?void 0:obj.backgroundComponent);_this._miniControlComponentState.import(obj===null||obj===void 0?void 0:obj.miniControlComponent);_this.setZoomInterval(obj===null||obj===void 0?void 0:obj.zoomInterval);_this._zoomToFitSettings=_assign(_assign({},defaultZoomToFitSettings),obj===null||obj===void 0?void 0:obj.zoomToFitSettings);_this._userInteraction.import(obj===null||obj===void 0?void 0:obj.userInteraction);};this.setZoomInterval=function(value){_this._zoomInterval=value!==null&&value!==void 0?value:defaultZoomInterval;};this._backgroundComponentState=new VisualComponentWithDefault(createDefaultBackground());this._miniControlComponentState=new VisualComponentWithDefault(createDefaultMiniControl());this._userInteraction=new UserInteractionSettings();mobx.makeAutoObservable(this);}Object.defineProperty(DiagramSettings.prototype,"backgroundComponentState",{get:function get(){return this._backgroundComponentState;},enumerable:false,configurable:true});Object.defineProperty(DiagramSettings.prototype,"miniControlComponentState",{get:function get(){return this._miniControlComponentState;},enumerable:false,configurable:true});Object.defineProperty(DiagramSettings.prototype,"zoomInterval",{get:function get(){return this._zoomInterval;},enumerable:false,configurable:true});Object.defineProperty(DiagramSettings.prototype,"zoomToFitSettings",{get:function get(){return this._zoomToFitSettings;},enumerable:false,configurable:true});Object.defineProperty(DiagramSettings.prototype,"userInteraction",{get:function get(){return this._userInteraction;},enumerable:false,configurable:true});return DiagramSettings;}();var defaultZoomInterval=[0.1,3];var defaultZoomToFitSettings={padding:[30,30]};var DiagramState=/** @class */function(){function DiagramState(rootStore){var _this=this;this.import=function(state){_this.setOffset(state===null||state===void 0?void 0:state.offset);_this.setZoom(state===null||state===void 0?void 0:state.zoom);};this.export=function(){return deepCopy({offset:_this._offset,zoom:_this._zoom});};this.setOffset=function(newOffset){_this._offset=newOffset!==null&&newOffset!==void 0?newOffset:[0,0];};this.setZoom=function(newZoom){_this._zoom=clampValue(newZoom!==null&&newZoom!==void 0?newZoom:1,_this._rootStore.diagramSettings.zoomInterval);};this.zoomIn=function(){return _this._rootStore.diagramState.zoomIntoCenter(1/0.8);};this.zoomOut=function(){return _this._rootStore.diagramState.zoomIntoCenter(0.8);};this.setTransformation=function(newOffset,newZoom){_this.setOffset(newOffset);_this.setZoom(newZoom);};// See: https://stackoverflow.com/a/30039971/9142642
...
var bind=reactUseGesture.useGesture(handlers,{eventOptions:{passive:false}});useUserAbilityToSelectSwitcher(!!(portState===null||portState===void 0?void 0:portState.dragging),(_b=(_a=portState===null||portState===void 0?void 0:portState.ref.current)===null||_a===void 0?void 0:_a.ownerDocument)===null||_b===void 0?void 0:_b.body);useDiagramCursor(!!(portState===null||portState===void 0?void 0:portState.dragging),'pointer');return{active:!!(portState===null||portState===void 0?void 0:portState.dragging),bind:bind};};var Port=mobxReactLite.observer(function(props){var node=React.useContext(NodeContext);// node should already exist
var portState=useUpdateOrCreatePortState(_assign(_assign({linkDirection:props.position&&positionToLinkDirection[props.position]},props),{nodeId:node.id}));var positionStyles=useRelativePositionStyles(props.position,props.offsetFromNodeCenter,props.offsetFromOrigin);useRenderingReport(props.id);var bind=usePortUserInteraction(portState).bind;React.useEffect(function(){portState===null||portState===void 0?void 0:portState.ref.recalculateSizeAndPosition();},[portState,portState===null||portState===void 0?void 0:portState.ref,portState===null||portState===void 0?void 0:portState.sizeAndPositionRecalculationWithDelay]);if(!portState){return null;}return React__default['default'].createElement("div",_assign({style:positionStyles,id:portState.fullId,className:className,ref:portState.ref,key:portState.fullId},bind()),React__default['default'].createElement(portState.componentDefinition.component,{entity:portState,settings:portState.componentDefinition.settings}));});var className="react_fast_diagram_Port "+disableNodeUserInteractionClassName;/**
 * Report to NodeWrapper that port was rendered so it can clean up the old ports
 * @param id - port id
 */var useRenderingReport=function useRenderingReport(id){var _a=React.useContext(RenderedPortsComponentsContext),render=_a.render,unrender=_a.unrender;React.useEffect(function(){render(id);return function(){return unrender(id);};},[id]);};var positionToLinkDirection={'left-center':'left','left-bottom':'left','left-top':'left','top-left':'up','top-center':'up','top-right':'up','right-center':'right','right-bottom':'right','right-top':'right','bottom-left':'down','bottom-center':'down','bottom-right':'down','diagonal-left-top':'left-up','diagonal-right-top':'right-up','diagonal-right-bottom':'right-down','diagonal-left-bottom':'left-down'};var Node=mobxReactLite.observer(function(_a){var entity=_a.entity,settings=_a.settings,draggableRef=_a.draggableRef;var finalSettings=_assign(_assign({},defaultNodeDefaultSettings),settings);var finalStyles=_assign(_assign({},finalSettings.style),entity.selected?finalSettings.selectedStyle:undefined);return React__default['default'].createElement("div",{ref:draggableRef,className:'react_fast_diagram_Node_Default',style:finalStyles},React__default['default'].createElement(finalSettings.innerNode,{node:entity}),Array.isArray(finalSettings.ports)&&finalSettings.ports.map(function(p){return React__default['default'].createElement(Port,_assign({},p,{key:p.id}));}));});var defaultNodeDefaultSettings={style:{padding:'10px'},selectedStyle:{border:'#6eb7ff solid 1px'},innerNode:NodeLabel};function createNode(settings){return{component:Node,settings:_assign(_assign({},defaultNodeDefaultSettings),settings)};}var createInputOutputHorizontalNode=function createInputOutputHorizontalNode(settings){return createNode(_assign(_assign({},settings),{ports:[{id:'input',type:'input',position:'left-center'},{id:'output',type:'output',position:'right-center'}]}));};var createInputOutputVerticalNode=function createInputOutputVerticalNode(settings){return createNode(_assign(_assign({},settings),{ports:[{id:'input',type:'input',position:'top-center'},{id:'output',type:'output',position:'bottom-center'}]}));};var createInputHorizontalNode=function createInputHorizontalNode(settings){return createNode(_assign(_assign({},settings),{ports:[{id:'input',type:'input',position:'left-center'}]}));};var createInputVerticalNode=function createInputVerticalNode(settings){return createNode(_assign(_assign({},settings),{ports:[{id:'input',type:'input',position:'top-center'}]}));};var createOutputHorizontalNode=function createOutputHorizontalNode(settings){return createNode(_assign(_assign({},settings),{ports:[{id:'output',type:'output',position:'right-center'}]}));};var createOutputVerticalNode=function createOutputVerticalNode(settings){return createNode(_assign(_assign({},settings),{ports:[{id:'output',type:'output',position:'bottom-center'}]}));};var createStarNode=function createStarNode(settings){return createNode(_assign(_assign({},settings),{ports:[{id:'left',position:'left-center'},{id:'top',position:'top-center'},{id:'right',position:'right-center'},{id:'bottom',position:'bottom-center'}]}));};var NodesSettings=/** @class */function(){function NodesSettings(){var _a;var _this=this;this._visualComponents=new VisualComponents((_a={},_a[componentDefaultType]=createNode({ports:[]}),_a.input_output_horizontal=createInputOutputHorizontalNode(),_a.input_output_vertical=createInputOutputVerticalNode(),_a.input_vertical=createInputVerticalNode(),_a.input_horizontal=createInputHorizontalNode(),_a.output_vertical=createOutputVerticalNode(),_a.output_horizontal=createOutputHorizontalNode(),_a.star=createStarNode(),_a));this.import=function(obj){_this._visualComponents.import(obj);_this.setGridSnap(obj===null||obj===void 0?void 0:obj.gridSnap);};this.setGridSnap=function(gridSnap){if(!gridSnap){_this._gridSnap=null;}else if(typeof gridSnap==='number'){_this._gridSnap=[gridSnap,gridSnap];}else if(Array.isArray(gridSnap)&&gridSnap.length===2){_this._gridSnap=gridSnap;}};this.setGridSnap();mobx.makeAutoObservable(this);}Object.defineProperty(NodesSettings.prototype,"visualComponents",{get:function get(){return this._visualComponents;},enumerable:false,configurable:true});Object.defineProperty(NodesSettings.prototype,"gridSnap",{get:function get(){return this._gridSnap;},enumerable:false,configurable:true});return NodesSettings;}();var NodesStore=/** @class */function(){function NodesStore(rootStore){var _this=this;this._nodes=new Map();this.import=function(newNodes){_this._nodes=new Map();newNodes===null||newNodes===void 0?void 0:newNodes.forEach(function(node){return _this.addNode(node,true);});};this.export=function(){return Array.from(_this._nodes).map(function(_a){_a[0];var value=_a[1];return value.export();});};this.addNode=function(node,rewriteIfExists){var _a;if(!node||!rewriteIfExists&&node.id&&_this._nodes.has(node.id)){return errorResult('');}var newNode=new NodeState(_this._rootStore,(_a=node.id)!==null&&_a!==void 0?_a:guidForcedUniqueness(function(id){return _this._nodes.has(id);}),node);_this._nodes.set(newNode.id,newNode);return successValueResult(newNode);};this.removeNode=function(nodeId){var node=_this._nodes.get(nodeId);if(node){_this._rootStore.linksStore.removeNodeLinks(nodeId);_this._rootStore.selectionState.unselect(node);_this._nodes.delete(nodeId);return true;}return false;};this.getNode=function(nodeId){return _this._nodes.get(nodeId);};this.getNodeOrThrowException=function(nodeId){var node=_this.getNode(nodeId);if(node)return node;else throw"Node with id '"+nodeId+"' does not exist";};/**
         * @returns Values are calculated without zoom taking into account, that is, the same as zoom would be '1'
         */this.getNodesBoundingBox=function(){var topLeftCorner=[Number.POSITIVE_INFINITY,Number.POSITIVE_INFINITY];var bottomRightCorner=[Number.NEGATIVE_INFINITY,Number.NEGATIVE_INFINITY];_this._nodes.forEach(function(node){var _a;var pos=node.position;var size=(_a=node.realSize)!==null&&_a!==void 0?_a:[1,1];topLeftCorner[0]=Math.min(topLeftCorner[0],pos[0]);topLeftCorner[1]=Math.min(topLeftCorner[1],pos[1]);bottomRightCorner[0]=Math.max(bottomRightCorner[0],pos[0]+size[0]);bottomRightCorner[1]=Math.max(bottomRightCorner[1],pos[1]+size[1]);});return{topLeftCorner:topLeftCorner,bottomRightCorner:bottomRightCorner,size:subtractPoints(bottomRightCorner,topLeftCorner)};};mobx.makeAutoObservable(this);this._rootStore=rootStore;}Object.defineProperty(NodesStore.prototype,"nodes",{get:function get(){return this._nodes;},enumerable:false,configurable:true});return NodesStore;}();var PortInnerDefault=mobxReactLite.observer(function(_a){var port=_a.entity,settings=_a.settings;var finalSettings=_assign(_assign({},portDefaultSettings),settings);var color=finalSettings.color;if(port.dragging)color=finalSettings.dragColor;else if(port.hovered&&port.validForConnection)color=finalSettings.hoverColor;else if(port.hovered&&!port.validForConnection)color=finalSettings.invalidColor;return React__default['default'].createElement("div",{style:{width:finalSettings.size[0],height:finalSettings.size[1],backgroundColor:color,borderRadius:'2px'}});});var portDefaultSettings={size:[10,10],color:'#6eb7ff',dragColor:'#49f860',hoverColor:'#49f860',invalidColor:'#fa4040'};function createPortInnerDefault(settings){return{component:PortInnerDefault,settings:_assign(_assign({},portDefaultSettings),settings)};}var PortsSettings=/** @class */function(){function PortsSettings(){var _a;var _this=this;this._portVisualComponents=new VisualComponents((_a={},_a[componentDefaultType]=createPortInnerDefault(),_a));this.import=function(obj){_this.portVisualComponents.import({components:obj===null||obj===void 0?void 0:obj.portComponents,defaultType:obj===null||obj===void 0?void 0:obj.portDefaultType});};mobx.makeAutoObservable(this);}Object.defineProperty(PortsSettings.prototype,"portVisualComponents",{get:function get(){return this._portVisualComponents;},enumerable:false,configurable:true});return PortsSettings;}();var SelectionState=/** @class */function(){function SelectionState(rootStore){var _this=this;this._selectedItems=[];this.select=function(item,multipleActivated){if(multipleActivated){if(_this._selectedItems.includes(item)){_this.unselect(item);}else{item.selected=true;_this._selectedItems.push(item);}}else{_this.clear();item.selected=true;_this._selectedItems.push(item);}};this.unselect=function(item){item.selected=false;_this._selectedItems=_this._selectedItems.filter(function(i){return i!==item;});};this.clear=function(){_this._selectedItems.forEach(function(i){return i.selected=false;});_this._selectedItems=[];};this.removeSelected=function(){_this.removeSelectedNodes();_this.removeSelectedLinks();};this.removeSelectedNodes=function(){_this._selectedItems.filter(function(i){return i instanceof NodeState;}).forEach(function(node){_this._rootStore.nodesStore.removeNode(node.id);});};this.removeSelectedLinks=function(){_this._selectedItems.filter(function(i){return i instanceof LinkState;}).forEach(function(link){_this._rootStore.linksStore.removeLink(link.id);});};this.cloneSelectedNodes=function(){_this._selectedItems.filter(function(i){return i instanceof NodeState;}).forEach(function(node){var nodeObj=node.export();nodeObj.id=undefined;nodeObj.label=[nodeObj.label,'copy'].join(' ');nodeObj.position=addPoints(nodeObj.position,[50,50]);_this._rootStore.nodesStore.addNode(nodeObj,false);});};mobx.makeAutoObservable(this);this._rootStore=rootStore;}Object.defineProperty(SelectionState.prototype,"selectedItems",{get:function get(){return this._selectedItems;},enumerable:false,configurable:true});return SelectionState;}();var RootStore=/** @class */function(){function RootStore(){var _this=this;this.importState=function(nodes,links){_this._nodesStore.import(nodes);_this._linksStore.import(links);};this.export=function(){return{nodes:_this._nodesStore.export(),links:_this._linksStore.export()};};this.importSettings=function(settings){_this._diagramSettings.import(settings.diagram);_this._nodesSettings.import(settings.nodes);_this._linksSettings.import(settings.links);_this._portsSettings.import(settings.ports);_this._callbacks.import(settings.callbacks);};this._diagramSettings=new DiagramSettings();this._nodesSettings=new NodesSettings();this._linksSettings=new LinksSettings();this._portsSettings=new PortsSettings();this._callbacks=new Callbacks(this);this._diagramState=new DiagramState(this);this._nodesStore=new NodesStore(this);this._linksStore=new LinksStore(this);this._selectionState=new SelectionState(this);}Object.defineProperty(RootStore.prototype,"diagramState",{get:function get(){return this._diagramState;},enumerable:false,configurable:true});Object.defineProperty(RootStore.prototype,"nodesStore",{get:function get(){return this._nodesStore;},enumerable:false,configurable:true});Object.defineProperty(RootStore.prototype,"linksStore",{get:function get(){return this._linksStore;},enumerable:false,configurable:true});Object.defineProperty(RootStore.prototype,"diagramSettings",{get:function get(){return this._diagramSettings;},enumerable:false,configurable:true});Object.defineProperty(RootStore.prototype,"nodesSettings",{get:function get(){return this._nodesSettings;},enumerable:false,configurable:true});Object.defineProperty(RootStore.prototype,"linksSettings",{get:function get(){return this._linksSettings;},enumerable:false,configurable:true});Object.defineProperty(RootStore.prototype,"portsSettings",{get:function get(){return this._portsSettings;},enumerable:false,configurable:true});Object.defineProperty(RootStore.prototype,"callbacks",{get:function get(){return this._callbacks;},enumerable:false,configurable:true});Object.defineProperty(RootStore.prototype,"selectionState",{get:function get(){return this._selectionState;},enumerable:false,configurable:true});return RootStore;}();function styleInject(css,ref){if(ref===void 0)ref={};var insertAt=ref.insertAt;if(!css||typeof document==='undefined'){return;}var head=document.head||document.getElementsByTagName('head')[0];var style=document.createElement('style');style.type='text/css';if(insertAt==='top'){if(head.firstChild){head.insertBefore(style,head.firstChild);}else{head.appendChild(style);}}else{head.appendChild(style);}if(style.styleSheet){style.styleSheet.cssText=css;}else{style.appendChild(document.createTextNode(css));}}var css_248z=".react_fast_diagram_DiagramInner {\r\n  width: 100%;\r\n  height: 100%;\r\n  min-height: 100%;\r\n  position: relative;\r\n  overflow: hidden;\r\n  touch-action: none;\r\n  -webkit-user-select: none;\r\n     -moz-user-select: none;\r\n      -ms-user-select: none;\r\n          user-select: none;\r\n}\r\n\r\n.react_fast_diagram_DiagramInner * {\r\n  margin: 0;\r\n  padding: 0;\r\n  box-sizing: border-box;\r\n  color: black;\r\n}\r\n\r\n.react_fast_diagram_DiagramInner_DraggablePart {\r\n  width: 100%;\r\n  height: 100%;\r\n  position: absolute;\r\n  overflow: visible;\r\n  transform-origin: 0px 0px;\r\n  top: 0px;\r\n  left: 0px;\r\n  right: 0px;\r\n  bottom: 0px;\r\n  /* useGestures hook use targetTouches instead of simply touches, \r\n  so we should set this property to Movable, otherwise if user put \r\n  one finger above Movable and another above DiagramInner, the hook \r\n  will not trigger pinch gesture */\r\n  pointer-events: none;\r\n}\r\n\r\n.react_fast_diagram_DiagramInner_DraggablePart > * {\r\n  overflow: visible;\r\n}\r\n\r\n.react_fast_diagram_NodeWrapper {\r\n  position: absolute;\r\n  top: 0;\r\n  left: 0;\r\n  width: -webkit-fit-content;\r\n  width: -moz-fit-content;\r\n  width: fit-content;\r\n  height: -webkit-fit-content;\r\n  height: -moz-fit-content;\r\n  height: fit-content;\r\n  pointer-events: auto;\r\n}\r\n\r\n.react_fast_diagram_Node_Default {\r\n  min-width: 10px;\r\n  min-height: 10px;\r\n  border-radius: 3px;\r\n  background-color: white;\r\n  border: #c2c2c2 solid 1px;\r\n  display: flex;\r\n  flex-direction: column;\r\n  align-items: center;\r\n  text-align: center;\r\n  margin: auto;\r\n  font-size: small;\r\n}\r\n\r\n.react_fast_diagram_PortContainer_Default {\r\n  display: flex;\r\n  align-items: center;\r\n  justify-content: center;\r\n}\r\n\r\n.react_fast_diagram_Node_Default > * {\r\n  text-align: center;\r\n  margin: auto;\r\n}\r\n\r\n.react_fast_diagram_disabled_user_select {\r\n  -webkit-user-select: none;\r\n     -moz-user-select: none;\r\n      -ms-user-select: none;\r\n          user-select: none;\r\n}\r\n\r\n.react_fast_diagram_BackgroundWrapper {\r\n  height: 100%;\r\n  width: 100%;\r\n  pointer-events: none;\r\n}\r\n\r\n.react_fast_diagram_Background_Default {\r\n  height: 100%;\r\n  width: 100%;\r\n}\r\n\r\n.react_fast_diagram_Minicontrol_Default {\r\n  position: absolute;\r\n  height: -webkit-fit-content;\r\n  height: -moz-fit-content;\r\n  height: fit-content;\r\n  display: flex;\r\n  flex-direction: column;\r\n}\r\n\r\n.react_fast_diagram_Minicontrol_Default_Btn {\r\n  background-color: white; \r\n  border: 1px solid rgb(209, 209, 209);\r\n  color: black; \r\n  padding: 2px;\r\n  font-size: 16px;\r\n  cursor: pointer;\r\n  text-align: center;\r\n}\r\n\r\n@media(hover: hover) and (pointer: fine) {\r\n  .react_fast_diagram_Minicontrol_Default_Btn:hover {\r\n    background-color: rgb(228, 228, 228);\r\n  }\r\n}\r\n\r\n.react_fast_diagram_Port {\r\n  cursor: pointer;\r\n}\r\n\r\n/* Containers with gap between items */\r\n\r\n.react_fast_diagram_flex_gap {\r\n  --gap: 12px;\r\n  display: flex;\r\n  align-items: center;\r\n  justify-content: center;\r\n}\r\n\r\n.react_fast_diagram_flex_gap_y {\r\n  flex-direction: column;\r\n  height: 100%;\r\n}\r\n\r\n.react_fast_diagram_flex_gap_y > * {\r\n  margin: var(--gap) 0 0 0;\r\n}\r\n\r\n.react_fast_diagram_flex_gap_y > :first-child {\r\n  margin: 0;\r\n}\r\n\r\n.react_fast_diagram_flex_gap_x {\r\n  flex-direction: row;\r\n  width: 100%;\r\n}\r\n\r\n.react_fast_diagram_flex_gap_x > * {\r\n  margin: 0 0 0 var(--gap);\r\n}\r\n\r\n.react_fast_diagram_flex_gap_x > :first-child {\r\n  margin: 0;\r\n}\r\n\r\n/* Containers with gap between items */\r\n";styleInject(css_248z);var RootStoreContext=React__default['default'].createContext(null);function _Diagram(props){var rootStore=React.useMemo(function(){var _a,_b,_c,_d;var store=new RootStore();props.settings&&store.importSettings(props.settings);store.importState((_b=(_a=props.initState)===null||_a===void 0?void 0:_a.nodes)!==null&&_b!==void 0?_b:[],(_d=(_c=props.initState)===null||_c===void 0?void 0:_c.links)!==null&&_d!==void 0?_d:[]);return store;},[]);React.useEffect(function(){if(props.storeRef){props.storeRef.current=rootStore;}},[rootStore,props.storeRef]);return React__default['default'].createElement(RootStoreContext.Provider,{value:rootStore},React__default['default'].createElement(InnerDiagram,null));}_Diagram.displayName='Diagram';var useRootStore=function useRootStore(){return React.useContext(RootStoreContext);};var BackgroundWrapper=mobxReactLite.observer(function(){var _a=useRootStore(),diagramSettings=_a.diagramSettings,diagramState=_a.diagramState;return React__default['default'].createElement("div",{className:'react_fast_diagram_BackgroundWrapper'},React__default['default'].createElement(diagramSettings.backgroundComponentState.component,{diagramOffset:diagramState.offset,diagramZoom:diagramState.zoom,settings:diagramSettings.backgroundComponentState.settings}));});var positionValues=['left','top','right','bottom'];var PortsContainer=mobxReactLite.observer(function(_a){var position=_a.position,ports=_a.ports,style=_a.style,gapBetweenPorts=_a.gapBetweenPorts,offsetFromOriginPosition=_a.offsetFromOriginPosition;var portsModified=React.useMemo(function(){return ports&&ports.map(function(p){return _assign({linkDirection:positionToDirection[position]},p);});},[position,ports]);if(!portsModified||portsModified.length===0)return null;var className='react_fast_diagram_flex_gap ';if(position==='top'||position==='bottom'){className+='react_fast_diagram_flex_gap_x';}else{className+='react_fast_diagram_flex_gap_y';}var positionStyle={position:'absolute',left:position==='left'?0:undefined,top:position==='left'||position==='right'||position==='top'?0:undefined,right:position==='right'?0:undefined,bottom:position==='bottom'?0:undefined,height:position==='left'||position==='right'?'100%':undefined,width:position==='top'||position==='bottom'?'100%':undefined};var offsetFromOriginPositionStyle={};if(offsetFromOriginPosition&&positionValues.includes(position)){offsetFromOriginPositionStyle[position]=-offsetFromOriginPosition;}return React__default['default'].createElement("div",{className:className,style:_assign(_assign(_assign({// @ts-ignore
'--gap':gapBetweenPorts},style),positionStyle),offsetFromOriginPositionStyle)},portsModified&&portsModified.map(function(port){return React__default['default'].createElement(Port,_assign({},port,{key:port.id}));}));});var positionToDirection={left:'left',top:'up',right:'right',bottom:'down'};function createPortsContainer(settings){return function(props){return React__default['default'].createElement(PortsContainer,_assign({},_assign(_assign({},defaultPortsContainerSettings),settings),props));};}var defaultPortsContainerSettings={gapBetweenPorts:'8px'};var useDiagram=function useDiagram(initState,settings){var storeRef=useNotifyRef(null);var obj=React.useMemo(function(){return{Diagram:function Diagram(){return React__default['default'].createElement(_Diagram,{storeRef:storeRef,initState:initState,settings:settings});},storeRef:storeRef};},[]);return obj;};function straightLinkPathConstructor(source,target){var path="M "+source.point[0]+" "+source.point[1]+", "+target.point[0]+" "+target.point[1];return path;}function createStraightLinkPathConstructor(){return straightLinkPathConstructor;}var LinkPointEndpointState=/** @class */function(){function LinkPointEndpointState(pos){var _this=this;this.translateBy=function(pointToTranslateBy){_this._point=addPoints(_this._point,pointToTranslateBy);};this._point=pos;mobx.makeAutoObservable(this);}Object.defineProperty(LinkPointEndpointState.prototype,"point",{get:function get(){return this._point;},enumerable:false,configurable:true});return LinkPointEndpointState;}();exports.BackgroundWrapper=BackgroundWrapper;exports.Button=Button;exports.Callbacks=Callbacks;exports.CopyIcon=CopyIcon;exports.DISABLED_USER_SELECT_CSS_CLASS=DISABLED_USER_SELECT_CSS_CLASS;exports.Diagram=_Diagram;exports.DiagramSettings=DiagramSettings;exports.DiagramState=DiagramState;exports.FilterCenterFocusIcon=FilterCenterFocusIcon;exports.HtmlElementRefState=HtmlElementRefState;exports.InnerDiagram=InnerDiagram;exports.LinkCreationState=LinkCreationState;exports.LinkDefault=LinkDefault;exports.LinkPointEndpointState=LinkPointEndpointState;exports.LinkPortEndpointState=LinkPortEndpointState;exports.LinkState=LinkState;exports.LinkWrapper=LinkWrapper;exports.LinksLayer=LinksLayer;exports.LinksSettings=LinksSettings;exports.LinksStore=LinksStore;exports.MiniControlWrapper=MiniControlWrapper;exports.Node=Node;exports.NodeContext=NodeContext;exports.NodeLabel=NodeLabel;exports.NodeState=NodeState;exports.NodeWrapper=NodeWrapper;exports.NodesLayer=NodesLayer;exports.NodesSettings=NodesSettings;exports.NodesStore=NodesStore;exports.Port=Port;exports.PortInnerDefault=PortInnerDefault;exports.PortState=PortState;exports.PortsSettings=PortsSettings;exports.RenderedPortsComponentsContext=RenderedPortsComponentsContext;exports.RootStore=RootStore;exports.RootStoreContext=RootStoreContext;exports.RubbishBinIcon=RubbishBinIcon;exports.SelectionState=SelectionState;exports.UserInteractionSettings=UserInteractionSettings;exports.VisualComponentState=VisualComponentState;exports.VisualComponentWithDefault=VisualComponentWithDefault;exports.VisualComponents=VisualComponents;exports.addPoints=addPoints;exports.arePointsEqual=arePointsEqual;exports.areTranformationsEqual=areTranformationsEqual;exports.canDragGestureBeTapInstead=canDragGestureBeTapInstead;exports.clampValue=clampValue;exports.className=className$1;exports.componentDefaultType=componentDefaultType;exports.createCrossesImageGenerator=createCrossesImageGenerator;exports.createCurvedLinkPathConstructor=createCurvedLinkPathConstructor;exports.createDefaultBackground=createDefaultBackground;exports.createDefaultMiniControl=createDefaultMiniControl;exports.createDotsImageGenerator=createDotsImageGenerator;exports.createFullPortId=createFullPortId;exports.createGridImageGenerator=createGridImageGenerator;exports.createInputHorizontalNode=createInputHorizontalNode;exports.createInputOutputHorizontalNode=createInputOutputHorizontalNode;exports.createInputOutputVerticalNode=createInputOutputVerticalNode;exports.createInputVerticalNode=createInputVerticalNode;exports.createLinkDefault=createLinkDefault;exports.createLinkPath=createLinkPath;exports.createNode=createNode;exports.createOutputHorizontalNode=createOutputHorizontalNode;exports.createOutputVerticalNode=createOutputVerticalNode;exports.createPortInnerDefault=createPortInnerDefault;exports.createPortsContainer=createPortsContainer;exports.createStarNode=createStarNode;exports.createStraightLinkPathConstructor=createStraightLinkPathConstructor;exports.deepCopy=deepCopy;exports.disableNodeUserInteractionClassName=disableNodeUserInteractionClassName;exports.distanceBetweenPoints=distanceBetweenPoints;exports.enableNodeUserInteractionClassName=enableNodeUserInteractionClassName;exports.errorResult=errorResult;exports.eventPathContainsClass=eventPathContainsClass;exports.generateTransform=generateTransform;exports.guid=guid;exports.guidForcedUniqueness=guidForcedUniqueness;exports.isBoolean=isBoolean;exports.isNumber=isNumber;exports.isObject=isObject;exports.isPoint=isPoint;exports.linkCreationComponentType=linkCreationComponentType;exports.linkPortEndpointsEquals=linkPortEndpointsEquals;exports.multiplyPoint=multiplyPoint;exports.portPositionValues=portPositionValues;exports.positionValues=positionValues;exports.roundPoint=roundPoint;exports.subtractPoints=subtractPoints;exports.successResult=successResult;exports.successValueResult=successValueResult;exports.useCursor=useCursor;exports.useDiagram=useDiagram;exports.useDiagramCursor=useDiagramCursor;exports.useDiagramDragHandlers=useDiagramDragHandlers;exports.useDiagramPinchHandlers=useDiagramPinchHandlers;exports.useDiagramUserInteraction=useDiagramUserInteraction;exports.useDiagramWheelHandler=useDiagramWheelHandler;exports.useLinkUserInteraction=useLinkUserInteraction;exports.useNodeUserInteraction=useNodeUserInteraction;exports.useNotifyRef=useNotifyRef;exports.usePortUserInteraction=usePortUserInteraction;exports.useRelativePositionStyles=useRelativePositionStyles;exports.useRootStore=useRootStore;exports.useUpdateOrCreatePortState=useUpdateOrCreatePortState;exports.useUserAbilityToSelectSwitcher=useUserAbilityToSelectSwitcher;
...
var lib_core_dist = __webpack_require__(4513);
...
var ReactLiveScope=Object.assign({React:react},react,lib_core_dist,{observer:es.observer});/* harmony default export */ var theme_ReactLiveScope = (ReactLiveScope);
...
__webpack_require__.d(__webpack_exports__, {
  ...
  "clearTimers": function() { return /* reexport */ resetCleanupScheduleForTests; },
  "enableStaticRendering": function() { return /* reexport */ enableStaticRendering; },
  ...
  "useLocalObservable": function() { return /* reexport */ useLocalObservable; },
  "useLocalStore": function() { return /* reexport */ useLocalStore; },
  "useObserver": function() { return /* binding */ es_useObserver; },
  "useStaticRendering": function() { return /* binding */ useStaticRendering; }
});
...
function useLocalObservable(initializer, annotations) {
    return (0,react.useState)(function () { return (0,mobx_esm.observable)(initializer(), annotations, { autoBind: true }); })[0];
}
...
function useAsObservableSource(current) {
    if (false)
        {}
    var _a = useAsObservableSource_read((0,react.useState)(function () { return (0,mobx_esm.observable)(current, {}, { deep: false }); }), 1), res = _a[0];
...
function useLocalStore(initializer, current) {
    ...
    return (0,react.useState)(function () { return (0,mobx_esm.observable)(initializer(source), undefined, { autoBind: true }); })[0];
}
