...
_rootStore:false});}Object.defineProperty(NodeState.prototype,"id",{get:function get(){return this._id;},enumerable:false,configurable:true});Object.defineProperty(NodeState.prototype,"label",{get:function get(){return this._label;},set:function set(value){this._label=value;},enumerable:false,configurable:true});Object.defineProperty(NodeState.prototype,"position",{get:function get(){return this._position;},enumerable:false,configurable:true});Object.defineProperty(NodeState.prototype,"componentType",{get:function get(){return this._componentType;},enumerable:false,configurable:true});Object.defineProperty(NodeState.prototype,"selected",{get:function get(){return this._selected;},set:function set(value){this._selected=value;},enumerable:false,configurable:true});Object.defineProperty(NodeState.prototype,"extra",{get:function get(){return this._extra;},enumerable:false,configurable:true});Object.defineProperty(NodeState.prototype,"ref",{get:function get(){return this._ref;},enumerable:false,configurable:true});Object.defineProperty(NodeState.prototype,"ports",{get:function get(){return this._ports;},enumerable:false,configurable:true});Object.defineProperty(NodeState.prototype,"transformString",{get:function get(){return generateTransform(this._position);},enumerable:false,configurable:true});Object.defineProperty(NodeState.prototype,"componentDefinition",{get:function get(){var visualComponents=this._rootStore.nodesSettings.visualComponents;return visualComponents.getComponent(this.componentType);},enumerable:false,configurable:true});Object.defineProperty(NodeState.prototype,"realSize",{/**
         * @returns Value is calculated without zoom taking into account, that is, the same as zoom would be '1'.
         * Value can be @type {null} in case reference to real DOM object is not set.
         */get:function get(){return this._ref.realSize;},enumerable:false,configurable:true});Object.defineProperty(NodeState.prototype,"connectedExternalPorts",{get:function get(){var keyValues=Object.values(this.ports).map(function(p){return[p.id,p.connectedPorts];});return Object.fromEntries(keyValues);},enumerable:false,configurable:true});Object.defineProperty(NodeState.prototype,"connectedLinks",{get:function get(){return this._rootStore.linksStore.getNodeLinks(this._id);},enumerable:false,configurable:true});return NodeState;}();var eventPathContainsClass=function eventPathContainsClass(event,className){var typedEvent=event;if('composedPath'in typedEvent){var targets=typedEvent.composedPath();for(var i=0;i<targets.length;i++){var target=targets[i];if('classList'in target){if(target.classList.contains(className)){return true;}}}}return false;};function allTouchTargetsContainsClass(event,listenOnlyClass,ignoreClass){for(var i=0;i<event.touches.length;i++){if(!eventTargetContainsClass(event.touches[i].target,listenOnlyClass,ignoreClass)){return false;}}return true;}function eventTargetContainsClass(eventTarget,listenOnlyClass,ignoreClass){if(eventTarget&&'classList'in eventTarget){var targetElement=eventTarget;return(!listenOnlyClass||targetElement.classList.contains(listenOnlyClass))&&(!ignoreClass||!targetElement.classList.contains(ignoreClass));}else return false;}/**
 ...
 */function canDragGestureBeTapInstead(movement){return Math.max(Math.abs(movement[0]),Math.abs(movement[1]))<3;}var index_esm_useNodeUserInteraction=function useNodeUserInteraction(nodeState,enable){var _a,_b;var rootStore=index_esm_useRootStore();// Should trigger rendering on change, otherwise useUserSelectSwitcher will not be invoked
