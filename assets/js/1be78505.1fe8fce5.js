(self["webpackChunkwebsite"] = self["webpackChunkwebsite"] || []).push([[514,119],{
...
var esm = __webpack_require__(8869);
...
(0,react.useEffect)(function(){var justBecameActive=isActive&&!wasActive;if(justBecameActive&&collapsed){setCollapsed(false);}},[isActive,wasActive,collapsed]);var handleItemClick=(0,react.useCallback)(function(e){e.preventDefault();if(!menuListHeight){handleMenuListHeight();}setTimeout(function(){return setCollapsed(function(state){return!state;});},100);},[menuListHeight]);if(items.length===0){return null;}return/*#__PURE__*/react.createElement("li",{className:(0,clsx_m/* default */.Z)('menu__list-item',{'menu__list-item--collapsed':collapsed}),key:label},/*#__PURE__*/react.createElement("a",(0,esm_extends/* default */.Z)({className:(0,clsx_m/* default */.Z)('menu__link',(_clsx={'menu__link--sublist':collapsible,'menu__link--active':collapsible&&isActive},_clsx[styles_module.menuLinkText]=!collapsible,_clsx)),onClick:collapsible?handleItemClick:undefined,href:collapsible?'#!':undefined},props),label),/*#__PURE__*/react.createElement("ul",{className:"menu__list",ref:menuListRef,style:{height:menuListHeight},onTransitionEnd:function onTransitionEnd(){if(!collapsed){handleMenuListHeight(false);}}},items.map(function(childItem){return/*#__PURE__*/react.createElement(DocSidebarItem,{tabIndex:collapsed?'-1':'0',key:childItem.label,item:childItem,onItemClick:onItemClick,collapsible:collapsible,activePath:activePath});})));}function DocSidebarItemLink(_ref2){var _clsx2;var item=_ref2.item,onItemClick=_ref2.onItemClick,activePath=_ref2.activePath,_collapsible=_ref2.collapsible,props=(0,objectWithoutPropertiesLoose/* default */.Z)(_ref2,["item","onItemClick","activePath","collapsible"]);var href=item.href,label=item.label;var isActive=isActiveSidebarItem(item,activePath);return/*#__PURE__*/react.createElement("li",{className:"menu__list-item",key:label},/*#__PURE__*/react.createElement(Link/* default */.Z,(0,esm_extends/* default */.Z)({className:(0,clsx_m/* default */.Z)('menu__link',(_clsx2={'menu__link--active':isActive},_clsx2[styles_module.menuLinkExternal]=!(0,isInternalUrl/* default */.Z)(href),_clsx2)),to:href},(0,isInternalUrl/* default */.Z)(href)&&{isNavLink:true,exact:true,onClick:onItemClick},props),label));}function DocSidebarItem(props){switch(props.item.type){case'category':return/*#__PURE__*/react.createElement(DocSidebarItemCategory,props);case'link':default:return/*#__PURE__*/react.createElement(DocSidebarItemLink,props);}}function DocSidebar(_ref3){var _clsx3,_clsx4;var path=_ref3.path,sidebar=_ref3.sidebar,_ref3$sidebarCollapsi=_ref3.sidebarCollapsible,sidebarCollapsible=_ref3$sidebarCollapsi===void 0?true:_ref3$sidebarCollapsi,onCollapse=_ref3.onCollapse,isHidden=_ref3.isHidden;var _useState3=(0,react.useState)(false),showResponsiveSidebar=_useState3[0],setShowResponsiveSidebar=_useState3[1];var _useThemeConfig=(0,lib/* useThemeConfig */.LU)(),hideOnScroll=_useThemeConfig.navbar.hideOnScroll,hideableSidebar=_useThemeConfig.hideableSidebar;var _useUserPreferencesCo=(0,useUserPreferencesContext/* default */.Z)(),isAnnouncementBarClosed=_useUserPreferencesCo.isAnnouncementBarClosed;var _useScrollPosition=(0,useScrollPosition/* default */.Z)(),scrollY=_useScrollPosition.scrollY;(0,useLockBodyScroll/* default */.Z)(showResponsiveSidebar);var windowSize=(0,useWindowSize/* default */.Z)();(0,react.useEffect)(function(){if(windowSize===useWindowSize/* windowSizes.desktop */.D.desktop){setShowResponsiveSidebar(false);}},[windowSize]);return/*#__PURE__*/react.createElement("div",{className:(0,clsx_m/* default */.Z)(styles_module.sidebar,(_clsx3={},_clsx3[styles_module.sidebarWithHideableNavbar]=hideOnScroll,_clsx3[styles_module.sidebarHidden]=isHidden,_clsx3))},hideOnScroll&&/*#__PURE__*/react.createElement(Logo/* default */.Z,{tabIndex:-1,className:styles_module.sidebarLogo}),/*#__PURE__*/react.createElement("div",{className:(0,clsx_m/* default */.Z)('menu','menu--responsive','thin-scrollbar',styles_module.menu,(_clsx4={'menu--show':showResponsiveSidebar},_clsx4[styles_module.menuWithAnnouncementBar]=!isAnnouncementBarClosed&&scrollY===0,_clsx4))},/*#__PURE__*/react.createElement("button",{"aria-label":showResponsiveSidebar?(0,Translate/* translate */.I)({id:'theme.docs.sidebar.responsiveCloseButtonLabel',message:'Close menu',description:'The ARIA label for close button of mobile doc sidebar'}):(0,Translate/* translate */.I)({id:'theme.docs.sidebar.responsiveOpenButtonLabel',message:'Open menu',description:'The ARIA label for open button of mobile doc sidebar'}),"aria-haspopup":"true",className:"button button--secondary button--sm menu__button",type:"button",onClick:function onClick(){setShowResponsiveSidebar(!showResponsiveSidebar);}},showResponsiveSidebar?/*#__PURE__*/react.createElement("span",{className:(0,clsx_m/* default */.Z)(styles_module.sidebarMenuIcon,styles_module.sidebarMenuCloseIcon)},"\xD7"):/*#__PURE__*/react.createElement(IconMenu/* default */.Z,{className:styles_module.sidebarMenuIcon,height:MOBILE_TOGGLE_SIZE,width:MOBILE_TOGGLE_SIZE})),/*#__PURE__*/react.createElement("ul",{className:"menu__list"},sidebar.map(function(item){return/*#__PURE__*/react.createElement(DocSidebarItem,{key:item.label,item:item,onItemClick:function onItemClick(e){e.target.blur();setShowResponsiveSidebar(false);},collapsible:sidebarCollapsible,activePath:path});}))),hideableSidebar&&/*#__PURE__*/react.createElement("button",{type:"button",title:(0,Translate/* translate */.I)({id:'theme.docs.sidebar.collapseButtonTitle',message:'Collapse sidebar',description:'The title attribute for collapse button of doc sidebar'}),"aria-label":(0,Translate/* translate */.I)({id:'theme.docs.sidebar.collapseButtonAriaLabel',message:'Collapse sidebar',description:'The title attribute for collapse button of doc sidebar'}),className:(0,clsx_m/* default */.Z)('button button--secondary button--outline',styles_module.collapseSidebarButton),onClick:onCollapse},/*#__PURE__*/react.createElement(theme_IconArrow,{className:styles_module.collapseSidebarButtonIcon})));}/* harmony default export */ var theme_DocSidebar = (DocSidebar);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var MDXComponents={code:function code(props){var children=props.children;if(typeof children==='string'){if(!children.includes('\n')){return/*#__PURE__*/react.createElement("code",props);}return/*#__PURE__*/react.createElement(CodeBlock/* default */.Z,props);}return children;},a:function a(props){return/*#__PURE__*/react.createElement(Link/* default */.Z,props);},pre:function pre(props){var children=props.children;return/*#__PURE__*/react.createElement(CodeBlock/* default */.Z,/*#__PURE__*/(0,react.isValidElement)(children)?children==null?void 0:children.props:{children:children});},h1:theme_Heading('h1'),h2:theme_Heading('h2'),h3:theme_Heading('h3'),h4:theme_Heading('h4'),h5:theme_Heading('h5'),h6:theme_Heading('h6')};/* harmony default export */ var theme_MDXComponents = (MDXComponents);
...
/* harmony import */ var _docusaurus_Translate__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(639);
/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
