...
__webpack_require__.d(__webpack_exports__, {
  ...
  "relativeXYPositionValues": function() { return /* binding */ relativeXYPositionValues; },
  "roundPoint": function() { return /* binding */ roundPoint; },
  "splitRelativeXYPostionByAxis": function() { return /* binding */ splitRelativeXYPostionByAxis; },
...
if(!this.offsetRelativeToNode)return undefined;var nodeCenter=this.node.realSize&&multiplyPoint(this.node.realSize,0.5);if(!nodeCenter)return undefined;if(this._rootStore.linksSettings.preferLinksDirection==='horizontal'){return this.offsetRelativeToNode[0]<nodeCenter[0]?'left':'right';}else if(this._rootStore.linksSettings.preferLinksDirection==='vertical'){return this.offsetRelativeToNode[1]<nodeCenter[1]?'up':'down';}},enumerable:false,configurable:true});Object.defineProperty(PortState.prototype,"sizeAndPositionRecalculationWithDelay",{get:function get(){return this._sizeAndPositionRecalculationWithDelay;},enumerable:false,configurable:true});Object.defineProperty(PortState.prototype,"isConnectionEnabled",{get:function get(){return this._isConnectionEnabled===null?this._rootStore.diagramSettings.userInteraction.portConnection:this._isConnectionEnabled;},enumerable:false,configurable:true});return PortState;}();function createFullPortId(nodeId,portId){return nodeId+"-"+portId;}var generateTransform=function generateTransform(translate,scale){var translatePart="translate("+translate[0]+"px, "+translate[1]+"px)";if(scale){var scalePart="scale("+scale+")";return translatePart+' '+scalePart;}else{return translatePart;}};var areTranformationsEqual=function areTranformationsEqual(a,b){return a===b||a&&b&&a.zoom===b.zoom&&arePointsEqual(a.offset,b.offset);};var NodeState=/** @class */function(){function NodeState(rootStore,id,state){var _this=this;this.import=function(newState){var _a;_this.setPosition(newState===null||newState===void 0?void 0:newState.position);_this.setComponentType(newState===null||newState===void 0?void 0:newState.componentType);_this.setExtra(newState===null||newState===void 0?void 0:newState.extra);_this.label=(_a=newState===null||newState===void 0?void 0:newState.label)!==null&&_a!==void 0?_a:'';_this._ports={};_this.setIsSelectionEnabled(newState===null||newState===void 0?void 0:newState.isSelectionEnabled);_this.setIsDragEnabled(newState===null||newState===void 0?void 0:newState.isDragEnabled);};this.export=function(){var _a,_b;return _assign({},deepCopy({id:_this._id,label:_this._label,position:_this._position,componentType:_this.componentType,extra:_this.extra,isSelectionEnabled:(_a=_this._isSelectionEnabled)!==null&&_a!==void 0?_a:undefined,isDragEnabled:(_b=_this._isDragEnabled)!==null&&_b!==void 0?_b:undefined}));};/**
